...
-->
												...
												<div class="flex-shrink-0 ms-2">
													...
													<!--begin::Menu-->
													<!--begin::Menu 1-->
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_614857a2d51f9">
														<!--begin::Header-->
														<div class="px-7 py-5">
														...
														<div class="px-7 py-5">
															...
															<div class="mb-10">
																...
																<!--begin::Input-->
																<div>
																	<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_614857a2d51f9" data-allow-clear="true">
																		<option></option>
													...
													<div class="menu-sub menu-sub-accordion menu-active-bg">
														<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
															...
															<div class="menu-sub menu-sub-accordion menu-active-bg">
																...
																<div class="menu-item">
																	<a class="menu-link active" href="../../modals/general/select-users.php">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot"></span>
																		</span>
				...
				<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
					...
					<div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
							<!--begin::Heading-->
							<h1 class="text-dark fw-bolder my-0 fs-2">Select Friends</h1>
							<!--end::Heading-->
							<!--begin::Breadcrumb-->
						...
						<div class="card">
							...
							<div class="card-body pb-0">
								...
								<div class="text-center px-5">
									<img src="assets/media/illustrations/sigma-1/20.png" alt="" class="mw-100 h-200px h-sm-325px" />
								</div>
								<!--end::Illustration-->
							</div>
							<!--end::Card body-->
												...
												<div class="d-flex flex-stack pb-3">
													...
													<div class="d-flex">
														...
														<div class="ms-5">
															<!--begin::Name-->
															<div class="d-flex align-items-center">
																<a href="../../pages/profile/overview.php" class="text-dark fw-bolder text-hover-primary fs-5 me-4">Emma Smith</a>
																<!--begin::Label-->
												...
												<div class="d-flex flex-stack pb-3">
													...
													<div class="d-flex">
														...
														<div class="ms-5">
															<!--begin::Name-->
															<div class="d-flex align-items-center">
																<a href="../../pages/profile/overview.php" class="text-dark fw-bolder text-hover-primary fs-5 me-4">Sean Bean</a>
																<!--begin::Label-->
																<span class="badge badge-light-success d-flex align-items-center fs-8 fw-bold">
																	<!--begin::Svg Icon | path: icons/duotune/general/gen029.svg-->
																	<span class="svg-icon svg-icon-8 svg-icon-success me-1">
												...
												<div class="d-flex flex-stack pb-3">
													...
													<div class="d-flex">
														...
														<div class="ms-5">
															<!--begin::Name-->
															<div class="d-flex align-items-center">
																<a href="../../pages/profile/overview.php" class="text-dark fw-bolder text-hover-primary fs-5 me-4">Lusy Kunic</a>
																<!--begin::Label-->
																<span class="m-0"></span>
																<!--end::Label-->
															</div>
												...
												<div class="d-flex flex-stack pb-3">
													...
													<div class="d-flex">
														...
														<div class="ms-5">
															<!--begin::Name-->
															<div class="d-flex align-items-center">
																<a href="../../pages/profile/overview.php" class="text-dark fw-bolder text-hover-primary fs-5 me-4">Mat Dillon</a>
																<!--begin::Label-->
																<span class="m-0"></span>
																<!--end::Label-->
															</div>
