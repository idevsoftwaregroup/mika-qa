<?php
require('layouts/infrastructure/header.php');
?>
<!DOCTYPE html>
...
<body id="kt_body" style="background-image: url()" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-enabled">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            <!--begin::Aside-->
            <!-- just in this case have flex-row other one in bundle.rtl css have row-reverse in class aside  -->
            <div id="kt_aside" class="aside aside-extended flex-row " data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
                <!--begin::Primary-->
                    ...
                    <div class="aside-footer d-flex flex-column align-items-center flex-column-auto" id="kt_aside_footer">
                        ...
                        <div class="d-flex align-items-center mb-10" id="kt_header_user_menu_toggle">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="/authentication/flows/basic/sign-in.php" class="menu-link px-5">Sign
                                        Out</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu separator-->
                                            ...
                                            <div class="m-0">
                                                ...
                                                <div class="mb-10">
                                                    ...
                                                    <a href="/pages/forms/beforeChecklist.php" class="custom-list d-flex align-items-center px-5 py-4">
                                                        ...
                                                        <div class="d-flex flex-column flex-grow-1">
                                                            <!--begin::Title-->
                                                            <h5 class="custom-list-title fw-bold text-gray-800 mb-1"> چک
                                                                لیست</h5>
                                                            <!--end::Title-->
                                                            <!--begin::Link-->
                                    ...
                                    <div class="tab-pane fade" id="kt_aside_nav_tab_menu" role="tabpanel">
                                        ...
                                        <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 px-6 my-5 my-lg-0" id="kt_aside_menu" data-kt-menu="true">
                                            <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                ...
                                                <div class="menu-item">
                                                    <div class="menu-content pt-8 pb-2">
                                                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">کاربران
                                                        </span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="kt_aside_nav_tab_subscription" role="tabpanel">
                                        ...
                                        <div class="mx-5">
                                            ...
                                            <div class="text-center pt-10 mb-20">
                                                ...
                                                <!--end::Title-->
                                                <!--begin::Description-->
                                                <p class="text-gray-400 fs-4 fw-bold mb-10">تضمین کیفیت پروژه ها
                                                    ساختمانی گروه ساختمانی میکا</p>
                                                <!--end::Description-->
                                                <!--begin::Action-->
                                                <a href="https://mikapartners.co" class="btn btn-primary" data-bs-target="#kt_modal_upgrade_plan" data-bs-toggle="modal">وب
                                                    سایت رسمی گروه ساختمانی میکا</a>
                                                <!--end::Action-->
                                            </div>
                                            <!--end::Container-->
                                            <!--begin::Illustration-->
                                        ...
                                        <div class="mx-5">
                                            ...
                                            <div class="mb-12">
                                                ...
                                                <div class="d-flex align-items-center mb-7">
                                                    ...
                                                    <!--begin::Text-->
                                                    <div class="d-flex flex-column">
                                                        <a href="/pages/profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">Project
                                                            Briefing</a>
                                                ...
                                                <div class="d-flex align-items-center mb-7">
                                                    ...
                                                    <!--begin::Text-->
                                                    <div class="d-flex flex-column">
                                                        <a href="/pages/profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">Concept
                                                            Design</a>
                                                ...
                                                <div class="d-flex align-items-center mb-7">
                                                    ...
                                                    <!--begin::Text-->
                                                    <div class="d-flex flex-column">
                                                        <a href="/pages/profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">Functional
                                                            Logics</a>
                                                ...
                                                <div class="d-flex align-items-center mb-7">
                                                    ...
                                                    <!--begin::Text-->
                                                    <div class="d-flex flex-column">
                                                        <a href="/pages/profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">HTML,
                                                            CSS Coding</a>
                                                        <span class="text-muted fw-bold">Art Director</span>
                                                    </div>
                                                    <!--end::Text-->
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!--begin::Text-->
                                                    <div class="d-flex flex-column">
                                                        <a href="/pages/profile/overview.php" class="text-gray-800 text-hover-primary fs-6 fw-bold">ReactJS
                                                            Developer</a>
                                            ...
                                            <div class="mb-12">
                                                ...
                                                <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-7">
                                                    ...
                                                    <div class="flex-grow-1 me-2">
                                                        <a href="/widgets/lists.php" class="fw-bolder text-gray-800 text-hover-primary fs-6">Group
                                                            lunch celebration</a>
                                                ...
                                                <div class="d-flex align-items-center bg-light-success rounded p-5 mb-7">
                                                    ...
                                                    <!--begin::Title-->
                                                    <div class="flex-grow-1 me-2">
                                                        <a href="/widgets/lists.php" class="fw-bolder text-gray-800 text-hover-primary fs-6">Navigation
                                                            optimization</a>
                                                ...
                                                <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
                                                    ...
                                                    <!--begin::Title-->
                                                    <div class="flex-grow-1 me-2">
                                                        <a href="/widgets/lists.php" class="fw-bolder text-gray-800 text-hover-primary fs-6">Humbert
                                                            Bresnen</a>
                                                ...
                                                <div class="d-flex align-items-center bg-light-info rounded p-5 mb-7">
                                                    ...
                                                    <!--begin::Title-->
                                                    <div class="flex-grow-1 me-2">
                                                        <a href="/widgets/lists.php" class="fw-bolder text-gray-800 text-hover-primary fs-6">Air
                                                            B &amp; B - Real Estate</a>
                                                ...
                                                <div class="d-flex align-items-center bg-light-primary rounded p-5 mb-7">
                                                    ...
                                                    <!--begin::Title-->
                                                    <div class="flex-grow-1 me-2">
                                                        <a href="/widgets/lists.php" class="fw-bolder text-gray-800 text-hover-primary fs-6">B
                                                            &amp; Q - Food Company</a>
                                                ...
                                                <div class="d-flex align-items-center bg-light-danger rounded p-5">
                                                    ...
                                                    <!--begin::Title-->
                                                    <div class="flex-grow-1 me-2">
                                                        <a href="/widgets/lists.php" class="fw-bolder text-gray-800 text-hover-primary fs-6">Nexa
                                                            - Next generation</a>
                ...
                <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            <!--begin::Heading-->
                            <h1 class="text-dark fw-bolder my-0 fs-2">داشبورد</h1>
                            <!--end::Heading-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                <li class="breadcrumb-item text-muted">
                                    <a href="/#" class="text-muted">صفحه نخست</a>
                                </li>
                                <li class="breadcrumb-item text-dark">داشیورد کاربری</li>
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                        <!--end::Page title=-->
