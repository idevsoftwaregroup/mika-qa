                        ...
                        <td>" . htmlspecialchars($jalali_date) . "</td>";
                                    ...
                                    function displayChecklists($conn, $username)
                                    {
                                        ...
                                        $query = "SELECT * FROM checklist 
                                                    WHERE projectname = (SELECT project_name FROM project WHERE id = ?) 
                                                    AND contractor_name = (SELECT contractor_name FROM project WHERE id = ?) AND checklist.isDeleted is False OR checklist.isDeleted is NULL
