...
WHERE
    ...
    WHERE
        id = ?
) AND checklist.isDeleted = False AND checklist.status = 'issued'
ORDER BY
    date_created
DESC
    ";
                        ...
                        <td>" . htmlspecialchars($jalali_date) . "</td>";
                                            ...
                                            echo "<tr><td colspan='8' class='text-center'>هیچ چک لیست <span class='text-success'>ایجاد شده </span>ای یافت نشد.</td></tr>";
                                        }
                                    }
