...
WHERE
    ...
    WHERE
        id = ?
) AND checklist.isDeleted is NULL OR checklist.isDeleted = NULL OR checklist.isDeleted = False AND checklist.status = 'Reject'
ORDER BY
    date_created
DESC
    ";
                        ...
                        <td>" . htmlspecialchars($jalali_date) . "</td>";
                                            ...
                                            echo "<tr><td colspan='8' class='text-center'>هیچ چک لیست <span class='text-danger'>ریجکت شده </span>ای یافت نشد.</td></tr>";
                                        }
                                    }
