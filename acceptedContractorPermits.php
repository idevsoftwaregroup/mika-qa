...
-->
    ...
    AND contractor_name = (
        ...
        FROM project 
        WHERE id = $projectId 
    ) AND permits.isDeleted = false AND permits.status = 'Accept'
...
WHERE
    ...
    AND (checklist.isDeleted = FALSE OR checklist.isDeleted IS NULL)
ORDER BY
    checklist.date_created DESC;
                                    ...
                                    echo "<h1 class='mb-5 text-white'>پرمیت های تایید شده</h1>";
