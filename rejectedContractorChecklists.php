<?php // Contractor Dashboard
require('layouts/infrastructure/headerContractor.php');
$title = "Quality Assurance | Contractor's Dashboard";
include_once('datetime/jdf.php');
error_reporting(0);
// echo $_SESSION['project_id'];
// echo $_SESSION['project_id'] = $_POST['project_id'];
?>
<!DOCTYPE html>
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" style="background-color: black;" class="aside aside-extended flex-row-reverse " data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
                ...
                <div class="aside-secondary d-flex flex-row-fluid">
                    <!--begin::Workspace-->
                    <div class="aside-workspace my-5 p-3 no-hover" id="kt_aside_wordspac">
...
-->
                            ...
                            <!--end::Wrapper-->
                            <!--begin::Footer-->
                            <div class="flex-column-auto mb-15 px-5" id="kt_aside_secondary_footer">
                                <a href="/logout.php" style="border: 1px solid white" class="btn btn-outline-dark bg-black btn-flex flex-center w-100 with-hover" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-trigger="hover" data-bs-offset="0,5" data-bs-dismiss-="click" title="200+ in-house components and 3rd-party plugins">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper" style="background-color: black;">
                    ...
                    <div class="container-fluid d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                <li class="breadcrumb-item text-muted">
                                    <a href="/contractor.php" class="p-5 btn btn-outline-white rounded text-black bg-white with-hover">صفحه نخست</a>
                                </li>
                                <li class="breadcrumb-item p-5 btn rounded text-white bg-black with-hover" style="border: 1px solid white">کارتابل پیمانکار</li>

                                <li class="breadcrumb-item p-5 btn rounded text-white bg-warning with-hover mx-2" style="border: 1px solid white">پروژه :
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        $project_SelectedName = $row['project_name'];
                                        $project_SelectedContractorName = $row['contractor_name'];

                                        echo $project_SelectedName . " ( " . $project_SelectedContractorName . " ) ";
                                    }
                        ...
                        <div class="d-flex d-lg-none align-items-center ms-n2 me-2">
                            ...
                            <a href="#" class="d-flex align-items-center">
                                <img alt="Logo" src="./assets/media/logos/mika.png" class="h-30px" />
                            </a>
                            <!--end::Logo-->
                        </div>
                        <!--end::Wrapper-->
                ...
                <!--end::Header-->
                <!--begin::Content-->
                <div class="container-fluid p-10" style="direction: rtl;overflow-x: scroll;">
                    <div class="row">
                        <div class="px-3">
                            <table class="table table-striped mb-10">
                                <thead>
                                    <tr>
                                        <th scope="col" class="fw-bold text-white w-25">
                                            <input class="form-control form-control-sm" id="searchId" type="text" placeholder="پرمیت | چک لیست">
                                        </th>
                                        <!-- <th scope="col" class="text-white">
                                            <input class="form-control form-control-sm" id="searchType" type="text" placeholder="نوع فرم">
                                        </th> -->
                                        <th scope="col" class="text-white w-25">
                                            <select class="form-control form-control-sm" id="searchType">
                                                <option value="">نوع فرم</option> <!-- Empty value for filtering all -->
                                                <option value="پرمیت">پرمیت</option>
                                                <option value="چک لیست">چک لیست</option>
                                            </select>
                                        </th>
                                        <!-- <th scope="col" class="text-white">
                                            <input class="form-control form-control-sm" id="searchProject" type="text" placeholder="نام پروژه">
                                        </th> -->
                                        <!-- <th scope="col" class="text-white">
                                            <input class="form-control form-control-sm" id="searchContractor" type="text" placeholder="نام پیمانکار">
                                        </th> -->
                                        <th scope="col" class="text-white w-25">
                                            <input class="form-control form-control-sm" id="searchContractNumber" type="text" placeholder="شماره قرارداد">
                                        </th>
                                        <th scope="col" class="text-white w-25">
                                            <input class="form-control form-control-sm" id="searchStatus" type="text" placeholder="وضعیت فرم">
                                        </th>
                                        <th scope="col" class="text-white w-25">
                                            <input class="form-control form-control-sm" id="searchDate" type="text" placeholder="تاریخ و زمان ایجاد">
                                        </th>
                                        <th scope="col" class="text-white w-25">
                                            <!-- New Action Column Header -->
                                            <input class="form-control form-control-sm" id="searchAction" type="text" placeholder="عملیات" disabled>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody id="tableBody">
                                    ...
                                    // Function to check if a permit has been submitted by the current user
                                    function permitSubmittedByUser($conn, $permit_id, $username)
                                    {
                                        $query = "SELECT COUNT(*) as count FROM `permit_status` WHERE `permit_id` = ? AND `user_id` = ?";
                                        $stmt = $conn->prepare($query);
                                        $stmt->bind_param("ss", $permit_id, $username);
                                        $stmt->execute();
                                        $result = $stmt->get_result();
                                    ...
                                    // Function to check if a checklist has been submitted by the current user
                                    function checklistSubmittedByUser($conn, $permit_id, $username)
                                    {
                                        $query = "SELECT COUNT(*) as count FROM `checklistItemsActions` WHERE `permit_id` = ? AND `user_name` = ?";
                                        $stmt = $conn->prepare($query);
                                        $stmt->bind_param("ss", $permit_id, $username);
                                        $stmt->execute();
                                        $result = $stmt->get_result();
                                    ...
                                    // Function to display permits not submitted by the current user
                                    function displayPermits($conn, $username)
                                    {
                                        $projectId = intval($_SESSION['project_id']);
    ...
    AND contractor_name = (
        ...
        FROM project 
        WHERE id = $projectId 
    ) AND permits.isDeleted = false AND permits.status = 'Reject'
...
";
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                if (permitSubmittedByUser($conn, $row['permit_id'], $username) === 0) {
                                                    ...
                                                    echo "<tr>
                                                    <td class='col-md-3'><a class='btn btn-sm btn-dark text-white rounded w-100' href='../pages/forms/permitItems.php?prmQWERTY=" . htmlspecialchars($row["permit_id"]) . "'>" . htmlspecialchars($row["permit_id"]) . "</a></td>
                                                    <td class='fw-bolder'><span class='text-info'>پرمیت</span></td>
                                                    <td>" . htmlspecialchars($row["contract_number"]) . "</td>
                                         
                                            <td><strong class='" . getStatusClass($row["status"]) . "'>" . getStatusText($row["status"]) . "</strong></td>
                                            <td>" . htmlspecialchars($jalali_date) . "</td>";

                                                    $fullNameQuery = "SELECT u.fullname, u.job_title, p.role, u.job_position 
                                                                                FROM users u
                                                                                LEFT JOIN projectPersonnel p ON u.id = p.userID
                                                                                WHERE u.username = ?";
                                                    $getFullname = $conn->prepare($fullNameQuery);
                                                    ...
                                                    if ($rowFullnameResult) {
                                                        ...
                                                        $jobTitle = $rowFullnameResult['job_title'];
                                                        $role = $rowFullnameResult['role'];
                                                        $jobPosition = $rowFullnameResult['job_position'];
                                                        // echo $full_name . " ( " . $jobTitle . " ) ";
                                                        // echo "<img  />";
                                                        if ($jobPosition == 3) {
                                                            echo "<td><a class='btn btn-dark btn-sm w-100' href='../pages/forms/progressContractor.php?type=permit&itemID={$row['permit_id']}'>وضعیت</a></td>";
                                                        } else {
                                                            echo "";
                                                        }
                                                    } else {
                                            ...
                                            echo "<tr><td colspan='8' class='text-center'>هیچ فرآیند فعال پرمیتی یافت نشد.</td></tr>";
                                        }
                                    }

                                    // Function to display checklists not submitted by the current user
                                    function displayChecklists($conn, $username)
                                    {
                                        $projectId = intval($_SESSION['project_id']);
...
WHERE
    ...
    AND (checklist.isDeleted = FALSE OR checklist.isDeleted IS NULL) AND checklist.status = 'Reject'
ORDER BY
    checklist.date_created DESC
                                                    ";
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                if (!checklistSubmittedByUser($conn, $row['permit_id'], $username)) {
                                                    $array = explode(' ', $row['date_created']);
                                                    list($year, $month, $day) = explode('-', $array[0]);
                                                    list($hour, $minute, $second) = explode(':', $array[1]);
                                                    $timestamp = mktime($hour, $minute, $second, $month, $day, $year);
                                                    $jalali_date = jdate("تاریخ:Y/m/d زمان:H:i:s", $timestamp);

                                                    $getSql = "SELECT checklist.checklistID
                                                    FROM checklist
                                                    WHERE checklist.permit_id = ?";
                                                    $stmtGetchecklistId = $conn->prepare($getSql);
                                                    $stmtGetchecklistId->bind_param("s", $row["permit_id"]);
                                                    $stmtGetchecklistId->execute();
                                                    $getResultstmt = $stmtGetchecklistId->get_result();
                                                    if ($row123 = $getResultstmt->fetch_assoc()) {
                                                        $getChecklistIDPermitID = $row123['checklistID'];
                                                    } else {
                                                        $getChecklistIDPermitID = 'N/A'; // Default value if no checklistID found
                                                    }

                                                    // <td>" . htmlspecialchars($row["projectname"]) . "</td>
                                                    // <td>" . htmlspecialchars($row["contractor_name"]) . "</td>
                                                    echo "<tr>
                                            <td class='col-md-3'><a class='btn btn-sm btn-dark text-white rounded w-100' href='../pages/forms/checklistItems.php?prmQWERTY=" . htmlspecialchars($getChecklistIDPermitID) . "'>" . htmlspecialchars($getChecklistIDPermitID) . "</a></td>
                                            <td class='fw-bolder'><span class='text-primary'>چک لیست</span></td>
                                            <td>" . htmlspecialchars($row["contract_number"]) . "</td>
                                            <td><strong class='" . getStatusClass($row["status"]) . "'>" . getStatusText($row["status"]) . "</strong></td>
                                            <td>" . htmlspecialchars($jalali_date) . "</td>";
                                                    $fullNameQuery = "SELECT u.fullname, u.job_title, p.role, u.job_position 
                                        ...
                                        WHERE u.username = ?";
                                                    ...
                                                    if ($rowFullnameResult) {
                                                        ...
                                                        // echo "<img  />";
                                                        if ($jobPosition == 3) {
                                                            echo "<td><a class='btn btn-dark btn-sm w-100' href='../pages/forms/progressContractor.php?type=checklist&itemID={$row['checklistID']}'>وضعیت</a></td>";
                                                        } else {
                                                            echo "";
                                                        }
                                                    } else {
                                            ...
                                            echo "<tr><td colspan='8' class='text-center'>هیچ فرآیند فعال چک لیست یافت نشد.</td></tr>";
                                        }
                                    }
                                    ...
                                    function getStatusClass($status)
                                    {
                                        switch ($status) {
                                            case 'issued':
                                                return 'text-white bg-warning rounded p-2 w-100';
                                            case 'Accept':
                                                return 'text-white bg-129045 rounded p-2 w-100';
                                            case 'Reject':
                                                return 'text-white bg-c70707 rounded p-2 w-100';
                                            case 'in progress':
                                                return 'text-white bg-267fe7 p-2 rounded w-100';
                                            default:
                                                return '';
                                        }
                                    }
                                    ...
                                    // Display permits not submitted by the current user
                                    echo "<h1 class='mb-5 text-white'>چک لیست های تایید نشده</h1>";
                                    // displayPermits($conn, $current_user_username);

                                    // Display checklists not submitted by the current user
                                    displayChecklists($conn, $current_user_username);
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        const searchInputs = {
                            ...
                            searchType: document.getElementById('searchType'), // This is now a select box
                            searchContractNumber: document.getElementById('searchContractNumber'),
                        ...
                        function filterTable() {
                            const filters = {
                                id: searchInputs.searchId.value.toLowerCase(),
                                type: searchInputs.searchType.value.toLowerCase(), // For select box, get the selected value
                                contractNumber: searchInputs.searchContractNumber.value.toLowerCase(),
                                status: searchInputs.searchStatus.value.toLowerCase(),
                                date: searchInputs.searchDate.value.toLowerCase()
                            };

                            for (let row of rows) {
                                const cells = row.getElementsByTagName('td');
                                if (cells.length > 0) {
                                    const [idCell, typeCell, contractNumberCell, statusCell, dateCell] = cells;
                                    const isVisible = (
                                        (idCell.textContent.toLowerCase().includes(filters.id) || filters.id === '') &&
                                        (typeCell.textContent.toLowerCase().includes(filters.type) || filters.type === '') &&
                                        (contractNumberCell.textContent.toLowerCase().includes(filters.contractNumber) || filters.contractNumber === '') &&
                                        (statusCell.textContent.toLowerCase().includes(filters.status) || filters.status === '') &&
                                        (dateCell.textContent.toLowerCase().includes(filters.date) || filters.date === '')
                                    );
                        ...
                        searchInputs.searchType.addEventListener('change', filterTable); // Handle select change
                    });
                </script>
                <!-- <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        const searchInputs = {
                            ...
                            searchContractor: document.getElementById('searchContractor'),
                            searchContractNumber: document.getElementById('searchContractNumber'),
                            searchStatus: document.getElementById('searchStatus'),
                            searchDate: document.getElementById('searchDate')
                        };
                        ...
                        function filterTable() {
                            const filters = {
                                id: searchInputs.searchId.value.toLowerCase(),
                                type: searchInputs.searchType.value.toLowerCase(),
                                project: searchInputs.searchProject.value.toLowerCase(),
                                contractor: searchInputs.searchContractor.value.toLowerCase(),
                                contractNumber: searchInputs.searchContractNumber.value.toLowerCase(),
                                status: searchInputs.searchStatus.value.toLowerCase(),
                                date: searchInputs.searchDate.value.toLowerCase()
                            };
                            ...
                            for (let row of rows) {
                                const cells = row.getElementsByTagName('td');
                                if (cells.length > 0) {
                                    const [idCell, typeCell, projectCell, contractorCell, contractNumberCell, statusCell, dateCell] = cells;
                                    const isVisible = (
                                        (idCell.textContent.toLowerCase().includes(filters.id) || filters.id === '') &&
                                        (typeCell.textContent.toLowerCase().includes(filters.type) || filters.type === '') &&
                                        (projectCell.textContent.toLowerCase().includes(filters.project) || filters.project === '') &&
                                        (contractorCell.textContent.toLowerCase().includes(filters.contractor) || filters.contractor === '') &&
                                        (contractNumberCell.textContent.toLowerCase().includes(filters.contractNumber) || filters.contractNumber === '') &&
                                        (statusCell.textContent.toLowerCase().includes(filters.status) || filters.status === '') &&
                                        (dateCell.textContent.toLowerCase().includes(filters.date) || filters.date === '')
                                    );
                    ...
                    function showFormStatus(permitId) {
                        // Implement the logic to show the form status here
                        alert('Show status for permit ID: ' + permitId);
                    }
                </script> -->
                <!--end::Content-->
                <!--begin::Footer-->
