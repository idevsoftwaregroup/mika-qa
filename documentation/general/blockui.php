				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/general/blockui.php">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574c36289" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574c3628c" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574c36289" role="tabpanel">
													<div class="highlight-code">
...
button.addEventListener("click", function() {
    if (blockUI.isBlocked()) {
        ...
        button.innerText = "Release";
												...
												<div class="tab-pane fade" id="kt_highlight_6148574c3628c" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
								...
								<div class="py-10">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574c36426" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574c36428" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574c36426" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
...
button.addEventListener("click", function() {
    if (blockUI.isBlocked()) {
        ...
        button.innerText = "Release";
												...
												<div class="tab-pane fade" id="kt_highlight_6148574c36428" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
								...
								<div class="py-10">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574c365d1" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574c365d3" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574c365d1" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
...
button.addEventListener("click", function() {
    if (blockUI.isBlocked()) {
        ...
        button.innerText = "Release";
												...
												<div class="tab-pane fade" id="kt_highlight_6148574c365d3" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
								...
								<div class="py-10">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574c36882" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574c36884" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574c36882" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
...
button.addEventListener("click", function(e) {
    ...
    setTimeout(function() {
        blockUI.release();
												...
												<div class="tab-pane fade" id="kt_highlight_6148574c36884" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
...
var blockUI = new KTBlockUI(target, options);</code>
															...
															<div class="d-flex align-items-center rounded py-5 px-5 bg-light-info">
																...
																<div class="text-gray-700 fw-bold fs-6">For the constructor
																	<code>options</code>refer to the next table.
																</div>
																<!--end::Description-->
															</div>
															<!--end::Information-->
...
var blockUI = KTBlockUI.getInstance(target);</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-2" id="options">
										<a href="#options"></a>Constructor Options
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
