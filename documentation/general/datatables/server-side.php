						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/general/datatables/server-side.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="p-0">
									...
									<h1 class="anchor fw-bolder mb-5" id="server-side">
										<a href="#server-side"></a>Server Side
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="pt-5 pb-10">
										...
										<div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
											...
											<div class="text-gray-700 fw-bold fs-6 lh-lg">With server-side processing enabled, all paging, searching, ordering actions that DataTables performs are handed off to a server where an SQL engine (or similar) can perform these actions on the large data set. For more information please check the official
												<a href="https://datatables.net/manual/server-side" target="_blank">documentation</a>.
											</div>
											<!--end::Description-->
										</div>
										<!--end::Notice-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574a93d10" role="tab">HTML</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574a93d14" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574a93d15" role="tab">PHP</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574a93d16" role="tab">PHP</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574a93d10" role="tabpanel">
...
&lt;!--end::Datatable--&gt;</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148574a93d14" role="tabpanel">
													<div class="highlight-code">
...
KTUtil.onDOMContentLoaded(function () {
    KTDatatablesServerSide.init();
												...
												<div class="tab-pane fade" id="kt_highlight_6148574a93d15" role="tabpanel">
													<div class="highlight-code">
...
$api-&gt;init();</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148574a93d16" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-php" style="height:400px">
<code class="language-php">&lt;?php
/**
