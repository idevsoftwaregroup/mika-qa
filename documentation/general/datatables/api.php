						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/general/datatables/api.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="add-rows">
										<a href="#add-rows"></a>Add Rows
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">New rows can be added to a DataTable using the
										<code>row.add()</code>API method. Simply call the API function with the data for the new row (be it an array or object).
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="my-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574b25ca0" role="tab">HTML</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574b25ca4" role="tab">JAVASCRIPT</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574b25ca0" role="tabpanel">
...
&lt;/table&gt;</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148574b25ca4" role="tabpanel">
													<div class="highlight-code">
...
$("#kt_datatable_example_1_addrow").click();</code>
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="form-inputs">
										<a href="#form-inputs"></a>Form Inputs
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574b25e79" role="tab">HTML</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574b25e7c" role="tab">JAVASCRIPT</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574b25e79" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
<code class="language-html">&lt;div class="pb-10"&gt;
    &lt;button class="btn btn-primary" id="kt_datatable_example_2_submit"&gt;Submit Form&lt;/button&gt;
...
&lt;/table&gt;</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148574b25e7c" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
