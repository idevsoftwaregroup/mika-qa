						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/general/datatables/advanced.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
											<span class="menu-title">Advanced</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="column-rendering">
										<a href="#column-rendering"></a>Column Rendering
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574a072aa" role="tab">HTML</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574a072bb" role="tab">JAVASCRIPT</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574a072aa" role="tabpanel">
...
&lt;/table&gt;</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148574a072bb" role="tabpanel">
													<div class="highlight-code">
      ...
      "targets": 1
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="complex-header">
										<a href="#complex-header"></a>Complex Header
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574a07577" role="tab">HTML</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574a0757a" role="tab">JAVASCRIPT</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574a07577" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
...
&lt;/table&gt;</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148574a0757a" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
        ...
        "targets": -1
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="row-grouping">
										<a href="#row-grouping"></a>Row Grouping
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574a0777f" role="tab">HTML</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574a07782" role="tab">JAVASCRIPT</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574a0777f" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
...
&lt;/table&gt;</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148574a07782" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript"></code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="footer-callback">
										<a href="#footer-callback"></a>Footer Callback
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574a07975" role="tab">HTML</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574a07978" role="tab">JAVASCRIPT</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574a07975" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
...
&lt;/table&gt;</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148574a07978" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
            ...
            "$" + pageTotal + " ( $" + total + " total)"
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="dom-positioning">
										<a href="#dom-positioning"></a>DOM Positioning
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">When customising DataTables for your own usage, you might find that the default position of the feature elements (filter input etc) is not quite to your liking. For more info please check
										<a href="https://datatables.net/examples/basic_init/dom.php" target="_blank" class="fw-bolder me-1">DOM positioning</a>documentation.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="my-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574a07b52" role="tab">HTML</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574a07b55" role="tab">JAVASCRIPT</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574a07b52" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
...
&lt;/table&gt;</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148574a07b55" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
