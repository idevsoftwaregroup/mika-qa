						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/general/datatables/basic.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
											<span class="menu-title">Basic</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
									...
									<div class="text-gray-700 fw-bold fs-6 lh-lg">DataTables is a plug-in for the jQuery Javascript library. It is a highly flexible tool, based upon the foundations of progressive enhancement, and will add advanced interaction controls to any HTML table. For more info see
										<a href="https://datatables.net/" class="fw-bold">the official site</a>.
									</div>
									<!--end::Description-->
								</div>
								<!--end::Notice-->
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="zero-configuration">
										<a href="#zero-configuration"></a>Zero Configuration
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857496d5b4" role="tab">HTML</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857496d5b9" role="tab">JAVASCRIPT</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857496d5b4" role="tabpanel">
...
&lt;/table&gt;</code>
												...
												<div class="tab-pane fade" id="kt_highlight_614857496d5b9" role="tabpanel">
													<div class="highlight-code">
...
<code class="language-javascript">$("#kt_datatable_example_1").DataTable();</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="vertical-scroll">
										<a href="#vertical-scroll"></a>Vertical Scroll
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857496d785" role="tab">HTML</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857496d788" role="tab">JAVASCRIPT</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857496d785" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
...
&lt;/table&gt;</code>
												...
												<div class="tab-pane fade" id="kt_highlight_614857496d788" role="tabpanel">
													<div class="highlight-code">
    ...
    "dom": "&lt;'table-responsive'tr&gt;"
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="horizontal-scroll">
										<a href="#horizontal-scroll"></a>Horizontal Scroll
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857496d932" role="tab">HTML</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857496d935" role="tab">JAVASCRIPT</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857496d932" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
...
&lt;/table&gt;</code>
												...
												<div class="tab-pane fade" id="kt_highlight_614857496d935" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
    ...
    "scrollX": true
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="vertical-horizontal-scroll">
										<a href="#vertical-horizontal-scroll"></a>Vertical &amp; Horizontal Scroll
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857496dae9" role="tab">HTML</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857496daec" role="tab">JAVASCRIPT</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857496dae9" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
...
&lt;/table&gt;</code>
												...
												<div class="tab-pane fade" id="kt_highlight_614857496daec" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
