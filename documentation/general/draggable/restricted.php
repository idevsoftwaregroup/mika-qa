						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/general/draggable/restricted.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
									...
									<div class="text-gray-700 fw-bold fs-6 lh-lg">Draggable is a lightweight, responsive, modern drag &amp; drop library. Draggable abstracts native browser events into a comprehensive API to create a custom drag and drop experience. For more info see
										...
										<a class="fw-bolder" href="https://github.com/Shopify/draggable">the Github repository</a>.
									</div>
									<!--end::Description-->
								</div>
								<!--end::Notice-->
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="restricted">
										<a href="#restricted" data-kt-scroll-toggle=""></a>Restricted Zones Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">
										<ul>
											...
											<li class="py-2">Add
												<code>data-kt-draggable-level="restricted"</code>to draggable zones to set a restricted permission level to the container.
											</li>
											<li class="py-2">Define draggable cards with permissions levels by adding
												<code>data-kt-draggable-level="admin"</code>to allow specific cards into the restricted container.
											</li>
									...
									<div class="pt-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857506214e" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148575062152" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857506214e" role="tabpanel">
...
// Handle drag start event -- more info: https://shopify.github.io/draggable/docs/class/src/Draggable/DragEvent/DragEvent.js~DragEvent.php
droppable.on("drag:start", (e) =&gt; {
    droppableOrigin = e.originalSource.getAttribute("data-kt-draggable-level");
});

// Handle drag over event -- more info: https://shopify.github.io/draggable/docs/class/src/Draggable/DragEvent/DragEvent.js~DragOverEvent.php
...
// Handle drag stop event -- more info: https://shopify.github.io/draggable/docs/class/src/Draggable/DragEvent/DragEvent.js~DragStopEvent.php
...
// Handle drop event -- https://shopify.github.io/draggable/docs/class/src/Droppable/DroppableEvent/DroppableEvent.js~DroppableDroppedEvent.php
    ...
    if (isRestricted) {
        ...
        if (droppableOrigin !== "admin") {
            ...
            e.cancel();
												...
												<div class="tab-pane fade" id="kt_highlight_6148575062152" role="tabpanel">
													<div class="highlight-code">
