						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/general/draggable/cards.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
											<span class="menu-title">Draggable</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="cards">
										<a href="#cards" data-kt-scroll-toggle=""></a>Draggable Cards Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="pt-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574ec7000" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574ec7003" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574ec7000" role="tabpanel">
...
var swappable = new Sortable.default(containers, {
    ...
    mirror: {
        ...
        constrainDimensions: true
												...
												<div class="tab-pane fade" id="kt_highlight_6148574ec7003" role="tabpanel">
													<div class="highlight-code">
