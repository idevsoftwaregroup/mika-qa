				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/general/sticky.php">
										...
										<div class="py-10">
											...
											<div class="py-5">
												<ul class="py-0">
													...
													<li class="py-2">Add
														<code>data-kt-sticky="true"</code>to a HTML element to enable it. There are multiple additional HTML attributes you can include to configure Sticky directly.
													</li>
										...
										<div class="py-10">
											...
											<div class="py-5">
												<div class="mb-3">The example sticky component is previewed on the right side of the screen. There are a variety HTML attributes added in the
													...
													<a href="#options" class="me-1" data-kt-scroll-toggle="">markup reference</a>below to view what each of them do.
												</div>
											</div>
											<!--end::Block-->
											<!--begin::Notice-->
														...
														<tbody>
															...
															<tr>
																...
																<td>
																	...
																	<div class="mb-3">This is also compatible with Bootstrap's standard breakpoint sizing (eg:
																		...
																		<code>px</code>values. For responsive options, this attribute value must be written as an object string to enable multiple responsive breakpoints.
																	</div>For example:
															...
															<tr>
																...
																<td>
																	...
																	<code>md</code>and is
																	<code>auto</code>for every other screen size.
																</td>
															</tr>
															<tr>
																<td>
...
var sticky = new KTSticky(stickyElement);</code>
																	...
																	<div class="d-flex align-items-center rounded py-5 px-5 bg-light-success">
																		...
																		<div class="text-gray-700 fw-bold fs-6">Remove
																			<code>data-kt-sticky="true"</code>attribute to avoid lazy initialization.
																		</div>
																		<!--end::Description-->
																	</div>
																	<!--end::Information-->
