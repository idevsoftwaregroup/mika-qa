				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/general/smooth-scroll.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">
										...
										<a href="https://github.com/cferdinandi/smooth-scroll" target="_blank">plugin's site</a>.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
								...
								<div class="py-10">
									...
									<!--begin::Block-->
									<div class="py-5">
										<strong>Smooth Scroll</strong>'s Javascript files are bundled in the global scripts bundles and are globally included in all pages:
									</div>
									<!--end::Block-->
									<!--begin::Code-->
									<div class="py-5">
									...
									<div class="py-5">
										<ul class="py-0">
											...
											<li class="pt-2">For more information on Smooth Scroll's other options, please refer to the official
												<a href="https://github.com/cferdinandi/smooth-scroll" target="_blank">plugin site</a>.
											</li>
										</ul>
									</div>
									<!--end::Block-->
...
&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="offset" data-kt-scroll-offset="85">
										<a href="#offset" data-kt-scroll-toggle=""></a>Offset Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Click on the button below to scroll to "Usage" with offset. Add the HTML attribute
										...
										<code>px</code>to the anchor element.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/div&gt;</code>
								...
								<div class="pt-10">
									<!--begin::Heading-->
									<h1 class="anchor fw-bolder mb-5" id="offset" data-kt-scroll-offset="85">
										<a href="#offset" data-kt-scroll-toggle=""></a>Responsive Offset Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
