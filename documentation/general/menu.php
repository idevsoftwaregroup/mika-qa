...
<head>
	<base href="../../">
	<title>Customm Bootstrap Menu component with Nested Dropdown &amp; Accordion Submenu by Keenthemes</title>
				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/general/menu.php">
									...
									<div class="py-5">
										<ul class="py-0">
											...
											<li class="py-2">Add
												...
												<code>click</code>or
												<code>hover</code>initialize the menu trigger type.
											</li>
											<li class="py-2">Add
												...
												<a href="#options" data-kt-scroll-toggle="">listed below</a>.
											</li>
											<li class="py-2">Add
												...
												<code>.menu-item</code>to enable a clean hover state effect.
											</li>
											<li class="py-2">Bootstrap Menu can be nested within itself to allow multiple tier menus. Please refer to our
												<a href="#nested" data-kt-scroll-toggle="">nested menu example below</a>.
											</li>
...
&lt;!--end::Menu--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="nested">
										<a href="#nested" data-kt-scroll-toggle=""></a>Nested Menu Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
												...
												<tbody>
													<tr>
														...
														<td>Sets the trigger method. Accepts values
															...
															<div class="mb-3">This is also compatible with Bootstrap's standard breakpoint sizing (eg:
																...
																<code>px</code>or
																<code>%</code>values. For responsive options, this attribute value must be written as an object string to enable multiple responsive breakpoints.
															</div>For example:
															...
															<code>lg</code>and
															<code>top</code>for every other screen size.
														</td>
													</tr>
													<tr>
														<td>
													...
													<tr>
														...
														<td>
															...
															<div class="mb-3">The first number indicates the horizontal offset value.</div>The second number indicates the vertical offset value.
														</td>
													</tr>
												</tbody>
											</table>
