				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/general/fslightbox.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">Fullscreen Lightbox, is en easy to use, but powerful plugin for displaying various types of sources in beautiful overlaying box with tons of features such as captions, thumbnails, zooming and more! Present single source or create beautiful gallery with stylish lightbox without jQuery! For more info see
										...
										<a class="fw-bolder" href="https://github.com/banthagroup">the Github repository</a>.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
...
<code class="language-html">&lt;script src="assets/plugins/custom/jslightbox/jslightbox.bundle.js"&gt;&lt;/script&gt;</code>
								...
								<div class="py-10">
									...
									<div class="py-5">Every
										...
										<code>data-fslightbox</code>attribute opens a lightbox. Value of href attribute will be shown in your box.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
