				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/general/stepper.php">
...
&lt;script src="assets/js/scripts.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-5">
										<ul class="py-0">
											...
											<li class="py-2">Stepper elements are defined with
												<code>data-kt-stepper-*</code>HTML attributes.
											</li>
								...
								<div class="py-10">
									...
									<div class="py-5">Use
										...
										<code>.stepper-pills</code>classes to enable a basic form steps with title, number and icon elements:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148575da0f08" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148575da0f0b" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148575da0f08" role="tabpanel">
													<div class="highlight-code">
...
stepper.on("kt.stepper.previous", function (stepper) {
    stepper.goPrevious(); // go previous step
												...
												<div class="tab-pane fade" id="kt_highlight_6148575da0f0b" role="tabpanel">
													<div class="highlight-code">
...
&lt;!--end::Stepper--&gt;</code>
								...
								<div class="py-10">
									<!--begin::Heading-->
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="basic">
										<a href="#basic" data-kt-scroll-toggle=""></a>Vertical Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.stepper-column</code>class to enable a stepper with vertical navigation layout:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148575da118d" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148575da118f" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148575da118d" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">// Stepper lement
...
stepper.on("kt.stepper.previous", function (stepper) {
    stepper.goPrevious(); // go previous step
												...
												<div class="tab-pane fade" id="kt_highlight_6148575da118f" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Stepper--&gt;
&lt;div class="stepper stepper-pills stepper-column d-flex flex-column flex-lg-row" id="kt_stepper_example_vertical"&gt;
...
&lt;!--end::Stepper--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="clickable">
										<a href="#clickable" data-kt-scroll-toggle=""></a>Clickable Navigation
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Add
										<code>data-kt-stepper-action="step"</code>attribute to Stepper navigation links to setup a Stepper with clickable navigation:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148575da141b" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148575da141d" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148575da141b" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">// Stepper lement
...
stepper.on("kt.stepper.click", function (stepper) {
    stepper.goTo(stepper.getClickedStepIndex()); // go to clicked step
												...
												<div class="tab-pane fade" id="kt_highlight_6148575da141d" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Stepper--&gt;
&lt;div class="stepper stepper-pills" id="kt_stepper_example_clickable"&gt;
									...
									<div class="py-5">
										...
										<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
											...
											<div class="text-gray-700 fw-bold fs-6">
												...
												<code>data-kt-stepper-element="content"</code>elements to highlight current, pending and competed step states.
											</div>
											<!--end::Description-->
										</div>
										<!--end::Information-->
