				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/general/typedjs.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">
										...
										<a class="fw-bolder" href="https://github.com/mattboldt/typed.js">the Github repository</a>.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
								...
								<div class="py-10">
									...
									<!--begin::Block-->
									<div class="py-5">
										<b>Typed.js's</b>&#160; Javascript files are bundled in a custom bundle file and included on demand as shown below:
									</div>
									<!--end::Block-->
									<!--begin::Code-->
									<div class="py-5">
...
<code class="language-html">&lt;script src="assets/plugins/custom/typedjs/typedjs.bundle.js"&gt;&lt;/script&gt;</code>
								...
								<div class="pt-10">
									...
									<div class="py-5">A basic
										<b>Typed.js</b>&#160; example with text options to auto type with typing speed:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61485761d757a" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61485761d757d" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_61485761d757a" role="tabpanel">
													<div class="highlight-code">
...
<code class="language-javascript">var typed = new Typed("#kt_typedjs_example_1", {
    ...
    typeSpeed: 30
												...
												<div class="tab-pane fade" id="kt_highlight_61485761d757d" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
