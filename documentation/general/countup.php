				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/general/countup.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">CountUp.js is a dependency-free, lightweight Javascript class that can be used to quickly create animations that display numerical data in a more interesting way. For more info see
										...
										<a class="fw-bolder" href="https://github.com/inorganik/CountUp.js">the Github repository</a>.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
...
&lt;script src="assets/js/scripts.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-5">
										<ul class="py-0">
											...
											<li class="py-2">To include CountUp into your project, you need to include a HTML attribute
												...
												<a href="#options" data-kt-scroll-toggle="">options below</a>.
											</li>
											<li class="pt-2">CountUp instances can also be controlled programmatically. For more information on Smooth Scroll's other options, please refer to the official
												<a href="https://inorganik.github.io/countUp.js/" target="_blank">plugin site</a>.
											</li>
										</ul>
									</div>
									<!--end::Block-->
								...
								<div class="py-10">
									...
									<div class="py-5">CountUp uses HTML attributes to set specific configurations. Here are some references for each below. For complete list of options, please refer to the
										<a href="https://github.com/ganlanyuan/tiny-slider" target="_blank">official documentation</a>.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="basic">
										<a href="#basic" data-kt-scroll-toggle=""></a>CountUp.js Examples
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Visit CountUp.js's
										<a href="https://inorganik.github.io/countUp.js/" class="me-1">official website</a>for more examples.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574d446cf" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574d446cf" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
...
&lt;/div&gt;</code>
								...
								<div class="py-10">
									<!--begin::Heading-->
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="basic">
										<a href="#basic" data-kt-scroll-toggle=""></a>Custom Examples
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574d44d10" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574d44d10" role="tabpanel">
													<div class="highlight-code">
...
&lt;/div&gt;</code>
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="tab">
										<a href="#tab" data-kt-scroll-toggle=""></a>CountUp.js Example within Tabs
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Here's a demo where CountUp will only start when visible within a tab container. Add
										...
										<code>data-bs-toggle="tab"</code>HTML attribute to define that the tab content has a CountUp element.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="pt-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574d458a1" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574d458a1" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
