				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/general/swapper.php">
									...
									<div class="py-5">
										<ul class="py-0">
											<li class="py-2">Swapper is initialized by adding
												<code>data-kt-swapper="true"</code>to the root of the HTML that will be swapped positions.
											</li>
											<li class="py-2">Add
												<code>data-kt-swapper-mode="prepend"</code>to the root HTML element to configure if the swapped element would be appended or prepended within the parent.
											</li>
											<li class="py-2">Add
												<code>data-kt-swapper-parent="{default: '#parent_container_1', lg: '#parent_container_2'}"</code>to identify the parent containers that the swapping component will be added into based on Bootstrap's breakpoint sizes.
											</li>
