						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/general/vis-timeline/group.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
									...
									<div class="text-gray-700 fw-bold fs-6 lh-lg">Vis-timeline is an interactive visualization chart to visualize data in time. For more info visit
										<a class="fw-bolder" href="https://github.com/visjs/vis-timeline">the Github repository</a>.
									</div>
									<!--end::Description-->
								</div>
								<!--end::Notice-->
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="group">
										<a href="#group" data-kt-scroll-toggle=""></a>Groups Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">
										...
										<a href="https://github.com/visjs/vis-timeline" target="_blank">official website</a>.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
										...
										<div class="mb-5">
											<div class="fw-bolder mb-5">Visible groups:
												<span id="visibleGroupsContainer" class="fw-normal"></span>
											</div>(Scroll with the mouse and see the items being focus automatically on the timeline)
										</div>
									...
									<div class="pt-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61485763cb2f9" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61485763cb2fd" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_61485763cb2f9" role="tabpanel">
...
button.addEventListener('click', e =&gt; {
    ...
    document.getElementById("visibleGroupsContainer").innerHTML += a;
												...
												<div class="tab-pane fade" id="kt_highlight_61485763cb2fd" role="tabpanel">
													<div class="highlight-code">
