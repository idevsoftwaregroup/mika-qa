						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/general/jkanban/restricted.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
											<span class="menu-title">Restricted</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
									...
									<div class="text-gray-700 fw-bold fs-6 lh-lg">jKanban is a pure agnostic Javascript plugin for Kanban boards. For more info see
										...
										<a class="fw-bolder" href="https://github.com/riktar/jkanban">the Github repository</a>.
									</div>
									<!--end::Description-->
								</div>
								<!--end::Notice-->
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="restricted">
										<a href="#restricted" data-kt-scroll-toggle=""></a>Restricted Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">
										<div class="mb-3">Here's a restricted jKanban Board example, where only specific inner blocks can be placed into allowed columns. For more info, please visit the
											<a href="http://www.riccardotartaglia.it/jkanban/" target="_blank">official website</a>.
										</div>
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61485756de85b" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61485756de862" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_61485756de85b" role="tabpanel">
            ...
            'item': [{
                ...
                },
                {
                    'title': '&lt;span class="font-weight-bold"&gt;Ok!&lt;/span&gt;'
												...
												<div class="tab-pane fade" id="kt_highlight_61485756de862" role="tabpanel">
													<div class="highlight-code">
