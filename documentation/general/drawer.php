				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/general/drawer.php">
...
&lt;!--end::View component--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="advanced">
										<a href="#advanced" data-kt-scroll-toggle=""></a>Advanced Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
...
&lt;!--end::View component--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="dismiss">
										<a href="#dismiss" data-kt-scroll-toggle=""></a>Adhoc Dismiss Button Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
...
&lt;!--end::View component--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="external">
										<a href="#external" data-kt-scroll-toggle=""></a>External Toggle Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															<div class="mb-3">This is also compatible with Bootstrap's standard breakpoint sizing
																<code>eg: sm, md, lg, xl</code>. For responsive options, this attribute value must be written as a JSON string to specify values for multiple responsive breakpoints.
															</div>For example:
															<code>{default: false, md: true}</code>indicates that the drawer is activated only when width on screens larger than
															<code>md</code>breakpoint size.
														</td>
													</tr>
													<tr>
														<td>
													...
													<tr>
														...
														<td>Defines the close button
															<code>id</code>within the drawer view component.
														</td>
													</tr>
													<tr>
														<td>
...
var scroll = new KTDrawer(scrollElement, {overlay: true});</code>
															...
															<div class="d-flex align-items-center rounded py-5 px-5 bg-light-info">
																...
																<div class="text-gray-700 fw-bold fs-6">Remove
																	...
																	<code>data-kt-drawer-overlay</code>option functionaliy as described above.
																</div>
																<!--end::Description-->
															</div>
															<!--end::Information-->
