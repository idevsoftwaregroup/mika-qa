				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/general/scroll.php">
...
&lt;script src="assets/js/scripts.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-5">
										<ul class="py-0">
											...
											<li class="py-2">To initialize it, simply add the
												<code>.scroll</code>CSS class to the required HTML container.
											</li>
								...
								<div class="py-10">
									...
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.scroll</code>in a HTML container with a suitable fixed height for a basic scroll bar:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="hover">
										<a href="#hover" data-kt-scroll-toggle=""></a>Hover Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.hover-scroll</code>in a HTML container with a suitable fixed height to display the scrollbar on hover:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="overlay_hover">
										<a href="#overlay_hover" data-kt-scroll-toggle=""></a>Hover Overlay Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.hover-scroll-overlay-y</code>in a HTML container with a suitable fixed height to display the scrollbar with an overlay on hover. This ensures that the scrollbar is always within the specifiec container:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="js-auto-height">
										<a href="#js-auto-height" data-kt-scroll-toggle=""></a>Smart Height Calculation Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
...
&lt;!--end::Footer--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="js-fixed-height">
										<a href="#js-fixed-height" data-kt-scroll-toggle=""></a>Fixed Height Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
										...
										<div class="py-5">
											...
											<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
												...
												<div class="text-gray-700 fw-bold fs-6">Please note that the classes above is not required to be paired with the default
													...
													<code>.hover-scroll</code>is only required.
												</div>
												<!--end::Description-->
											</div>
											<!--end::Information-->
													...
													<tbody>
														<tr>
															...
															<td>Accepts
																...
																<code>KTScroll</code>Javascript class automatically initializes the scroll instance with smart height calculation.
															</td>
														</tr>
														<tr>
															<td>
															...
															<td>
																...
																<div class="mb-3">It uses Bootstrap's standard breakpoint sizing (eg:
																	...
																	<code>true</code>or
																	<code>false</code>value. This attribute value can be written as an object string to enable multiple responsive breakpoints.
																</div>For example:
																<code>{default: false, lg: true}</code>specifies that the smart height calculation will only fire on
																<code>lg</code>screen sizes and above.
															</td>
														</tr>
														<tr>
															<td>
															...
															<td>
																...
																<div class="mb-3">You can also use the Bootstrap's standard breakpoint size options
																	...
																	<code>{default: '200px', lg: '400px'}</code>
																</div>When
																<code>auto</code>value is set, Scroll does the smart height calculation by subtracting from browser's window height, the dependencies and wrapper elements heights, such as border width, padding top, padding bottom, margin top and margin bottom style values dynamically.
															</td>
														</tr>
														<tr>
															<td>
															...
															<td>
																...
																<code>auto</code>value is set, Scroll does the smart minimum height calculation by subtracting from browser's window height, the dependencies and wrapper elements heights, such as border width, padding top, padding bottom, margin top and margin bottom style values dynamically.
															</td>
														</tr>
														<tr>
															<td>
															...
															<td>
																...
																<code>auto</code>value is set, Scroll does the smart maximum height calculation by subtracting from browser's window height, the dependencies and wrapper elements heights, such as border width, padding top, padding bottom, margin top and margin bottom style values dynamically.
															</td>
														</tr>
														<tr>
															<td>
														...
														<tr>
															...
															<td>
																...
																<code>#kt_aside_menu, #kt_aside_footer, #kt_aside_body</code>
															</td>
														</tr>
														<tr>
															<td>
															...
															<td>
																...
																<div class="mb-3">You can also use the Bootstrap's standard breakpoint size options (
																	<code>sm, md, lg, xl</code>) to specify conditional height values for different screen sizes. For example:
																	<code>{default: '20px', lg: '40px'}</code>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div class="mb-3">Accepts
																	...
																	<code>false</code>values, when
																	<code>true</code>is set
																	<code>KTScroll</code>remembers last scroll position in user Cookies and on page reload automatically initializes the scroll with last scrolled position.
																</div>
...
var scroll = new KTScroll(scrollElement, {saveState: true});</code>
																...
																<div class="d-flex align-items-center rounded py-5 px-5 bg-light-info">
																	...
																	<div class="text-gray-700 fw-bold fs-6">Remove
																		...
																		<code>data-kt-scroll-save-state</code>option functionaliy as described above.
																	</div>
																	<!--end::Description-->
																</div>
																<!--end::Information-->
