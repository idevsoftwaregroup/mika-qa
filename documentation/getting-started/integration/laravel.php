							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="pt-5">This documentation manual will explain how to implement Keenthemes designed admin dashboard theme
										...
										<b>Metronic</b>, Laravel and Webpack.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
								...
								<div class="py-10">
									...
									<div class="py-0 m-0">
										<ol>
											<li class="py-3">
												<a class="fw-bold" href="https://www.php.net/">PHP</a>.
											</li>
											<li class="py-3">
												<a class="fw-bold" href="https://getcomposer.org/">Composer</a>&#160;- a Dependency Manager for PHP.
											</li>
											<li class="py-3">Install
												...
												<a href="" class="fw-bold">Webpack Quick Start</a>.
											</li>
										</ol>
									</div>
									<!--end::Block-->
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="create-app">
										<a href="#create-blazor-app"></a>Create Laravel Application
									</h1>
									<!--end::Heading-->
									<!--begin::List-->
									<ol class="py-0 m-0">
...
<code class="language-bash">cd laravel</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="preparing_theme_assets">
										<a href="#preparing_theme_assets"></a>Preparing Theme Assets
									</h1>
									<!--end::Heading-->
									<ol>
										<!--begin::Block-->
										<li class="py-3">Copy source folder from
											...
											<code>laravel/resources</code>.
										</li>
										<!--end::Block-->
										<li class="py-3">
											<div class="pb-3">In Metronic some plugins and components pages are located inside
												<code>tools/webpack</code>folder, so we need to move them into the same src folder in laravel project.
											</div>
											<div class="pt-3">Copy
												<code>tools/webpack</code>folder and paste it into
												<code>laravel/resources/src</code>.
											</div>
										</li>
									</ol>
								</div>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="fix_style_import_paths">
										<a href="#fix_style_import_paths"></a>Fix Style Import Paths
									</h1>
									<!--end::Heading-->
									<ol>
										<li>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="preparing_theme_dependencies">
										<a href="#preparing_theme_dependencies"></a>Preparing Theme Dependencies
									</h1>
									<!--end::Heading-->
									<ol>
										<!--begin::Block-->
										<li class="py-3">To prepare theme dependencies we can just copy devDependencies and dependencies sections from
											...
											<code>laravel/package.json</code>.
										</li>
										<!--end::Block-->
										<div class="py-3">
											<!--begin::Highlight-->
    ...
    "devDependencies": {
        ...
        "yarn-install": "^1.0.0"
										...
										<li class="py-3">Now we can fetch the dependencies. Run this command in Laravel application root (where
											<code>package.json</code>is placed)
										</li>
										<div class="py-3">
											<!--begin::Highlight-->
											<div class="highlight">
...
<code class="language-bash">npm install</code>
								...
								<div class="pb-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="preparing_mix_config">
										<a href="#preparing_mix_config"></a>Preparing Mix Config
									</h1>
									<!--end::Heading-->
									<ol>
										<li>
...
// ], 'public/plugins/custom/fullcalendar/fullcalendar.bundle.css');</code>
											...
											<div class="py-3">
												...
												<div class="d-flex align-items-center rounded py-5 px-5 bg-light-info">
													...
													<div class="text-gray-700 fw-bold fs-6">This webpack.mix.js configuration file will bundle all source files which theme is requiring. Bundled files will be placed into
														<code>laravel/public</code>folder.
													</div>
													<!--end::Description-->
												</div>
												<!--end::Information-->
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="compile_assets">
										<a href="#compile_assets"></a>Compile Assets
									</h1>
									<!--end::Heading-->
									<ol>
										<li>
...
<code class="language-bash">npm run dev</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="sample_page">
										<a href="#sample_page"></a>Sample Page
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="pt-5">For the sample page you can use
										<code>dist/#</code>code or
										<a href="https://preview.keenthemes.com/metronic8/demo7/layout-builder.php" target="_blank">Layout Builder</a>&#160;to export the layout's HTML code and paste it into
										<code>laravel/resources/views/welcome.blade.php</code>
									</div>
									<!--end::Block-->
									<div class="pt-5">
										<!--begin::Information-->
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="run-application">
										<a href="#overview"></a>Run Application:
									</h1>
									<!--end::Heading-->
									<!--begin::List-->
									<ol class="py-0 m-0">
...
<code class="language-bash">php artisan serve</code>
										...
										<li class="py-3">Wait for the app to display that it's listening on
											<a href="http://127.0.0.1:8000">http://127.0.0.1:8000</a>&#160; and open this url in your browser.
										</li>
									</ol>
									<!--end::List-->
								</div>
