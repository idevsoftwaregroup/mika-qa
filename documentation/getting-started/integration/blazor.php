					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/getting-started/integration/blazor.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="pt-5">This documentation will show how to make a basic integration between
										<b>Metronic</b>&#160;and
										<a class="fw-bold" href="https://dotnet.microsoft.com/apps/aspnet/web-apps/blazor" target="_blank">Blazor Framework</a>.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
									...
									<div class="py-0 m-0">
										<ol>
											<li class="py-3">Download and install
												<a href="https://dotnet.microsoft.com/download" class="fw-bold">.NET SDK</a>.
											</li>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="create-app">
										<a href="#create-blazor-app"></a>Create Blazor Application
									</h1>
									<!--end::Heading-->
									<!--begin::List-->
									<ol class="py-0 m-0">
...
<code class="language-bash">cd BlazorApp</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="initialize-npm">
										<a href="#initialize-npm"></a>Initialize NPM:
									</h1>
									<!--end::Heading-->
									<!--begin::List-->
									<ol class="py-0 m-0">
											...
											<div class="pt-2 pb-5">
												...
												<div class="d-flex align-items-center rounded py-5 px-5 bg-light-info">
													...
													<div class="text-gray-700 fw-bold fs-6">This will create a new
														...
														<b>npmjs</b>&#160; directory and initialize it with default settings.
													</div>
													<!--end::Description-->
												</div>
												<!--end::Information-->
...
<code class="language-bash">npm install</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="setup-theme-dependacies">
										<a href="#overview"></a>Setup Theme Dependencies:
									</h1>
									<!--end::Heading-->
									<!--begin::List-->
									<ol class="py-5 m-0">
										...
										<li class="py-3">
											...
											<div class="pb-3">Copy
												...
												<code>npmjs/src/sass/components/components.scss</code>.
											</div>Inside file
										...
										<li class="py-3">Place
											...
											<code>BlazorApp/wwwroot/assets</code>.
										</li>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="setup-webpack">
										<a href="#setup-webpack"></a>Setup Webpack:
									</h1>
									<!--end::Heading-->
									<!--begin::List-->
									<ol class="py-0">
                            ...
                            publicPath: (url, resourcePath, context) =&gt; {
                                return '../';
										...
										<li class="py-3">Add an npm build script that will help us to bundle assets. Modify the
											...
											<code>package.json</code>file to add the following build script.
										</li>
										<div class="py-5">
											<!--begin::Highlight-->
											<div class="highlight">
...
<code class="language-bash">dotnet watch run</code>
										...
										<li class="py-3">Wait for the app to display that it's listening on
											<a href="http://localhost:5000">http://localhost:5000</a>&#160; and for the browser to launch at that address.
										</li>
									</ol>
									<!--end::List-->
								</div>
