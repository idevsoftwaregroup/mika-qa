					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/getting-started/customization/sass.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="pt-5">Metronic uses
										<a class="fw-bold" href="https://sass-lang.com/">SASS</a>&#160;, the most powerful CSS preprocessor for handling the theme css efficiently. Sass is the most mature, stable, and powerful professional grade CSS extension language in the world.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-2" id="bootstrap-variables">
										<a href="#bootstrap-variables"></a>Bootstrap Variables
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">In
										...
										<a class="fw-bold" href="https://getbootstrap.com/docs/4.5/getting-started/theming/">the official documentation</a>.
									</div>
									<!--end::Block-->
									<div class="pt-2 pb-5">
										<!--begin::Information-->
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-2" id="override-variables">
										<a href="#override-variables"></a>Override Variables
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">If you like to change the Bootstrap theme colors, border radiuses, font family and other variables, we suggest using
										...
										<code>!default</code>attribute to prioritize your code change.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
								...
								<div class="py-10">
									...
									<div class="py-5">Layout related SASS code is located in
										<code>/src/sass/layout/</code>folder. This folder contains the layout's markup and SASS variables files as explained in the below table:
									</div>
									<!--end::Block-->
									<!--begin::Table-->
									<div class="py-5">
								...
								<div class="pt-10">
									...
									<ul class="pt-5">
										...
										<li class="py-3">All 3rd-party plugins css files are bundled into the plugins bundle CSS file and globally included in all pages.
											<code>dist/assets/plugins/global/plugins.bundle.css</code>.
										</li>
									</ul>
									<!--end::Block-->
								</div>
