						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/getting-started/build/gulp.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
									...
									<div class="text-gray-700 fw-bold fs-6 lh-lg">Metronic's
										<a class="fw-bold me-1" href="https://gulpjs.com/" target="_blank">Gulp</a>build tools provide easy package management and production deployment for any type of web application that also comes with powerful asset bundle tools to organize assets structure with custom bundling for production.
									</div>
									<!--end::Description-->
								</div>
								<!--end::Notice-->
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="gulp-quick-start">
										<a href="#gulp-quick-start"></a>Gulp Quick Start
									</h1>
									<!--end::Heading-->
									<!--begin::List-->
									<ol class="py-5">
										<li class="pt-0 pb-3">Download the latest theme source from the
											<a href="https://1.envato.market/EA4JP" class="fw-bold">Marketplace</a>.
										</li>
											...
											<div class="pt-2 pb-5">
												...
												<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
													...
													<div class="text-gray-700 fw-bold fs-6">Don't forget to run
														...
														<br />Use
														<code>npm cache clean --force</code>command, if the installation had failed at any step. Retry again from beginning once it's done.
													</div>
													<!--end::Description-->
												</div>
												<!--end::Information-->
											...
											<div class="pt-2 pb-5">
												...
												<div class="d-flex align-items-center rounded py-5 px-5 bg-light-danger">
													...
													<div class="text-gray-700 fw-bold fs-6">We recommend using
														...
														<code>resolutions: { "gulp-dart-sass/sass": "1.32.13" }</code>.
													</div>
													<!--end::Description-->
												</div>
												<!--end::Information-->
...
<code class="language-bash">gulp localhost</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="gulp-build-options">
										<a href="#gulp-build-options"></a>Gulp Build Options
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="pt-5">The build config file is located at
										<code>tools/gulp.config.json</code>and you can fully customize the build settings to meet your project requirements.
									</div>
									<!--end::Block-->
									<!--begin::Code-->
									<div class="py-5">
                ...
                "datatables.net": {
                    "src": {
                        ...
                        "scripts": [
                            ...
                            "{$config.path.node_modules}/datatables.net-buttons/js/buttons.php5.js",
            ...
            "dist": {
                "media": "{$config.dist}/api/"
								...
								<div class="py-10">
									<!--begin::Heading-->
									<h1 class="anchor fw-bolder mb-5" id="gulp-build-options">
										<a href="#gulp-build-options"></a>Gulp Build Tasks
									</h1>
									<!--end::Heading-->
									<!--begin::Notice-->
									<div class="py-5">
...
<code class="language-bash">yarn</code>
									...
									<div class="py-5">
										<p class="mb-0">After every modification in
											...
											<code>/tools/gulp.config.json</code>:
										</p>
										<div class="py-5">
											<!--begin::Highlight-->
											<div class="highlight">
...
<code class="language-bash">gulp --demo1</code>
									...
									<div class="py-5">
										<p class="mb-0">Provide parameter
											<code>--rtl</code>to the gulp task. This command will disable RTL CSS from generating. If this param does not exist, by default, RTL CSS will be generated.
										</p>
										<div class="py-5">
											<!--begin::Highlight-->
											<div class="highlight">
...
<code class="language-bash">gulp --rtl --demo1</code>
									...
									<div class="py-5">
										<p class="mb-0">Provide parameter
											<code>--js</code>to the gulp task. This command will generate javascript assets only.
										</p>
										<div class="py-5">
											<!--begin::Highlight-->
											<div class="highlight">
...
<code class="language-bash">gulp --js --demo1</code>
									...
									<div class="py-5">
										<p class="mb-0">Provide parameter
											<code>--sass</code>to the gulp task. This command will generate SCSS, SASS and CSS assets only.
										</p>
										<div class="py-5">
											<!--begin::Highlight-->
											<div class="highlight">
...
<code class="language-bash">gulp --sass --demo1</code>
									...
									<div class="py-5">
										<p class="mb-0">Provide parameter
											<code>--media</code>to the gulp task. This command will generate all media, fonts, images, etc. assets only.
										</p>
										<div class="py-5">
											<!--begin::Highlight-->
											<div class="highlight">
...
<code class="language-bash">gulp --media --demo1</code>
									...
									<div class="py-5">
										<p class="mb-0">Provide parameter
											<code>--prod</code>to the gulp task. This command will minify all the JS and CSS.
										</p>
										<div class="py-5">
											<!--begin::Highlight-->
											<div class="highlight">
...
<code class="language-bash">gulp --prod --demo1</code>
									...
									<div class="py-5">
										<p class="">The customization should be done in
											...
											<code>theme/dist/</code>. The bellow command is to start a real-time watcher. This task watches the SCSS and Javascript files and automatically recompile whenever the source files are changed. You also can run watcher separately for JS and SCSS.
										</p>
										<p class="mb-0"></p>
										<div class="py-5">
											<!--begin::Highlight-->
...
<code class="language-bash">gulp watch --demo1</code>
								...
								<div class="pt-10">
									<!--begin::Heading-->
									<h1 class="anchor fw-bolder mb-5" id="gulp-build-options">
										<a href="#gulp-build-options"></a>Localhost
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">
										<p class="mb-0">Metronic uses
											<a href="https://www.npmjs.com/package/gulp-connect" target="_blank" class="fw-bolder me-1">Gulp-connect</a>plugin use to run a simple webserver for quick browsing the HTML templatest:
										</p>
										<div class="py-5">
											<!--begin::Highlight-->
											<div class="highlight">
