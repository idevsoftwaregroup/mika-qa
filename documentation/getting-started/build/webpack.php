						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/getting-started/build/webpack.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
									...
									<div class="text-gray-700 fw-bold fs-6 lh-lg">Webpack is a module bundler primarily for JavaScript, but it can transform front-end assets like HTML, CSS, and images if the corresponding plugins are included. Webpack takes modules with dependencies and generates static assets representing those modules. More information can be found in the
										<a href="https://webpack.js.org/&gt;" class="fw-bold">official Webpack site</a>.
									</div>
									<!--end::Description-->
								</div>
								<!--end::Notice-->
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="gulp-quick-start">
										<a href="#gulp-quick-start"></a>Webpack Quick Start
									</h1>
									<!--end::Heading-->
									<!--begin::List-->
									<ol class="py-5">
											...
											<div class="pt-2 pb-5">
												...
												<div class="d-flex align-items-center rounded py-5 px-5 bg-light-danger">
													...
													<div class="text-gray-700 fw-bold fs-6">Note on the
														...
														<code>"type": "module"</code>. Otherwise, it will cause compilation error when running the next command.
													</div>
													<!--end::Description-->
												</div>
												<!--end::Information-->
...
<code class="language-bash">gulp localhost</code>
									...
									<div class="pt-2 pb-5">
										...
										<div class="d-flex align-items-center rounded py-5 px-5 bg-light-danger">
											...
											<div class="text-gray-700 fw-bold fs-6">If you are getting this error
												...
												<code>package.json</code>file" above.
											</div>
											<!--end::Description-->
										</div>
										<!--end::Information-->
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="build-options">
										<a href="#build-options"></a>Build Options
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="pt-5">The main webpack build config file is located in
										<code>tools/webpack.config.js</code>and you can fully customize the build settings to meet your project requirements.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
...
<code class="language-bash">npm run build --js --demo1</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="adding-new-plugins">
										<a href="#adding-new-plugins"></a>Adding New Plugins
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">Follow the below steps to add a new plugin into the main bundle or as a separate bundle:
										...
										<ol class="py-5">
											<li class="pt-0 pb-3">Get the new plugin package from yarn site
												...
												<a href="https://yarnpkg.com/en/docs/usage" class="fw-bold" target="_blank">Yarn Usage Docs</a>.
											</li>
...
<code class="language-bash">require("path/to/dist/package.css");</code>
								...
								<div class="py-10">
									...
									<div class="py-5">Below is a file structure inside the default Metronic's Webpack config. The Webpack config is located in
										<code>tools/webpack</code>folder.
									</div>
									<!--end::Block-->
									<!--begin::Table-->
									<div class="py-5">
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="integration">
										<a href="#integration"></a>Integration
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
...
<code class="language-js">function getEntryFiles() {
    ...
    return entries;
										...
										<p>
											...
											<code>C:\wamp64\www\keenthemes\_releases\metronic_html_v8.0.25\theme\demo1\src</code>
										</p>
										<p>These are the example output entry file paths to be passed into the Webpack
											...
											<code>value</code>is the source file paths.
										</p>
										<div class="py-5">
											<!--begin::Highlight-->
											<div class="highlight">
  ...
  // ....
									...
									<div class="pt-5">
										<p>Call the function above, to get the list of asset files. It should pass into the
											...
											<code>webpack.config.js</code>along with other Webpack configurations.
										</p>
										<p>
											...
											<code>theme/tools/webpack/</code>.
										</p>
										<p>Read more information about the
											<code>resolve.alias</code>on the Webpack documentation
											<a href="https://webpack.js.org/configuration/resolve/#resolvealias">https://webpack.js.org/configuration/resolve/#resolvealias</a>
										</p>
										<div class="py-5">
											<!--begin::Highlight-->
											<div class="highlight">
