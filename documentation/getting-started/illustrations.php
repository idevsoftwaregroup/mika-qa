				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/getting-started/illustrations.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="tab-content">
									...
									<div class="tab-pane fade show active" id="kt_illustration_sketchy-1">
										...
										<!--begin::More-->
										<div class="mb-5">
											<a href="https://mikapartners.co/products/sketchy-pro" class="btn btn-flex btn-link btn-color-primary">Learn more
									...
									<div class="tab-pane fade" id="kt_illustration_sigma-1">
										...
										<!--begin::More-->
										<div class="mb-5">
											<a href="https://mikapartners.co/products/sigma-pro" class="btn btn-flex btn-link btn-color-primary">Learn more
												<!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
												<span class="svg-icon ms-2 svg-icon-3">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														<rect opacity="0.5" x="18" y="13" width="13" height="2" rx="1" transform="rotate(-180 18 13)" fill="black" />
									...
									<div class="tab-pane fade" id="kt_illustration_dozzy-1">
										...
										<!--begin::More-->
										<div class="mb-5">
											<a href="https://mikapartners.co/products/doozy-pro" class="btn btn-flex btn-link btn-color-primary">Learn more
												<!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
												<span class="svg-icon ms-2 svg-icon-3">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														<rect opacity="0.5" x="18" y="13" width="13" height="2" rx="1" transform="rotate(-180 18 13)" fill="black" />
									...
									<div class="tab-pane fade" id="kt_illustration_unitedpalms-1">
										...
										<!--begin::More-->
										<div class="mb-5">
											<a href="https://mikapartners.co/products/unitedpalms-pro" class="btn btn-flex btn-link btn-color-primary">Learn more
												<!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
												<span class="svg-icon ms-2 svg-icon-3">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														<rect opacity="0.5" x="18" y="13" width="13" height="2" rx="1" transform="rotate(-180 18 13)" fill="black" />
