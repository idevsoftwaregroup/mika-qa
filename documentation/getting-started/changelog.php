				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/getting-started/changelog.php">
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../documentation/general/tiny-slider/overview.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Bootstrap Maxlength</code>plugin integration -
															<a href="../../documentation/forms/bootstrap-maxlength.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">CountUp</code>plugin integration -
															<a href="../../documentation/general/countup.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Select2</code>integration with
															<code>Bootstrap Input Group</code>-
															<a href="../../documentation/forms/select2#input-group.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Users Selection</code>modal example -
															<a href="../../modals/general/select-users.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Video Tutorials</code>from the core team -
															<a href="../../documentation/getting-started/video-tutorials.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Figma</code>file for demos, widgets, icons and general elements.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="https://blog.getbootstrap.com/2021/09/07/bootstrap-5-1-1/" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															<code class="ms-0">KTMenu</code>dropdown alignment issue on mobile mode.
														</li>
														<li class="py-2">
															<code class="ms-0">Customer App</code>filter modal datepicker validation issue -
															<a href="../../apps/customers/list.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Subscriptions App</code>filter modal datepicker validation issue -
															<a href="../../apps/subscriptions/list.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../demo8/dist/#" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Demo 9</code>complete layout and pages -
															<a href="../../demo9/dist/#" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Demo 6 Dark Mode</code>complete layout and pages -
															<a href="../../demo6/dist/#" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Demo 7 Dark Mode</code>complete layout and pages -
															<a href="#" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Ajax Server Side DataTables</code>improvements -
															<a href="../../documentation/general/datatables/server-side.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Autosize</code>textarea plugin integration -
															<a href="../../documentation/forms/autosize.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Bootstrap Vertical Tabs</code>integration -
															<a href="../../documentation/base/tabs.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">Removed
															...
															<code>KTMenu</code>instances to automatically handle the responsive and parent overflow modes.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">Fixed
															<code>KTMenu</code>responsive and parent overflow issues.
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../demo5/dist/#" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
														...
														<li class="py-2">
															...
															<a href="../../demo5/dist/documentation/getting-started.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Duotune</code>in-house designed with 400+ SVG icons -
															<a href="../../documentation/icons/duotune.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Multiple Illustrations Support</code>across pages and apps with in-house designed illustration sets -
															<a href="https://preview.keenthemes.com/metronic8/demo7/layout-builder.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Select2</code>country list with flag implementation -
															<a href="../../documentation/forms/select2.php#countries" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Select2</code>user list with avatar implementation -
															<a href="../../documentation/forms/select2.php#users" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Tagify</code>country list with flag implementation -
															<a href="../../documentation/forms/tagify.php#countries" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Tagify</code>user list with avatar implementation -
															<a href="../../documentation/forms/tagify.php#users" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															<code class="ms-0">design</code>folder added with in-house designed SVG illustrations and Duotune icons source files.
														</li>
														<li class="py-2">
															<code class="ms-0">KTStepper</code>wizard form validation flow improvements -
															<a href="../../pages/wizards/vertical.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
														...
														<li class="py-2">
															...
															<code>.container-xxl</code>in demos layouts for better responsivenes in small to medium desktops.
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../demo3/dist/#" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
														...
														<li class="py-2">
															...
															<a href="../../demo3/dist/documentation/getting-started.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
														...
														<li class="py-2">
															...
															<a href="../../documentation/general/jstree/overview.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Vis-Timeline</code>plugin integration -
															<a href="../../documentation/general/vis-timeline/overview.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="https://blog.getbootstrap.com/2021/08/04/bootstrap-5-1-0/" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">Fixed
															<code>KTBlockUI</code>build error in Webpack.
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../demo2/dist/#" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Demo 2 Dark Mode</code>complete documentation and components -
															<a href="../../demo2/dist/documentation/getting-started.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">BlockUI</code>in-house plugin -
															<a href="../../documentation/general/blockui.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">FormValidation</code>plugin integration -
															<a href="../../documentation/forms/formvalidation/overview.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Flot Charts</code>plugin integration -
															<a href="../../documentation/charts/flotcharts/overview.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Google Charts</code>plugin integration -
															<a href="../../documentation/charts/google-charts/overview.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Bootstrap Buttons with Badges</code>options -
															<a href="../../documentation/base/badges.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../layouts/toolbars/toolbar-4.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../documentation/general/jkanban/overview.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Cropper.js</code>plugin integration -
															<a href="../../documentation/general/cropper.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Bootstrap Menu</code>in-house component documentation -
															<a href="../../documentation/general/menu.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Bootstrap Buttons with Badges</code>options -
															<a href="../../documentation/base/badges.php" class="fw-bold" target="_blank">Preview</a>.
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="https://preview.keenthemes.com/metronic8/demo1/rtl/#" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Apexchart v3.27.3</code>update -
															<a href="../../documentation/charts/apexcharts.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														...
														<li class="py-2">
															...
															<a href="../../demo8/dist/documentation/getting-started.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../documentation/general/fullcalendar/overview.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../demo1/dist/#" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Demo 1 Dark Mode</code>complete documentation and components -
															<a href="../../demo1/dist/documentation/getting-started.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Demo 1 Compact</code>dashboard -
															<a href="../../demo1/dist/dashboards/compact.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
														...
														<li class="py-2">
															...
															<a href="../../demo4/dist/dashboards/compact.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														...
														<li class="py-2">
															...
															<a href="../../documentation/getting-started/references.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
											</div>
											...
											<div class="accordion-body ps-0 pt-0">
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">New
															<code>Demo 4</code>-
															<a href="../../demo4/dist/#" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">New
															<code>Calendar</code>app -
															<a href="../../apps/calendar.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">New
														...
														<li class="py-2">New
															...
															<a href="../../widgets/mixed.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														...
														<li class="py-2">
															...
															<a href="../../apps/support-center/overview.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														...
														<li class="py-2">
															...
															<a href="../../documentation/general/draggable/overview.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="https://blog.getbootstrap.com/2021/06/22/bootstrap-5-0-2/" class="fw-bold" target="_blank">Preview</a>.
														</li>
														...
														<li class="py-2">
															...
															<a href="../../apps/subscriptions/add.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Customers</code>app enhancements -
															<a href="../../apps/customers/view.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<code>Demo 5</code>toolbar/page title truncated on mobile mode.
														</li>
														<li class="py-2">
															<code class="ms-0">Datatable</code>sort icon position fix -
															<a href="../../documentation/general/datatables/basic.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														...
														<li class="py-2">
															...
															<a href="../../documentation/forms/password-meter.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Swapper</code>in-house plugin -
															<a href="../../documentation/general/swapper.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Quick Search</code>in-house plugin -
															<a href="../../documentation/general/search.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Sticky</code>in-house plugin -
															<a href="../../documentation/general/sticky.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Cookie</code>in-house plugin -
															<a href="../../documentation/general/cookie.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../apps/user-management/users/list.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Customers</code>app enhancements -
															<a href="../../apps/customers/view.php" class="fw-bold" target="_blank">Preview</a>.
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														...
														<li class="py-2">
															...
															<a href="../../apps/support-center/tickets/list.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Support Ticket View</code>page -
															<a href="../../apps/support-center/tickets/view.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Support Tutorials</code>page -
															<a href="../../apps/support-center/tutorials/list.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Support Tutorials Post</code>page -
															<a href="../../apps/support-center/tutorials/post.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Support FAQ</code>overview -
															<a href="../../apps/support-center/faq.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Support Licenses</code>overview -
															<a href="../../apps/support-center/licenses.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Support Contact Us</code>overview -
															<a href="../../apps/support-center/contact.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Image Input</code>in-house plugin documentation -
															<a href="../../documentation/forms/image-input.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Toggle</code>in-house plugin documentation -
															<a href="../../documentation/general/toggle.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Triangle Ribbon</code>in-house plugin new option -
															<a href="../../documentation/base/ribbon.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../layouts/aside/none.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../documentation/general/scroll.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Drawer</code>in-house plugin documentation -
															<a href="../../documentation/general/drawer.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="https://formvalidation.io/updates" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">Fixed
															<code class="ms-0">Form Check</code>validations show error message at a wrong place.
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="http://preview.keenthemes.com/metronic8/laravel/" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../documentation/getting-started/integration/blazor.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">Fixed
															...
															<code class="ms-0">gulp --demo5</code>
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../documentation/general/smooth-scroll.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Bootstrap Alerts</code>extended integration -
															<a href="../../documentation/base/alerts.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Bootstrap Tooltips</code>dismiss on click option -
															<a href="../../documentation/base/tooltips.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														...
														<li class="py-2">
															...
															<a href="../../documentation/forms/dropzonejs.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														...
														<li class="py-2">Fixed
															...
															<a href="../../authentication/flows/basic/sign-up.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="http://preview.keenthemes.com/metronic8/vue/demo1" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Toastr</code>plugin integration -
															<a href="../../documentation/general/toastr.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
														...
														<li class="py-2">
															...
															<a href="../../documentation/charts/chartjs.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../documentation/base/utilities.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">Fixed
															...
															<a href="../../documentation/general/stepper.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="../../pages/company/team.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Licenses</code>page -
															<a href="../../pages/company/licenses.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Sitemap</code>page -
															<a href="../../pages/company/sitemap.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">AmChart Charts</code>library integration -
															<a href="../../documentation/general/amcharts/charts.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">AmChart Maps</code>library integration -
															<a href="../../documentation/general/amcharts/maps.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">AmChart Stock Charts</code>library integration -
															<a href="../../documentation/general/amcharts/stock-charts.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Clipboard</code>plugin integration -
															<a href="../../documentation/forms/clipboard.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														...
														<li class="py-2">Extended
															...
															<a href="../../apps/user-management/users/view.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Advanced
															<code>User Roles</code>page with complete CRUD features -
															<a href="../../apps/user-management/roles/list.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Advanced
															<code>User Permissions</code>page with complete CRUD features -
															<a href="../../apps/user-management/permissions.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Handy
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="https://blog.getbootstrap.com/2021/05/13/bootstrap-5-0-1/" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code class="ms-0">Blazor</code>integration documentation enhancements -
															<a href="../../documentation/getting-started/integration/blazor.php" class="fw-bold" target="_blank">Preview</a>.
														...
														<li class="py-2">
															...
															<a href="../../documentation/base/cards.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														...
														<li class="py-2">Font icon
															...
															<a href="../../layouts/aside/font-icons.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">UX friendly
															<code>Landing</code>page sticky header -
															<a href="../../landing.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														...
														<li class="py-2">
															...
															<a href="../../apps/chat/group.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														...
														<li class="py-2">Handy
															...
															<a href="../../documentation/forms/bootstrap-multiselectsplitter.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">High demand
															<code>Google reCAPTCHA v3</code>plugin integration -
															<a href="../../documentation/forms/google-recaptcha.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Interactive
															<code>Typed.js</code>plugin integration -
															<a href="../../documentation/general/typedjs.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															...
															<a href="https://preview.keenthemes.com/metronic8/demo1/documentation/getting-started/integration/blazor.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Complete
															<code>Contact Us</code>page with feedback form and interactive map -
															<a href="https://preview.keenthemes.com/metronic8/demo1/pages/company/contact.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Extended
															<code>Bootstrap Tooltips</code>integration -
															<a href="https://preview.keenthemes.com/metronic8/demo1/documentation/base/tooltips.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Extended
															<code>Bootstrap Popover</code>integration -
															<a href="https://preview.keenthemes.com/metronic8/demo1/documentation/base/popovers.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															<code>Layout</code>enhancements for iOS v12.x &amp; v13.x
														</li>
														<li class="py-2">
															<code>Chat</code>app enhancements -
															<a href="https://preview.keenthemes.com/metronic8/demo1/apps/chat/group.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code>Subscriptions</code>app enhancements -
															<a href="https://preview.keenthemes.com/metronic8/demo1/apps/subscriptions/add.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">
															<code>Customers</code>app enhancements -
															<a href="https://preview.keenthemes.com/metronic8/demo1/apps/customers/view.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">Fixed
															<code>Menus</code>and
															<code>Drawers</code>toggle issue for iOS v12.x and v13.x.
														</li>
													</ul>
												</div>
											</div>
										...
										<div id="kt_accordion_body_v8_0_4" class="fs-6 mt-1 mb-1 py-0 ps-10 collapse" data-bs-parent="#kt_accordion">
											<div class="accordion-body ps-0 pt-0">
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">Creative
															...
															<a href="https://preview.keenthemes.com/metronic8/demo1/pages/company/about.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Complete
															<code>Pricing &amp; Plan Selection</code>page -
															<a href="https://preview.keenthemes.com/metronic8/demo1/pages/company/pricing.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Advanced
															<code>Careers Listing</code>page -
															<a href="https://preview.keenthemes.com/metronic8/demo1/pages/careers/list.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Fully functional
															<code>Careers Application</code>page
															<code>Topbar</code>chat button -
															<a href="https://preview.keenthemes.com/metronic8/demo1/pages/careers/apply.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Classic
															<code>FAQ</code>page -
															<a href="https://preview.keenthemes.com/metronic8/demo1/pages/faq/classic.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Extended
															<code>FAQ</code>page -
															<a href="https://preview.keenthemes.com/metronic8/demo1/pages/faq/extended.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">Fixed
															<code>Demo1</code>breadcrumb responsive issue on Mobile.
														</li>
														<li class="py-2">Fixed
															<code>Demo1</code>topbar icons tooltip issue on Mobile.
														</li>
													</ul>
												</div>
											</div>
										...
										<div id="kt_accordion_body_v8_0_3" class="fs-6 mt-1 mb-1 py-0 ps-10 collapse" data-bs-parent="#kt_accordion">
											<div class="accordion-body ps-0 pt-0">
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">Fully functional and flexible
															<code>Chat</code>app -
															<a href="https://preview.keenthemes.com/metronic8/demo1/apps/chat/private.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Extended
														...
														<li class="py-2">Extended
															...
															<a href="https://preview.keenthemes.com/metronic8/demo1/apps/chat/drawer.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Global
															<code>Quick Chat Messanger</code>feature launched with the
															<code>Topbar</code>chat button -
															<a href="https://preview.keenthemes.com/metronic8/demo1/#" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Complete
															<code>Invoice Management</code>app -
															<a href="https://preview.keenthemes.com/metronic8/demo1/apps/invoices/create.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Advanced
															<code>Invoice 1</code>template -
															<a href="https://preview.keenthemes.com/metronic8/demo1/apps/invoices/view/invoice-1.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Minimalistic
															<code>Invoice 2</code>template -
															<a href="https://preview.keenthemes.com/metronic8/demo1/apps/invoices/view/invoice-2.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">Fixed
															<code>Select2</code>search input focus issue on modal.
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">Fully functional
															...
															<a href="https://preview.keenthemes.com/metronic8/demo1/apps/subscriptions/getting-started.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Advanced
															<code>Subscriptions Listing</code>page -
															<a href="https://preview.keenthemes.com/metronic8/demo1/apps/subscriptions/list.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Detailed
															<code>Subscription View</code>page -
															<a href="https://preview.keenthemes.com/metronic8/demo1/apps/subscriptions/view.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Extended
														...
														<li class="py-2">Stylish
															...
															<a href="https://preview.keenthemes.com/metronic8/demo1/pages/pages/blog/home.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Well-structured
															<code>Blog Post</code>page -
															<a href="https://preview.keenthemes.com/metronic8/demo1/pages/pages/blog/post.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Awesome
															<code>Fullscreen Lightbox</code>plugin integration -
															<a href="https://preview.keenthemes.com/metronic8/demo1/documentation/general/fslightbox.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">
															<code>Customers</code>app Javascript files reorganization.
														</li>
														<li class="py-2">Remember
															<code>Demo 1 Aside Menu</code>last scroll position.
														</li>
														<li class="py-2">
															<code>DataTables</code>plugin documentation improvement -
															<a href="https://preview.keenthemes.com/metronic8/demo1/documentation/general/datatable/overview.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">Fully functional
															...
															<a href="https://preview.keenthemes.com/metronic8/demo1/apps/customers/getting-started.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Advanced
															<code>Customers Listing</code>page -
															<a href="https://preview.keenthemes.com/metronic8/demo1/apps/customers/list.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
														<li class="py-2">Detailed
														...
														<li class="py-2">Documentation for exclusive plugin
															<code>KTStepper</code>-
															<a href="https://preview.keenthemes.com/metronic8/demo1/documentation/general/stepper.php" class="fw-bold" target="_blank">Preview</a>.
														</li>
													</ul>
												</div>
												<div class="mb-5">
													...
													<ul class="my-0 py-0">
														<li class="py-2">Other
															<code>Documentation</code>improvements.
														</li>
													</ul>
												</div>
												<div class="mb-5">
