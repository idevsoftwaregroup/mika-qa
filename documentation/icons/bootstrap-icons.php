				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/icons/bootstrap-icons.php">
						...
						<div class="card card-docs mb-2">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<!--begin::Block-->
									<div class="py-5">
										<a href="https://icons.getbootstrap.com/" target="_blank" class="fw-bold">Bootstrap Icons</a>&#160; is a free, high quality, open source icon library with nearly 1,200 icons. Include them anyway you like SVGs, SVG sprite, or web fonts.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
								...
								<div class="py-10">
									...
									<div class="py-5">Use Bootstrap Icons with a spesific class as explained in the
										<a class="fw-bold" href="https://icons.getbootstrap.com/icons/alarm-fill/" target="_blank">Icons Preview Page</a>:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
