				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/forms/bootstrap-multiselectsplitter.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">
										...
										<a href="https://github.com/poolerMF/bootstrap-multiselectsplitter" target="_blank" class="fw-bold">plugin's repository</a>.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
								...
								<div class="py-10">
									...
									<!--begin::Block-->
									<div class="py-5">
										<b>Bootstrap Selectsplitter's</b>&#160; Javascript files are bundled in the global plugin bundles and globally included in all pages:
									</div>
									<!--end::Block-->
									<!--begin::Code-->
									<div class="py-5">
...
<code class="language-html">&lt;script src="assets/plugins/global/plugins.bundle.js"&gt;&lt;/script&gt;</code>
								...
								<div class="py-10">
									...
									<div class="py-5">Create a
										...
										<code>&lt;select&gt;</code>must have a unique value.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573791de3" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573791de7" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573791de3" role="tabpanel">
													<div class="highlight-code">
...
<code class="language-javascript">$("#kt_multiselectsplitter_example_1").multiselectsplitter();</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148573791de7" role="tabpanel">
													<div class="highlight-code">
								...
								<div class="py-10">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573791fed" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573791fef" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573791fed" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">$("#kt_multiselectsplitter_example_2").multiselectsplitter({
    ...
    groupCounter: true
												...
												<div class="tab-pane fade" id="kt_highlight_6148573791fef" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:300px">
								...
								<div class="py-10">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573792192" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573792194" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573792192" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">$("#kt_multiselectsplitter_example_3").multiselectsplitter({
    ...
    maximumSelected: 2
												...
												<div class="tab-pane fade" id="kt_highlight_6148573792194" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:300px">
								...
								<div class="py-10">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573792341" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573792343" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573792341" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">$("#kt_multiselectsplitter_example_4").multiselectsplitter({
    ...
    onlySameGroup: true
												...
												<div class="tab-pane fade" id="kt_highlight_6148573792343" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:300px">
								...
								<div class="pt-10">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61485737924df" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61485737924e2" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_61485737924df" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">$("#kt_multiselectsplitter_example_5").multiselectsplitter({
    ...
    createSecondSelect: function (label, $firstSelect) {
        return "&lt;option class=\"text-danger\"&gt; ??? &lt;/option&gt;";
												...
												<div class="tab-pane fade" id="kt_highlight_61485737924e2" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:300px">
