				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/forms/google-recaptcha.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">
										...
										<a href="https://developers.google.com/recaptcha/docs/v3" target="_blank" class="fw-bold">plugin's documentation</a>.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
								...
								<div class="py-10">
									...
									<!--begin::Block-->
									<div class="py-5">
										<b>Google reCAPTCHA v3</b>&#160; requires to include below Google Recaptcha API Javascript file on your page:
									</div>
									<!--end::Block-->
									<!--begin::Code-->
									<div class="py-5">
...
<code class="language-html">&lt;script src="https://www.google.com/recaptcha/api.js"&gt;&lt;/script&gt;</code>
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="example">
										<a href="#example"></a>Basic Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Below example shows how to include
										<b>Google reCAPTCHA v3</b>&#160; and perform a basic validation.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
												...
												<div class="form-group row mb-10">
													...
													<div class="col-lg-4 col-md-9 col-sm-12">
														...
														<div class="form-text text-muted">To learn more about Google reCaptcha please visit
															<a class="link" href="http://www.google.com/recaptcha" target="_blank">http://www.google.com/recaptcha</a>
														</div>
													</div>
												</div>
												<!--end::Input group-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857390e1b4" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857390e1b8" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857390e1b4" role="tabpanel">
													<div class="highlight-code">
...
<code class="language-javascript">grecaptcha.ready(function () {
    if (grecaptcha.getResponse() === "") {
        ...
        alert("Successful validation! Now you can submit this form to your server side processing.");
												...
												<div class="tab-pane fade" id="kt_highlight_614857390e1b8" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
