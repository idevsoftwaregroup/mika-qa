				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/forms/flatpickr.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">Lean, UX-driven, and extensible, yet it doesn’t depend on any libraries. There’s minimal UI but many themes. Rich, exposed APIs and event system make it suitable for any environment. For full documentation please check the
										<a href="https://flatpickr.js.org" target="_blank" class="fw-bold">plugin's site</a>.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
									...
									<div class="py-5">
										<ul class="py-0">
											...
											<li class="py-2">To start usin Flatpckr right away, check the official
												<a href="https://flatpickr.js.org/getting-started/" class="fw-bold" target="_blank">Getting Started</a>&#160;guide.
											</li>
										</ul>
									</div>
									<!--end::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573422a31" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573422a35" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573422a31" role="tabpanel">
													<div class="highlight-code">
...
$("#kt_datepicker_2").flatpickr();</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148573422a35" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
...
&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="datetime">
										<a href="#datetime"></a>DateTime
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Specify datetime format through
										<code>dateFormat</code>parameter to enable date and time selection.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573422bba" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573422bbc" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573422bba" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">$("#kt_datepicker_3").flatpickr({
    ...
    dateFormat: "Y-m-d H:i",
												...
												<div class="tab-pane fade" id="kt_highlight_6148573422bbc" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
...
&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="disabling-dates">
										<a href="#disabling-dates"></a>Disabling Dates
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>disable</code>option to make certain dates or range of dates unavailable for selection:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
            ...
            to: "2025-02-15"
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="multiple-dates">
										<a href="#multiple-dates"></a>Selecting Multiple Dates
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
    ...
    defaultDate: ["2025-01-05", "2025-01-10"]
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="range-selections">
										<a href="#range-selections"></a>Range Selections
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
    ...
    mode: "range"
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="time-picker">
										<a href="#time-picker"></a>Time Picker
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
    ...
    dateFormat: "H:i",
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="week-number">
										<a href="#week-number"></a>Week Numbers
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
								...
								<div class="pt-10">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573423622" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573423626" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573423622" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">$("#kt_datepicker_10").flatpickr();</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148573423626" role="tabpanel">
													<div class="highlight-code">
