				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/forms/bootstrap-maxlength.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">Bootstrap Maxlength is a visual feedback indicator for the maxlength attribute. For more info please visit the plugin's
										...
										<a href="https://github.com/mimo84/bootstrap-maxlength/" target="_blank">Github Repo</a>.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
...
<code class="language-html">&lt;script src="assets/plugins/global/plugins.bundle.js"&gt;&lt;/script&gt;</code>
								...
								<div class="py-10">
									...
									<div class="py-5">Basic example of a simple input with the
										<code>maxlength</code>HTML attribute to control the total number of characters allowed.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573711538" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857371153c" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573711538" role="tabpanel">
													<div class="highlight-code">
...
<code class="language-javascript">$('#kt_docs_maxlength_basic').maxlength({
    ...
    limitReachedClass: "badge badge-success"
												...
												<div class="tab-pane fade" id="kt_highlight_614857371153c" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
...
&lt;span class="fs-6 text-muted"&gt;The badge will show up by default when the remaining chars are 3 or less&lt;/span&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="threshold">
										<a href="#threshold"></a>Threshold Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">An example of Bootstrap Maxlength with a treshold option. The
										<code>threshold</code>option is to set the minimum number of characters that will display the badge.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61485737116dc" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61485737116de" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_61485737116dc" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">$('#kt_docs_maxlength_threshold').maxlength({
    ...
    limitReachedClass: "badge badge-success"
												...
												<div class="tab-pane fade" id="kt_highlight_61485737116de" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
								...
								<div class="py-10">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573711846" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573711855" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573711846" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">$('#kt_docs_maxlength_always_show').maxlength({
    ...
    limitReachedClass: "badge badge-success"
												...
												<div class="tab-pane fade" id="kt_highlight_6148573711855" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
<code class="language-html">&lt;label class="form-label"&gt;Threshold example&lt;/label&gt;
...
&lt;span class="fs-6 text-muted"&gt;Show the counter on input focus&lt;/span&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="custom-text">
										<a href="#custom-text"></a>Custom Text Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61485737119d9" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61485737119db" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_61485737119d9" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">$('#kt_docs_maxlength_custom_text').maxlength({
    ...
    validate: true
												...
												<div class="tab-pane fade" id="kt_highlight_61485737119db" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
...
&lt;span class="fs-6 text-muted"&gt;Display custom text on input focus&lt;/span&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="textarea">
										<a href="#textarea"></a>Textarea Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573711b71" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573711b73" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573711b71" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">$('#kt_docs_maxlength_textarea').maxlength({
    ...
    limitReachedClass: "badge badge-success"
												...
												<div class="tab-pane fade" id="kt_highlight_6148573711b73" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
...
&lt;span class="fs-6 text-muted"&gt;Bootstrap maxlength supports textarea as well as inputs&lt;/span&gt;</code>
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="position">
										<a href="#position"></a>Set Position Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="pt-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573711d2a" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573711d2c" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573711d2a" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">$('#kt_docs_maxlength_position_top_left').maxlength({
    ...
    limitReachedClass: "badge badge-primary"
												...
												<div class="tab-pane fade" id="kt_highlight_6148573711d2c" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
