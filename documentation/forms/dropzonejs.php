				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/forms/dropzonejs.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">
										...
										<a href="https://www.dropzonejs.com/" target="_blank" class="fw-bold">plugin's official site</a>.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
								...
								<div class="py-10">
									...
									<!--begin::Block-->
									<div class="py-5">
										<b>DropzoneJS's</b>&#160;CSS and Javascript files are bundled in the global plugin bundles and globally included in all pages:
									</div>
									<!--end::Block-->
									<!--begin::Code-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61485733a55ae" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61485733a55b1" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_61485733a55ae" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">var myDropzone = new Dropzone("#kt_dropzonejs_example_1", {
    url: "https://mikapartners.co/scripts/void.php", // Set the url for your upload script location
    ...
    accept: function(file, done) {
        if (file.name == "wow.jpg") {
												...
												<div class="tab-pane fade" id="kt_highlight_61485733a55b1" role="tabpanel">
													<div class="highlight-code">
								...
								<div class="py-10">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61485733a5745" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61485733a5747" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_61485733a5745" role="tabpanel">
													<div class="highlight-code">
...
previewNode.id = "";
var previewTemplate = previewNode.parent(".dropzone-items").php();
previewNode.remove();
...
myDropzone.on("removedfile", function(file){
    if(myDropzone.files.length &lt; 1) {
        $( id + " .dropzone-upload, " + id + " .dropzone-remove-all").css("display", "none");
												...
												<div class="tab-pane fade" id="kt_highlight_61485733a5747" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form class="form" action="#" method="post"&gt;
...
&lt;!--end::Form--&gt;</code>
								...
								<div class="pt-10">
									<!--begin::Heading-->
									<h1 class="anchor fw-bolder mb-5" id="queue">
										<a href="#queue"></a>Queue Auto Upload
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61485733a5915" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61485733a5918" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_61485733a5915" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// set the dropzone container id
...
myDropzone.on("complete", function(progress) {
    ...
    setTimeout(function(){
        $( thisProgressBar + " .progress-bar, " + thisProgressBar + " .progress").css("opacity", "0");
												...
												<div class="tab-pane fade" id="kt_highlight_61485733a5918" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form class="form" action="#" method="post"&gt;
