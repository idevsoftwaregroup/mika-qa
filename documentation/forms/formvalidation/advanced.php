						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/forms/formvalidation/advanced.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
									...
									<div class="text-gray-700 fw-bold fs-6 lh-lg">FormValidation is one of the best validation library for JavaScript. For more info see
										...
										<a class="fw-bolder" href="https://github.com/form-validation/formvalidation.io">the Github repository</a>.
									</div>
									<!--end::Description-->
								</div>
								<!--end::Notice-->
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="advanced">
										<a href="#advanced" data-kt-scroll-toggle=""></a>Advanced Inputs Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Here's an example of multiple advanced
										<code>input</code>types within a
										<code>form</code>that has FormValidation attached to it.
									</div>
									<!--end::Block-->
									<!--begin::Notice-->
									<div class="py-5">
										...
										<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
											...
											<div class="text-gray-700 fw-bold fs-6">All input types require the
												<code>name</code>attribute to bind the input field for validation.
											</div>
											<!--end::Description-->
										</div>
										<!--end::Information-->
									...
									<div class="py-5">
										...
										<div class="d-flex align-items-center rounded py-5 px-5 bg-light-primary">
											...
											<div class="text-gray-700 fw-bold fs-6">FormValidation is best used together with our integrated SweetAlert2. For more info, please visit the
												<a href='https://sweetalert2.github.io/' target='_blank'>official website</a>.
											</div>
											<!--end::Description-->
										</div>
										<!--end::Information-->
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="daterangepicker">
										<a href="#daterangepicker" data-kt-scroll-toggle=""></a>Date range picker
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">For more information on Date Range Pickers, please visit the
										<a href="https://www.daterangepicker.com/" target="_blank">official website</a>.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857358bb9b" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857358bb9f" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857358bb9b" role="tabpanel">
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
												...
												<div class="tab-pane fade" id="kt_highlight_614857358bb9f" role="tabpanel">
													<div class="highlight-code">
...
&lt;!--end::Form--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="flatpickr">
										<a href="#flatpickr" data-kt-scroll-toggle=""></a>Flatpickr
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">For more information on Flatpickr, please visit the
										<a href="https://flatpickr.js.org/" target="_blank">official website</a>.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857358bd7c" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857358bd7e" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857358bd7c" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
												...
												<div class="tab-pane fade" id="kt_highlight_614857358bd7e" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_flatpickr" class="form" action="#" autocomplete="off"&gt;
...
&lt;!--end::Form--&gt;</code>
								...
								<div class="py-10">
									<!--begin::Heading-->
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="daterangepicker">
										<a href="#basic" data-kt-scroll-toggle=""></a>Image Input
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">For more information on our exclusive Image Input form, please visit the
										<a href="../../documentation/forms/image-input.php" target="_blank">our documentation page</a>.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857358bf67" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857358bf68" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857358bf67" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
												...
												<div class="tab-pane fade" id="kt_highlight_614857358bf68" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_image_input" class="form" action="#" autocomplete="off"&gt;
...
&lt;!--end::Form--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="password">
										<a href="#password" data-kt-scroll-toggle=""></a>Password Meter
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">For more information on our exclusive Password Meter, please visit the
										<a href="../../documentation/forms/password-meter.php" target="_blank">our documentation page</a>.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857358c147" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857358c149" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857358c147" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
												...
												<div class="tab-pane fade" id="kt_highlight_614857358c149" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_password" class="form" action="#" autocomplete="off"&gt;
...
&lt;!--end::Form--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="select2">
										<a href="#select2" data-kt-scroll-toggle=""></a>Select2
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">For more information on Select2, please visit the
										<a href="https://select2.org/" target="_blank">official website</a>.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857358c32e" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857358c331" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857358c32e" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
												...
												<div class="tab-pane fade" id="kt_highlight_614857358c331" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_select2" class="form" action="#" autocomplete="off"&gt;
...
&lt;!--end::Form--&gt;</code>
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="tagify">
										<a href="#tagify" data-kt-scroll-toggle=""></a>Tagify
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">For more information on Tagify, please visit the
										<a href="https://yaireo.github.io/tagify/" target="_blank">official website</a>.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="pt-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857358c509" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857358c50c" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857358c509" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
												...
												<div class="tab-pane fade" id="kt_highlight_614857358c50c" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_tagify" class="form" action="#" autocomplete="off"&gt;
