						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/forms/formvalidation/basic.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="basic">
										<a href="#basic" data-kt-scroll-toggle=""></a>Basic Inputs Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="text">
										<a href="#text" data-kt-scroll-toggle=""></a>Text Input
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857351517e" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573515182" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857351517e" role="tabpanel">
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
												...
												<div class="tab-pane fade" id="kt_highlight_6148573515182" role="tabpanel">
													<div class="highlight-code">
...
&lt;!--end::Form--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="email">
										<a href="#email" data-kt-scroll-toggle=""></a>Email Input
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573515342" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573515345" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573515342" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
												...
												<div class="tab-pane fade" id="kt_highlight_6148573515345" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_email" class="form" action="#" autocomplete="off"&gt;
...
&lt;!--end::Form--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="textarea">
										<a href="#textarea" data-kt-scroll-toggle=""></a>Textarea Input
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61485735154ee" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61485735154f1" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_61485735154ee" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
												...
												<div class="tab-pane fade" id="kt_highlight_61485735154f1" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_textarea" class="form" action="#" autocomplete="off"&gt;
...
&lt;!--end::Form--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="radio">
										<a href="#radio" data-kt-scroll-toggle=""></a>Radio Input
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_61485735156a1" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_61485735156a3" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_61485735156a1" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
												...
												<div class="tab-pane fade" id="kt_highlight_61485735156a3" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_radio" class="form" action="#" autocomplete="off"&gt;
...
&lt;!--end::Form--&gt;</code>
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="checkbox">
										<a href="#checkbox" data-kt-scroll-toggle=""></a>Checkbox Input
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="pt-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857351586e" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573515870" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857351586e" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Define form element
            ...
            if (status == 'Valid') {
                ...
                setTimeout(function () {
                    ...
                    //form.submit(); // Submit form
												...
												<div class="tab-pane fade" id="kt_highlight_6148573515870" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
<code class="language-html">&lt;!--begin::Form--&gt;
&lt;form id="kt_docs_formvalidation_checkbox" class="form" action="#" autocomplete="off"&gt;
