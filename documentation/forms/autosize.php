				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/forms/autosize.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">
										...
										<a href="http://www.jacklmoore.com/autosize/" target="_blank" class="fw-bold">plugin's site</a>.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
...
&lt;script src="assets/plugins/global/plugins.bundle.js"&gt;&lt;/script&gt;</code>
									...
									<div class="py-5">
										<ul class="py-0">
											...
											<li class="py-2">Autosize's is initialized by adding
												...
												<code>textarea</code>HTML element.
											</li>
											...
											<li class="py-2">Autosize also supports event hooks. Please refer to the
												<a href="http://www.jacklmoore.com/autosize/" target="_blank" class="me-1">official documentation</a>for more info.
											</li>
										</ul>
									</div>
									<!--end::Block-->
								...
								<div class="py-10">
									...
									<div class="py-5">Here's an example of the
										<code>textarea</code>automatically resizing base on the amount of text written in it.
									</div>
									<!--end::Block-->
									<div class="py-5">
										<!--begin::Information-->
...
<code class="language-javascript">autosize.destroy(autosize_element);</code>
	...
	<script src="assets/js/custom/documentation/forms/autosize.js"></script>
