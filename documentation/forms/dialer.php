				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/forms/dialer.php">
...
&lt;!--end::Dialer--&gt;</code>
									...
									<div class="py-5">
										...
										<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
											...
											<div class="text-gray-700 fw-bold fs-6">While customizing the look and feel, ensure to maintain the control attributes(
												<code>data-kt-dialer-control="*"</code>) in order Dialer to function as expected.
											</div>
											<!--end::Description-->
										</div>
										<!--end::Information-->
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="javascript">
										<a href="#javascript"></a>Javascript Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573301c14" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573301c17" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573301c14" role="tabpanel">
													<div class="highlight-code">
...
var dialerObject = new KTDialer(dialerElement, {
    ...
    decimals: 2
												...
												<div class="tab-pane fade" id="kt_highlight_6148573301c17" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
<code class="language-html">&lt;!--begin::Dialer--&gt;
&lt;div class="position-relative w-md-300px" id="kt_dialer_example_1"&gt;
...
&lt;!--end::Dialer--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-2" id="options">
										<a href="#options"></a>Options Reference
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
...
var dialerObject = new KTDialer(dialerElement, options);</code>
															...
															<div class="d-flex align-items-center rounded py-5 px-5 bg-light-info">
																...
																<div class="text-gray-700 fw-bold fs-6">Remove
																	<code>data-kt-dialer="true"</code>attribute to avoid lazy initializes.
																</div>
																<!--end::Description-->
															</div>
															<!--end::Information-->
															...
															<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
																...
																<div class="text-gray-700 fw-bold fs-6">For
																	<code>options</code>object refer to above Options Reference section.
																</div>
																<!--end::Description-->
															</div>
															<!--end::Information-->
