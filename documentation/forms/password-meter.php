				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/forms/password-meter.php">
									...
									<div class="py-5">
										<ul class="py-0">
											...
											<li class="py-2">The Visibility Toggle is an icon button positioned within the input field to toggle password state from hidden to visible and vice versa. The Visibility Toggle can be identified by adding
												<code>data-kt-password-meter-control="visibility"</code>.
											</li>
											...
											<li class="py-2">Password Meter is usually added as an
												<code>input group</code>with our default form validation and our extended Bootstrap's utility classes for styling.
											</li>
													...
													<tr>
														...
														<td>
															<div class="mb-3">Identifies the element as a Visibility Toggle or a Highlight Meter. Accepts either
																...
																<code>data-kt-password-meter-control</code>HTML attributes are mandatory and are required to be placed within the Main Wrapper.
															</div>
...
&lt;/div&gt;</code>
															...
															</div>Here's a sample code structure for the Highlight Meter to display and highlight the password strength based on our Password Meter calculator:
															<div class="pt-3">
																<!--begin::Highlight-->
																<div class="highlight">
																	<button class="highlight-copy btn" data-bs-toggle="tooltip" title="Copy code">copy</button>
...
var passwordMeter = new KTPasswordMeter(passwordMeterElement);</code>
															...
															<div class="d-flex align-items-center rounded py-5 px-5 bg-light-info">
																...
																<div class="text-gray-700 fw-bold fs-6">Remove
																	<code>data-kt-password-meter="true"</code>attribute to avoid lazy initializes.
																</div>
																<!--end::Description-->
															</div>
															<!--end::Information-->
