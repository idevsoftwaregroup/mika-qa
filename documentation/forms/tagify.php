				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/forms/tagify.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">Transforms an input field or a textarea into a Tags component, in an easy, customizable way, with great performance and small code footprint, exploded with features For full documentation please check the
										<a href="https://yaireo.github.io/tagify/" target="_blank" class="fw-bold">plugin's site</a>.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573a2e953" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573a2e956" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573a2e953" role="tabpanel">
													<div class="highlight-code">
...
new Tagify(input2);</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148573a2e956" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
...
&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="countries">
										<a href="#countries"></a>Countries With Flags Examples
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573a2eaeb" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573a2eaee" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573a2eaeb" role="tabpanel">
													<div class="highlight-code">
...
tagify.addTags(tagsToAdd);</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148573a2eaee" role="tabpanel">
													<div class="highlight-code">
...
&lt;input class="form-control d-flex align-items-center" value="" id="kt_tagify_country" /&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="users">
										<a href="#users"></a>Users With Photos Examples
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573a2eca0" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573a2eca3" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573a2eca0" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript" style="height:400px">
    ...
    return tagify.parseTemplate('dropdownItem', [{
        ...
        email: tagify.settings.whitelist.reduce(function (remainingSuggestions, item) {
            return tagify.isTagDuplicate(item.value) ? remainingSuggestions : remainingSuggestions + 1
												...
												<div class="tab-pane fade" id="kt_highlight_6148573a2eca3" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
								...
								<div class="py-10">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573a2ee74" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573a2ee76" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573a2ee74" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">// The DOM elements you wish to replace with Tagify
...
new Tagify(input3);</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148573a2ee76" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
								...
								<div class="py-10">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573a2f00d" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573a2f00f" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573a2f00d" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// The DOM elements you wish to replace with Tagify
...
new Tagify(input, {
    ...
    dropdown: {
        ...
        closeOnSelect: false    // &lt;- do not hide the suggestions dropdown once an item has been selected
												...
												<div class="tab-pane fade" id="kt_highlight_6148573a2f00f" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
...
&lt;input class="form-control form-control-solid" value="css, html, javascript" id="kt_tagify_7"/&gt;</code>
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="readonly">
										<a href="#readonly"></a>Readonly Mode
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573a2f19d" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573a2f1ac" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573a2f19d" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">// The DOM elements you wish to replace with Tagify
...
new Tagify(input1);</code>
												...
												<div class="tab-pane fade" id="kt_highlight_6148573a2f1ac" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
