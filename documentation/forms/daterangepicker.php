				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/forms/daterangepicker.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">Date Range Picker can be attached to any webpage element to pop up two calendars for selecting dates, times, or predefined ranges like "Last 30 Days". For full documentation please check the
										<a href="https://www.daterangepicker.com/" target="_blank" class="fw-bold">plugin's site</a>.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857327e23a" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857327e241" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857327e23a" role="tabpanel">
													<div class="highlight-code">
...
<code class="language-javascript">$("#kt_daterangepicker_1").daterangepicker();</code>
												...
												<div class="tab-pane fade" id="kt_highlight_614857327e241" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
...
&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="with-times">
										<a href="#with-times"></a>With Times
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857327e4ca" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857327e4ce" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857327e4ca" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">$("#kt_daterangepicker_2").daterangepicker({
    ...
    locale: {
        format: "M/DD hh:mm A"
												...
												<div class="tab-pane fade" id="kt_highlight_614857327e4ce" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
<code class="language-html">&lt;div class="mb-0"&gt;
    &lt;label class="form-label"&gt;Example&lt;/label&gt;
...
&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="single-date-picker">
										<a href="#single-date-picker"></a>Single Date Picker
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857327e792" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857327e796" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857327e792" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">$("#kt_daterangepicker_3").daterangepicker({
        ...
        alert("You are " + years + " years old!");
												...
												<div class="tab-pane fade" id="kt_highlight_614857327e796" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
<code class="language-html">&lt;div class="mb-0"&gt;
    &lt;label class="form-label"&gt;Example&lt;/label&gt;
...
&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="predefined">
										<a href="#predefined"></a>Predefined Date Ranges
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857327ea11" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857327ea15" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857327ea11" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
...
function cb(start, end) {
    $("#kt_daterangepicker_4").php(start.format("MMMM D, YYYY") + " - " + end.format("MMMM D, YYYY"));
}
...
cb(start, end);</code>
												...
												<div class="tab-pane fade" id="kt_highlight_614857327ea15" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
								...
								<div class="pt-10">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857327ee41" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857327ee44" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857327ee41" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
<code class="language-javascript">$("#kt_daterangepicker_5").daterangepicker();</code>
												...
												<div class="tab-pane fade" id="kt_highlight_614857327ee44" role="tabpanel">
													<div class="highlight-code">
