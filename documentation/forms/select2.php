				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/forms/select2.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">
										...
										<a href="https://select2.org" target="_blank" class="fw-bold">plugin's site</a>.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
									...
									<div class="py-5">
										<ul class="py-0">
											<li class="py-2">Select2's CSS is highly customized in
												...
												<code>assets/plugins/global/plugins.bundle.css</code>and globally included in all pages.
											</li>
											...
											<li class="py-2">Select2's is globally initialized through
												...
												<a class="fw-bold">Select2 Data Attributes</a>.
											</li>
										</ul>
									</div>
									<!--end::Block-->
									...
									<div class="py-5">
										...
										<div class="d-flex align-items-center rounded py-5 px-5 bg-light-warning">
											...
											<div class="text-gray-700 fw-bold fs-6">Add
												<code>&lt;option&gt;&lt;/option&gt;</code>empty option in order to display the placeholder when selection is not made.
											</div>
											<!--end::Description-->
										</div>
										<!--end::Information-->
...
&lt;/select&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="input-group">
										<a href="#input-group"></a>Bootstrap Input Group
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Mix and match Select2 with
										<code>.input-group</code>
										<a href="https://getbootstrap.com/docs/5.0/forms/input-group" class="fw-bold">Bootstrap Input Group</a>&#160; components.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;!--end::Both add-ons in solid style--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="clear-selection">
										<a href="#clear-selection"></a>Clear Selection
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Add
										<code>data-allow-clear="true"</code>attribute to allow clearing selected options.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/select&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="hide-search">
										<a href="#hide-search"></a>Hide Search
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Add
										<code>data-hide-search="true"</code>attribute to hide the search input in the dropdown list.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/select&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="multiple-selection">
										<a href="#multiple-selection"></a>Multiple Selection
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Declare a selectbox with
										<code>multiple="multiple"</code>attribute to allow multiple selection with a tag control.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/select&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="hierarchical-options">
										<a href="#hierarchical-options"></a>Hierarchical Options
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>&lt;optgroup&gt;&lt;/optgroup&gt;</code>tag to display options in single level groups:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;!--end::Modal--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="countries">
										<a href="#countries"></a>Countries With Flags Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Initialize Select2 programmatically and add
										<code>data-kt-select2-country</code>attribute with the path to the country flag to create a list with country icons.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857398ae97" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857398ae9b" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857398ae97" role="tabpanel">
													<div class="highlight-code">
...
$('#kt_docs_select2_country').select2({
    templateResult: function (item) {
        return format(item);
												...
												<div class="tab-pane fade" id="kt_highlight_614857398ae9b" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
...
&lt;/select&gt;</code>
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="users">
										<a href="#users"></a>Users With Photos Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Initialize Select2 programmatically and add
										<code>data-kt-select2-user</code>attribute with the path to the user avatar to create a list with user portraits.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
										<div class="rounded border p-10">
											...
											<select class="form-select" data-placeholder="Select an option" id="kt_docs_select2_users">
												<option></option>
												<option value="0" data-kt-select2-user="avatars/150-1.jpg">Emma Smith</option>
												<option value="2" data-kt-select2-user="avatars/150-26.jpg">Max Smith</option>
												<option value="3" data-kt-select2-user="avatars/150-4.jpg">Sean Bean</option>
												<option value="4" data-kt-select2-user="avatars/150-15.jpg">Brian Cox</option>
												<option value="6" data-kt-select2-user="avatars/150-8.jpg">Francis Mitcham</option>
												<option value="9" data-kt-select2-user="avatars/150-6.jpg">Dan Wilson</option>
												<option value="11" data-kt-select2-user="avatars/150-7.jpg">Ana Crown</option>
												<option value="13" data-kt-select2-user="avatars/150-17.jpg">John Miller</option>
												<option value="15" data-kt-select2-user="avatars/150-10.jpg">Ethan Wilder</option>
											</select>
										</div>
									</div>
									<!--end::Block-->
									...
									<div class="pt-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857398b040" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857398b042" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857398b040" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript" style="height:400px">
<code class="language-javascript">// Format options
const format = (item) =&gt; {
...
$('#kt_docs_select2_country').select2({
    templateResult: function (item) {
        return format(item);
												...
												<div class="tab-pane fade" id="kt_highlight_614857398b042" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html" style="height:400px">
<code class="language-html">&lt;select class="form-select" placeholder="Select an option" id="kt_docs_select2_users"&gt;
    &lt;option&gt;&lt;/option&gt;
    &lt;option value="0" data-kt-select2-user="avatars/150-1.jpg"&gt;Emma Smith&lt;/option&gt;
    &lt;option value="1" data-kt-select2-user="avatars/150-2.jpg"&gt;Max Smith&lt;/option&gt;
    ...
&lt;/select&gt;</code>
</pre>
													</div>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="validation-states">
										<a href="#validation-states"></a>Validation States
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">The standard
										<a href="https://getbootstrap.com/docs/5.0/forms/validation/" class="fw-bold">Bootstrap's Form Validation</a>&#160; classes are supported:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
