				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/forms/image-input.php">
									...
									<div class="py-5">
										<ul class="py-0">
											...
											<li class="py-2">Image input instances are automatically initialized through
												...
												<code>KTImageInput</code>class constructor below.
											</li>
											...
											<li class="py-2">The image preview wrapper element is identified by the
												<code>.image-input-wrapper</code>css class.
											</li>
											<li class="py-2">The edit button is identified by the
												<code>data-kt-image-input-action="change"</code>attribute.
											</li>
											<li class="py-2">The cancel button is identified by the
												<code>data-kt-image-input-action="cancel"</code>attribute.
											</li>
											<li class="py-2">The remove button is identified by the
												<code>data-kt-image-input-action="remove"</code>attribute.
											</li>
 ...
 &lt;!--end::Image input--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="bordered">
										<a href="#bordered" data-kt-scroll-toggle=""></a>Preset Preview Image Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
 ...
 &lt;!--end::Image input--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="circle">
										<a href="#circle" data-kt-scroll-toggle=""></a>Circle Edge Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
 ...
 &lt;!--end::Image input--&gt;</code>
								...
								<div class="py-10">
									...
									<div class="py-5">Image input uses both CSS and HTML attributes to define the input configuration. The CSS classes below must be placed next to the main
										<code>image-input</code>css class within the main wrapper. Here are the references for each below
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="d-flex align-items-center rounded py-5 px-5 bg-light-primary">
											...
											<div class="text-gray-700 fw-bold fs-6">Tip: The
												...
												<code>image-input-outline</code>classes can be used simultaneously.
											</div>
											<!--end::Description-->
										</div>
										<!--end::Information-->
												...
												<tbody>
													<tr>
														...
														<td>Accepts
															...
															<code>KTImageInput</code>Javascript class automatically initializes the image input instance to apply the edit &amp; remove logic.
														</td>
													</tr>
													<tr>
														<td>
														...
														<td>
															<div class="mb-3">To be applied to each button type. Accepts either
																<code>change</code>,
																<code>cancel</code>or
																<code>remove</code>values. This specifies the type of button it's assigned to.
															</div>Each button must be defined within the main wrapper of the image input.
														</td>
													</tr>
												</tbody>
											</table>
...
var imageInput = new KTImageInput(imageInputElement);</code>
															...
															<div class="d-flex align-items-center rounded py-5 px-5 bg-light-info">
																...
																<div class="text-gray-700 fw-bold fs-6">Remove
																	<code>data-kt-image-input="true"</code>attribute to avoid lazy initializes.
																</div>
																<!--end::Description-->
															</div>
															<!--end::Information-->
