				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/forms/nouislider.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">noUiSlider is a lightweight range slider with multi-touch support and a ton of features. It supports non-linear ranges, requires no external dependencies, has keyboard support, and it works great in responsive designs. For full documentation please check the
										<a href="https://refreshless.com/nouislider" target="_blank" class="fw-bold">plugin's site</a>.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857381c073" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857381c076" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857381c073" role="tabpanel">
													<div class="highlight-code">
...
slider.noUiSlider.on("update", function (values, handle) {
    if (handle) {
        ...
        valueMin.innerHTML = values[handle];
												...
												<div class="tab-pane fade" id="kt_highlight_614857381c076" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
...
&lt;div id="kt_slider_sizes_lg" class="noUi-lg"&gt;&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="vertical">
										<a href="#vertical"></a>Vertical Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857381c383" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857381c386" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857381c383" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
...
noUiSlider.create(slider, {
    ...
    range: {
        ...
        "max": 200
												...
												<div class="tab-pane fade" id="kt_highlight_614857381c386" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
								...
								<div class="py-10">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857381c511" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857381c514" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857381c511" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
...
noUiSlider.create(tooltipSlider, {
    ...
    range: {
        ...
        "max": 200
												...
												<div class="tab-pane fade" id="kt_highlight_614857381c514" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
<code class="language-html">&lt;div id="kt_slider_tooltip"&gt;&lt;/div&gt;</code>
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="soft-limits">
										<a href="#soft-limits"></a>Soft Limits
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857381c6ea" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857381c6ed" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857381c6ea" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript">
...
noUiSlider.create(slider, {
    ...
    pips: {
        ...
        density: 4
												...
												<div class="tab-pane fade" id="kt_highlight_614857381c6ed" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
