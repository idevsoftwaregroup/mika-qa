						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/charts/amcharts/stock-charts.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
...
&lt;script src="https://cdn.amcharts.com/lib/4/themes/animated.js"&gt;&lt;/script&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="basic">
										<a href="#basic"></a>Basic Stock Chart
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857420fc5f" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857420fc62" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857420fc5f" role="tabpanel">
													<div class="highlight-code">
...
<code class="language-javascript">am4core.ready(function () {
    ...
    chart.scrollbarX = scrollbarX;
												...
												<div class="tab-pane fade" id="kt_highlight_614857420fc62" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
...
&lt;script src="https://cdn.amcharts.com/lib/4/plugins/rangeSelector.js"&gt;&lt;/script&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="compare">
										<a href="#compare"></a>Stock Comparison Chart
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Simply define a blank
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857420fe39" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857420fe3b" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857420fe39" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript" style="height:400px">
<code class="language-javascript">am4core.ready(function () {
    ...
    chart.scrollbarX = scrollbarX;
												...
												<div class="tab-pane fade" id="kt_highlight_614857420fe3b" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
<code class="language-html">&lt;div class="card card-bordered"&gt;
    &lt;div class="card-body"&gt;
...
&lt;script src="https://cdn.amcharts.com/lib/4/plugins/rangeSelector.js"&gt;&lt;/script&gt;</code>
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="variance">
										<a href="#variance"></a>Variance indicators Chart
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Simply define a blank
										<code>div</code>with a unique
										<code>id</code>in your HTML markup. Then initialize the chart via javascript. A clever use of highly configurable clustered Column series and adapters allows automatically-calculated variance indicators.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148574210016" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148574210019" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148574210016" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-javascript" style="height:400px">
<code class="language-javascript">am4core.ready(function () {
    ...
    chart.scrollbarX = scrollbarX;
												...
												<div class="tab-pane fade" id="kt_highlight_6148574210019" role="tabpanel">
													<div class="highlight-code">
														<pre class="language-html">
<code class="language-html">&lt;div class="card card-bordered"&gt;
    &lt;div class="card-body"&gt;
