						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/charts/google-charts/column.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
									...
									<div class="text-gray-700 fw-bold fs-6 lh-lg">Google chart tools are powerful, simple to use, and free. For more info see
										<a href="https://developers.google.com/chart/interactive/docs" class="fw-bolder me-1">the official site</a>.
									</div>
									<!--end::Description-->
								</div>
								<!--end::Notice-->
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="column">
										<a href="#column" data-kt-scroll-toggle=""></a>Column Chart Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">
										<div class="mb-3">Here's an example of a Column Chart. For more info, please visit the
											<a href="https://developers.google.com/chart/interactive/docs" target="_blank">official website</a>.
										</div>
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									...
									<div class="pt-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_614857478b866" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_614857478b86a" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_614857478b866" role="tabpanel">
...
google.setOnLoadCallback(function () {
    ...
    chart.draw(data, options);
												...
												<div class="tab-pane fade" id="kt_highlight_614857478b86a" role="tabpanel">
													<div class="highlight-code">
