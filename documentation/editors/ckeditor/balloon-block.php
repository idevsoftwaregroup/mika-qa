						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/editors/ckeditor/balloon-block.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="d-flex align-items-center rounded py-5 px-4 bg-light-info">
									...
									<div class="text-gray-700 fw-bold fs-6 lh-lg">CKEditor is Modern JavaScript rich text editor with a modular architecture. Its clean UI and features provide the perfect WYSIWYG UX for creating semantic content.. For more info see
										...
										<a class="fw-bolder" href="https://github.com/ckeditor/ckeditor5">the Github repository</a>.
									</div>
									<!--end::Description-->
								</div>
								<!--end::Notice-->
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" data-kt-scroll-offset="85" id="basic">
										<a href="#basic" data-kt-scroll-toggle=""></a>Balloon Block CKEditor Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148573e7f105" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148573e7f10c" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148573e7f105" role="tabpanel">
...
<code class="language-javascript">BalloonEditor
    ...
    .catch(error =&gt; {
        console.error(error);
												...
												<div class="tab-pane fade" id="kt_highlight_6148573e7f10c" role="tabpanel">
													<div class="highlight-code">
