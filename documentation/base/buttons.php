				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/base/buttons.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="overview">
										<a href="#overview"></a>Bootstrap Buttons
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
...
&lt;a href="#" class="btn btn-light-dark"&gt;Dark&lt;/a&gt;</code>
								...
								<div class="py-10">
									...
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.btn-bg-{color}</code>Bootstrap Button class to set a button's background color only without hover or active states:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;a href="#" class="btn btn-outline btn-outline-dashed btn-outline-dark btn-active-light-dark"&gt;Dark&lt;/a&gt;</code>
								...
								<div class="py-10">
									...
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.btn-color-{text-color}</code>Bootstrap Button class to set a button's text and icon colors only:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;a href="#" class="btn btn-bg-light btn-color-gray-900"&gt;Gray-900&lt;/a&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="icon-and-text-color-styles">
										<a href="#icon-and-text-color-styles"></a>Icon &amp; Text Color Styles
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.btn-icon-{text-color}</code>and
										<code>.btn-text-{text-color}</code>Bootstrap Button classes to set a button's icon and text colors separately:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;a href="#" class="btn btn-icon-gray-900 btn-text-gray-900"&gt;&lt;span class="svg-icon svg-icon-1"&gt;&lt;svg&gt;...&lt;/svg&gt;&lt;/span&gt;Gray-900&lt;/a&gt;</code>
								...
								<div class="py-10">
									...
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.btn-active-{color}</code>Bootstrap Button class to set a button's color for active &amp; hover states only:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;a href="#" class="btn btn-active-dark"&gt;Dark&lt;/a&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="active-light-style">
										<a href="#active-light-style"></a>Active Light Style
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.btn-active-light-{color}</code>Bootstrap Button class to set a button's light color for active &amp; hover states only:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;a href="#" class="btn btn-active-light-dark"&gt;Dark&lt;/a&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="active-color-style">
										<a href="#active-color-style"></a>Active Color Style
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.btn-active-color-{color}</code>Bootstrap Button class to set a button's text and icon colors for active and hover states only:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;a href="#" class="btn btn-bg-light btn-active-color-gray-900"&gt;Gray-900&lt;/a&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="active-icon-and-text-color-styles">
										<a href="#active-color-style"></a>Active Icon &amp; Text Color Styles
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.btn-active-icon-{color}</code>and
										<code>.btn-active-text-{color}</code>Bootstrap Button classes to set a button's icon and text colors separately for active and hover states:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;a href="#" class="btn btn-active-icon-gray-900 btn-active-text-gray-900"&gt;&lt;span class="svg-icon svg-icon-1"&gt;&lt;svg&gt;...&lt;/svg&gt;&lt;/span&gt;Gray-900&lt;/a&gt;</code>
								...
								<div class="py-10">
									...
									<!--begin::Block-->
									<div class="py-5">Use
										<a href="../../documentation/icons/duotune.php" class="fw-bold">Duotune Svg Icons</a>&#160;in conbination with buttons as shown below:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;a href="#" class="btn btn-icon btn-dark"&gt;&lt;span class="svg-icon svg-icon-1"&gt;&lt;svg&gt;...&lt;/svg&gt;&lt;/span&gt;&lt;/a&gt;</code>
									...
									<!--begin::Block-->
									<div class="py-5">Use
										<a href="../../documentation/icons/bootstrap-icons.php" class="fw-bold">Bootstrap Icons</a>&#160;in conbination with buttons as shown below:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;a href="#" class="btn btn-icon btn-dark"&gt;&lt;i class="bi bi-chat-square-text-fill fs-4 me-2"&gt;&lt;/i&gt;&lt;/a&gt;</code>
									...
									<!--begin::Block-->
									<div class="py-5">Use
										<a href="../../documentation/icons/font-awesome.php" class="fw-bold">Font Awesome Icons</a>&#160;in conbination with buttons as shown below:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;a href="#" class="btn btn-icon btn-dark"&gt;&lt;i class="fas fa-envelope-open-text fs-4 me-2"&gt;&lt;/i&gt;&lt;/a&gt;</code>
									...
									<!--begin::Block-->
									<div class="py-5">Use
										<a href="../../documentation/icons/line-awesome.php" class="fw-bold">Line Awesome Icons</a>&#160;in conbination with buttons as shown below:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;a href="#" class="btn btn-icon btn-dark"&gt;&lt;i class="las la-wallet fs-2 me-2"&gt;&lt;/i&gt;&lt;/a&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="social">
										<a href="#social"></a>Social Buttons
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										...
										<a href="https://icons.getbootstrap.com" class="fw-bold" target="_blank">Bootstrap Icons</a>&#160; social icons for supporting buttons with social brand logos and colors.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
...
&lt;a href="#" class="btn btn-icon btn-light-linkedin me-5 "&gt;&lt;i class="fab fa-linkedin fs-4"&gt;&lt;/i&gt;&lt;/a&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="link">
										<a href="#link"></a>Link Option
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.btn-link</code>Bootstrap Button class with any other button classes to set a link buttons without side paddings:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
