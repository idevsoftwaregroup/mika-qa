				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/base/rotate.php">
									...
									<div class="py-5">
										...
										<div class="highlight">
											...
											<ul class="nav nav-pills" role="tablist">
												<li class="nav-item">
													<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_6148572eeea40" role="tab">JAVASCRIPT</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_6148572eeea43" role="tab">HTML</a>
												</li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade show active" id="kt_highlight_6148572eeea40" role="tabpanel">
													<div class="highlight-code">
...
button.addEventListener("click", function() {
    button.classList.toggle("active");
												...
												<div class="tab-pane fade" id="kt_highlight_6148572eeea43" role="tabpanel">
													<div class="highlight-code">
...
&lt;/button&gt;</code>
								...
								<div class="pt-10">
									...
									<div class="py-5">Use Rotate with
										...
										<a href="https://getbootstrap.com/docs/5.0/components/collapse/" class="fw-bold">Bootstrap Collapse</a>&#160; and display:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
