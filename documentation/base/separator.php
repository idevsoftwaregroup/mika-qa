				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/base/separator.php">
						...
						<div class="card card-docs mb-2">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pt-10">
									...
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.separator</code>class to place a separator with border color and add vertical space with margin spacing classes as shown below:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
<code class="language-html">&lt;div class="separator my-10"&gt;&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<div class="py-5">Use
										...
										<a href="https://getbootstrap.com/docs/5.0/utilities/borders/#border-width" class="fw-bold">Bootstrap Border Width</a>&#160; classes to change separator border width:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;div class="separator border-5 my-10"&gt;&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<div class="py-5">Use
										<code>.separator</code>class in combination with
										<a href="https://getbootstrap.com/docs/5.0/utilities/borders/#border-color" class="fw-bold">Bootstrap Border Color</a>&#160; classes to change separator's border color:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
