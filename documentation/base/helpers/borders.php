						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/base/helpers/borders.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">Metronic extends
										...
										<code>src/sass/helpers/_borders.scss</code>to provide additional border utility classes to cover its own design system.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
...
&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-3" id="transparent">
										<a href="#transparent"></a>Transparent Border
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.border-transparent</code>to set an element's border color to tranparent.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/div&gt;</code>
								...
								<div class="pt-10">
									...
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.border-gray-{100, 200, 300, 400, 500, 600, 700, 800, 900}</code>to set an element's border color.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
