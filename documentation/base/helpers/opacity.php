						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/base/helpers/opacity.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">Metronic sets custom opacity classes in
										...
										<code>/src/sass/components/_variables.scss</code>to provide additional opacity utility classes to cover its own design system.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
								...
								<div class="py-10">
									...
									<div class="py-5">Use the
										<code>.opacity-{ 0, 5, 10, 15 ,20, 25, 50, 75, 100 }</code>class to set an element's opacity style.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;div class="opacity-100"&gt;&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-3" id="opacity-hover">
										<a href="#opacity-hover"></a>Opacity Hover Effects
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.opacity-{ 0, 5, 10, 15 ,20, 25, 50, 75, 100 }-hover</code>to display an element's opacity on hover.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;div class="opacity-100-hover"&gt;&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-3" id="opacity-active">
										<a href="#opacity-active"></a>Opacity Active State
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.opacity-active-{ 0, 5, 10, 15 ,20, 25, 50, 75, 100 }</code>to set an element's opacity on active states. Click on the demo below to trigger the active state.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;div class="opacity-active-100"&gt;&lt;/div&gt;</code>
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-3" id="opacity-state">
										<a href="#opacity-state"></a>Opacity Combined Active &amp; Hover State
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.opacity-state-{ 0, 5, 10, 15 ,20, 25, 50, 75, 100 }</code>to set an element's opacity on both active and hover states. Click on the demo below to trigger the active state.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
