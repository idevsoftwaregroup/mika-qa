						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link active py-2" href="../../documentation/base/helpers/background.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
...
&lt;div class="bg-dark hoverable"&gt;&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<div class="py-5">Use
										<code>.hoverable</code>with
										<code>.bg-light-{color}</code>class to set an element's light background color with hover state:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;div class="bg-opacity-100 bg-primary"&gt;&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="hover-opacity">
										<a href="#hover-opacity"></a>Hover Background Opacity
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										...
										<code>.bg-{color}</code>or
										<code>.bg-light-{color}</code>to set an element's background color with opacity on hover:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;div class="bg-hover-opacity-100 bg-primary"&gt;&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="active-opacity">
										<a href="#active-opacity"></a>Active Background Opacity
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										...
										<code>.bg-{color}</code>or
										<code>.bg-light-{color}</code>to set an element's background color with opacity on active state:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
