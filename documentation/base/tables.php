				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/base/tables.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">Metronic extends
										...
										<a href="https://datatables.net/" class="fw-bolder me-1" target="_blank">Datatables</a>as well.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
...
&lt;/table&gt;</code>
								...
								<div class="py-10">
									...
									<div class="py-5">To control cell paddings easily,
										...
										<code>.gs-*</code>to set padding left to the first cell and padding right to the last cell in the row.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="my-5">
...
&lt;/table&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="border-styling">
										<a href="#border-styling"></a>Row Border Styling
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
...
&lt;/table&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="flush-table">
										<a href="#flush-table"></a>Flush Table
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.table-flush</code>&#160; to reset the table and cells base styles so then style the cells individually.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="my-5">
...
&lt;/table&gt;</code>
								...
								<div class="py-10">
									...
									<!--begin::Block-->
									<div class="py-5">Add
										<code>.table-hover</code>&#160; to enable a hover state on table rows within a &lt;tbody&gt;
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="my-5">
...
&lt;/table&gt;</code>
								...
								<div class="pt-10">
									...
									<div class="py-5">Enable a table with fixed cell widths and responsive modes by referring to the official
										<a href="https://getbootstrap.com/docs/5.0/content/tables/" class="fw-bolder me-1">Bootstrap Tables</a>documentation.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="my-5">
