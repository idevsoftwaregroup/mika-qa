				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/base/forms.php">
...
&lt;input type="text" class="form-control form-control-white" placeholder="name@example.com"/&gt;</code>
								...
								<div class="py-10">
									...
									<div class="py-5">Use
										...
										<code>.form-control</code>to remove the default background-color, borders, and rounded corners of a form input.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
<code class="language-html">&lt;input type="email" class="form-control form-control-flush" placeholder="Example input"/&gt;</code>
								...
								<div class="py-10">
									<!--begin::Heading-->
									<h1 class="anchor fw-bolder mb-5" id="custom-form-control">
										<a href="#custom-form-control"></a>Form Labels
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>.required</code>class with
										<code>.form-label</code>or any custom element to indicate input's mandatory status:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/div&gt;</code>
									...
									<div class="pt-10 pb-5">Use
										<code>.form-check-{sm, lg}</code>fixed size classes for checkbox and radio to change their sizes:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/div&gt;</code>
									...
									<div class="pt-15 pb-5">Use
										<a class="fw-bold" href="../../documentation/base/utilities#width-and-height.php" target="_blank">Custom Size Classes</a>&#160; for checkbox and radio to set custom sizes:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/div&gt;</code>
								...
								<div class="pt-10">
									...
									<div class="py-5">Use
										<code>.form-check-custom</code>and
										<code>.form-check-solid</code>class with
										<code>.form-switch</code>to set custom layout with solid background style for a form switch:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/div&gt;</code>
									...
									<!--begin::Block-->
									<div class="pt-15 pb-5">Use
										<a class="fw-bold" href="../../documentation/base/utilities#width-and-height.php" target="_blank">Custom Size Classes</a>&#160; for switches to set custom sizes:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
