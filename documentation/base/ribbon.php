				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/base/ribbon.php">
...
&lt;/div&gt;</code>
								...
								<div class="py-10">
									...
									<div class="py-5">Add
										...
										<code>top</code>and
										<code>bottom</code>.
										<br />Please note that the ribbon may overlap your card title, so align your titles accordingly.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;!--end::Card--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="vertical">
										<a href="#vertical"></a>Vertical Ribbons
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Add
										<code>.ribbon-vertical</code>together with
										<code>.ribbon-top</code>to add a vertical ribbon.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;!--end::Card--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="clip">
										<a href="#clip"></a>Clip Ribbons
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Add
										<code>.ribbon-clip</code>and
										<code>.ribbon-inner</code>to add a clip style ribbon edge.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;!--end::Card--&gt;</code>
								...
								<div class="pt-10">
									<!--begin::Heading-->
									<h1 class="anchor fw-bolder mb-5" id="vertical">
										<a href="#vertical"></a>Triangle Ribbons
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										...
										<code>.border-{color}</code>class to set a ribbon color:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
