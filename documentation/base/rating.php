				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/base/rating.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="py-10">
									...
									<div class="py-5">Use
										...
										<a href="../../documentation/icons/duotune.php" class="fw-bold">Duotune Svg Icons</a>.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/div&gt;</code>
								...
								<div class="pt-10">
									...
									<div class="py-5">As a star icon any font icons can be used as well. This examples uses a star icon from
										<a href="../../documentation/icons/bootstrap-icons.php" class="fw-bold">Bootstrap Icons</a>:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/div&gt;</code>
									...
									<div class="pt-15 pb-5">Rating with default value can be setup through a radio input's
										<code>checked="checked"</code>state. This examples shows a rating with 3 stars default value:
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
