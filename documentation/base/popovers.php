				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/base/popovers.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="py-10">
									...
									<div class="py-5">Use
										...
										<a href="https://getbootstrap.com/docs/5.0/components/popover/#options" class="fw-bold">Popover Options</a>.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/button&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="dark-mode">
										<a href="#dark-mode"></a>Dark Mode
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										<code>data-bs-custom-class="popover-dark"</code>HTML attribute to initialize a popover with dark mode.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/button&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="delay">
										<a href="#delay"></a>Delay Options
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use custom
										<code>data-bs-delay-show</code>and
										<code>data-bs-delay-hide</code>HTML attributes to initialize a popover with showing and hiding delay(ms).
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;/button&gt;</code>
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="dismiss">
										<a href="#dismiss"></a>Dismiss
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use custom
										<code>data-bs-dismiss="true"</code>HTML attribute to initialize a popover with showing and hiding delay(ms).
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
