				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/base/utilities.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">Metronicfully utilizes the
										...
										<code>src/sass/_variables.custom.scss</code>you can override any variable for your needs.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
								...
								<div class="pb-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="theme-colors">
										<a href="#theme-colors"></a>Theme Colors
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
    ...
    "gray-900":   $gray-900
								...
								<div class="py-10">
									...
									<div class="py-5">Metronic extends
										<a href="https://getbootstrap.com/docs/5.0/utilities/spacing/" class="fw-bold">Bootstrap Spacing Classes</a>&#160; to provide additonal spacing options by overidding the default spacing SASS variable as shown below:
									</div>
									<!--end::Block-->
									<!--begin::Code-->
									<div class="py-5">
...
<code class="language-scss">$spacers: (
    ...
    20: ($spacer * 5)
								...
								<div class="py-10">
									...
									<!--begin::Block-->
									<div class="py-5">Metronic extends
										<a href="https://getbootstrap.com/docs/5.0/utilities/text/#font-size" class="fw-bold">Bootstrap Font Size Classes</a>&#160; to provide additonal sizing options by overidding the default font size SASS variable as shown below:
									</div>
									<!--end::Block-->
									<!--begin::Code-->
									<div class="py-5">
...
<code class="language-scss">$font-sizes: (
    ...
    5tx: $font-size-base * 5.75     // 74.75px
								...
								<div class="py-10">
									...
									<!--begin::Block-->
									<div class="py-5">Metronic extends
										<a href="https://getbootstrap.com/docs/5.0utilities/text/#line-height" class="fw-bold">Bootstrap Line Height Classes</a>&#160; to provide additonal line height options by overidding the line height SASS variable.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">Use
...
&lt;div class="z-index-3"&gt;&lt;/div&gt;</code>
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="css-variables-in-js">
										<a href="#css-variables-in-js"></a>Access CSS variables in Javascript
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									...
									<div class="py-5">
										<ul class="py-0">
											<li class="py-2">
												<code>--bs-light-primary</code>- Light version of primary color hex value.
											</li>
											<li class="py-2">
												<code>--bs-active-primary</code>- Active version of primary color hex value.
											</li>
											<li class="py-2">
												<code>--bs-light-success</code>- Light version of success color hex value.
											</li>
											<li class="py-2">
												<code>--bs-active-success</code>- Active version of success color hex value.
											</li>
											<li class="py-2">
											...
											<li class="py-2">
												<code>--bs-light-warning</code>- Light version of warning color hex value.
											</li>
											<li class="py-2">
												<code>--bs-active-warning</code>- Active version of warning color hex value.
											</li>
											<li class="py-2">
												<code>--bs-light-danger</code>- Light version of danger color hex value.
											</li>
											<li class="py-2">
												<code>--bs-active-danger</code>- Active version of danger color hex value.
											</li>
											<li class="py-2">
											...
											<li class="py-2">
												<code>--bs-xl</code>- Extra large small breakpoint width value - 1200px.
											</li>
											<li class="py-2">
												<code>--bs-xxl</code>- Double extra large breakpoint width value - 1400px.
											</li>
											<li class="py-2">
									...
									<div class="py-5">To access these variables, simply call it with this function
										...
										<br />For example to access the primary color, CSS responsive breakpoint value or the theme font family you can use the below code:
									</div>
									<!--end::Block-->
									<!--begin::Code-->
									<div class="py-5">
