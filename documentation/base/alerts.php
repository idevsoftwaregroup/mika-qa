				...
				<div class="docs-aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link active py-2" href="../../documentation/base/alerts.php">
							...
							<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
								...
								<div class="pb-10">
									...
									<div class="py-5">Metronic customizes the
										<a href="https://getbootstrap.com/docs/5.0/components/alerts/" target="_blank" class="fw-bold">Bootstrap Alerts</a>&#160; through creative use of Bootstrap utilities and with handpicked icons.
									</div>
									<!--end::Block-->
								</div>
								<!--end::Section-->
...
&lt;!--end::Alert--&gt;</code>
								...
								<div class="py-10">
									...
									<div class="py-5">Use
										...
										<a href="../../documentation/base/utilities#theme-colors.php" class="me-1">Theme colors</a>for more info.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">Add the class
										...
										<code>data-bs-dismiss="alert"</code>to the close button to allow dismissing alerts. Please take note of the HTML markup sample below for all required responsive classes.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">
...
&lt;!--end::Alert--&gt;</code>
								...
								<div class="py-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="border">
										<a href="#border"></a>Border Examples
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
									<div class="py-5">Use
										...
										<a href="../../documentation/base/utilities#theme-colors.php" class="me-1">Theme colors</a>and
										<a href="../../documentation/base/helpers/borders.php" class="me-1">Borders</a>for more info.
									</div>
									<!--end::Block-->
									<!--begin::Block-->
									<div class="py-5">Add the class
...
&lt;!--end::Alert--&gt;</code>
								...
								<div class="pt-10">
									...
									<h1 class="anchor fw-bolder mb-5" id="rich_content">
										<a href="#rich_content"></a>Rich Content Example
									</h1>
									<!--end::Heading-->
									<!--begin::Block-->
