                ...
                <div class="container mt-5 text-center" dir="rtl">
                    <div class="row">
                        ...
                        <div class="alert alert-danger col">
                            <?php
                            if ($_GET['error'] == "New passwords do not match.") {
                                echo "رمز های شما یکسان نیستند";
                            } else if ($_GET['error'] == "Current password is incorrect.") {
                                echo "رمز فعلی شما صحیح نمی باشد";
                            } else if ($_GET['error'] == "User not found.") {
                                echo "کاربر یافت نشد";
                            } else if ($_GET['error'] == "All fields are required.") {
                                echo "همه فیلد ها باید تکمیل شوند";
                            }
                            echo "<br/> ";
                            echo "<br/> ";
                            ...
                            <a href="settingsOwner.php" class="btn btn-primary">مجددا تلاش کنید</a>
                        </div>
                        <div class="col">&nbsp;</div>
                    </div>
                </div>
