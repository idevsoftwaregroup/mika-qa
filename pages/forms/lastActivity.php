...
$title = "Quality Assurance | Last Activity Search";
...
-->
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper" style="background-color: black;">
                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                ...
                                <li class="breadcrumb-item p-5 btn btn-outline-white rounded bg-white text-dark">پروژه ها</li>
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                        <!--end::Page title=-->
                ...
                <!--begin::Content-->
                <div class="px-10">
                    <div dir="rtl" class="container text-start">
                        <div class="row">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-7 p-10">
                                            <!-- <label for="search" class="form-label fs-3 text-white">عبارت دیسیپلین</label> -->
                                            <input type="text" id="search" class="form-control" aria-describedby="Search" name="search" placeholder="شماره پرمیت">
                                            <div id="passwordHelpBlock" class="form-text">
                                                شماره پرمیت را جستجو کنید.
                                            </div>
                                        </div>
                                        <div class="col-5 p-10">
                                            <input type="submit" value="جستجو" class="btn btn-block btn-md btn-white text-dark w-100">
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                // Prepare and bind
                                $stmt = $conn->prepare("
        SELECT p.permit_id, ch.checklistID
        FROM permits p
        INNER JOIN checklist ch ON p.permit_id = ch.permit_id
        WHERE p.permit_id LIKE ? OR ch.checklistID LIKE ?
    ");
                                $search_param = "%" . $search . "%";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo "<div class='fs-3 pb-5 pt-5 text-white'>نتایج جستجو</div>";
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<div class='row mb-3'><div class='col-12'>";
                                        echo "<div class='bg-white text-black border border-1 rounded-3 px-15 pb-5 pt-10 fs-3'>";
                                        echo "<p class='text-black'>شماره پرمیت: " . htmlspecialchars($row["permit_id"]) .
                                            " &nbsp;&nbsp;<button onclick='copyToClipboard(\"" . htmlspecialchars($row["permit_id"]) . "\")' class='btn btn-secondary btn-sm'>کپی</button></p>";
                                        echo "<p>شماره چک لیست: " . htmlspecialchars($row["checklistID"]) .
                                            " &nbsp;&nbsp;<button onclick='copyToClipboard(\"" . htmlspecialchars($row["checklistID"]) . "\")' class='btn btn-secondary btn-sm'>کپی</button></p>";
                                        echo "</div>";
                                        echo "</div></div>";
                                    }
                                    echo "</div>";
                                } else {
                                    echo "<div class='container text-center text-white h-2'><p class='h-2' style='font-size: 17px;'>هیچ نتیجه ای برای این جستجو '" . htmlspecialchars($_POST['search']) . "' یافت نشد</p></div>";
                                }
                            ...
                            <!-- Add this script for copy-to-clipboard functionality -->
                            <script>
