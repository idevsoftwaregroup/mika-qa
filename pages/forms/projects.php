...
-->
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper" style="background-color: black;">
                    ...
                    <div class="container-fluid d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                ...
                                <li class="breadcrumb-item p-5 btn btn-outline-white rounded text-white bg-black" style="border: 1px solid white">پروژه ها</li>
                                <!-- Left Side -->
                ...
                <!--begin::Content-->
                <div class="px-10">
                    <div dir="rtl" class="container-fluid text-start p-0">
                        <div class="row">
                            ...
                            // Prepare the query to get projects associated with the current user
                            $query = "
SELECT project.*
FROM project
INNER JOIN projectPersonnel ON project.id = projectPersonnel.projectID
INNER JOIN users ON projectPersonnel.userID = users.id
...
";
                            ...
                            // Bind the username from the session to the query
                            $username = $_SESSION['username'];
                            $stmt->bind_param("s", $username);
                            $stmt->execute();
                            $result = $stmt->get_result();

                            // Check if any projects were found and output them
                            if ($result->num_rows > 0) {
                                echo "<p class='text-white text-start pt-15 pb-10 fs-3'>یکی از پروژه ها را برای نمایش اطلاعات مرتبط با آن انتخاب کنید</p>";
                                echo '<form action="../pages/forms/projectSet.php" method="post">';
                                echo '<div class="row">';
                            ...
                            ?>
                                    <div class="col-12 col-sm-6 col-md-4 p-2">
                                        <?php
                                        if ($row['project_name'] === "عرش همت") {
                                            echo '<button
            type="submit"
            name="project_id"
            value="' . $row['id'] . '"
            style="background-image: url(\'../../pages/projects/images/' . $row['projectImage'] . '\'); background-size: cover; padding: 50px !important; font-size: 15px; border-radius: 18px; min-height: 400px !important;"
            class="btn btn-lg btn-white text-dark p-5 w-100 pt-5 pb-5">
            <div style="background-color: rgb(255 255 255 / 83%); padding: 10px; border-radius: 10px;">
                ' . $row['project_name'] . '<br />(' . $row['contractor_name'] . ')
            </div>
          </button>';
                                        } else {
                                            echo '<button
            ...
            <div style="background-color: rgba(255, 255, 255, 0.2); padding: 10px; border-radius: 10px;">
                ' . $row['project_name'] . '<br />(' . $row['contractor_name'] . ')
                            ...
                            <?php
                                ...
                                echo "<p class='text-white text-start pt-15 pb-10'>هیچ پروژه‌ای یافت نشد.</p>";
                            }
