...
// Check if the user is already logged in, redirect to signin page if not logged in
if (!isset($_SESSION['username'])) {
    ...
    $sql = "SELECT u.username, 
        ...
        FROM users u
        LEFT JOIN `projectPersonnel` p ON u.username = p.userID
        WHERE u.username = ?";
    ...
    if ($row['in_personnel_project'] == 'No') {
        ...
        if ($_SESSION['username'] === "idevsoftwaregroup" || $_SESSION['username'] === "admin") {
            // Continue with the current operation if the user is "idevsoftwaregroup" or "admin"
        } else {
            header("Location: ../signin.php");
            exit;
        }
...
// Title of Page:
$title = "Quality Assurance | فرآیند پرمیت جدید";

// Fetch personnel names from the database
$sqlM = "SELECT fullname FROM users";
...
<body id="kt_body" style="background-image: url();background-color: black;" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-enabled">
    <!--begin::Main-->
    <!--begin::Root-->
    <div class="d-flex flex-column flex-root bg-black">
        <!--begin::Page-->
...
-->
                                                ...
                                                <div class="mb-10">
                                                    ...
                                                    <a href="/contractor.php" class="custom-list d-flex align-items-center px-5 py-1">
                                                        ...
                                                        <div class="d-flex flex-column flex-grow-1">
                                                            ...
                                                            <!--end::Title-->
                                                            <!--begin::Link-->
                                                            <span class="text-white fw-bold with-hover" style="border: 1px solid white;padding: 10px;border-radius: 5px; "> صفحه نخست</span>
                                                            <!--end::Link-->
                                                        </div>
                                                        <!--begin::Description-->
                                                    </a>
                                                    ...
                                                    <a href="/pages/forms/permit.php" class="custom-list d-flex align-items-center px-5 py-1">
                                                        ...
                                                        <div class="d-flex flex-column flex-grow-1">
                                                            ...
                                                            <!--end::Title-->
                                                            <!--begin::Link-->
                                                            <span class="text-white fw-bold with-hover" style="border: 1px solid white;padding: 10px;border-radius: 5px;"> پرمیت</span>
                                                            <!--end::Link-->
                                                        </div>
                                                        <!--begin::Description-->
                                                    </a>
                                                    ...
                                                    <a href="/pages/forms/beforeChecklist.php" class="custom-list d-flex align-items-center px-5 py-1">
                                                        <div class="d-flex flex-column flex-grow-1">
                                                            <!--begin::Link-->
                                                            <span class="text-white fw-bold with-hover" style="border: 1px solid white;padding: 10px;border-radius: 5px;"> چک لیست</span>
                                                            <!--end::Link-->
                                                        </div>
                                                        <!--begin::Description-->
                                                    </a>
                                                    ...
                                                    <a href="/pages/forms/projects.php" class="custom-list d-flex align-items-center px-5 py-1">
                                                        <div class="d-flex flex-column flex-grow-1">
                                                            <!--begin::Link-->
                                                            <span id="projectSelection" class="text-black fw-bold bg-white with-hover" style="border: 1px solid white;padding: 10px;border-radius: 5px;">پروژه ها</span>
                                                    ...
                                                    <br />
                                                    <!--begin::Item-->
                                                    <a href="/settingsContractor.php" class="custom-list d-flex align-items-center px-5 py-1">
                                                        <div class="d-flex flex-column flex-grow-1">
                                                            <!--begin::Link-->
                                                            <span id="history" class="text-white fw-bold bg-black with-hover" style="border: 1px solid white;padding: 10px;border-radius: 5px;">تنظیمات</span>
                                                            <!-- <label for="history" class="pt-2 text-muted" style="font-size: 11px;">یکی از پروژه ها را انتخاب کنید</label> -->
                                                            <!--end::Link-->
                                                        </div>
                                                        <!--begin::Description-->
                                                    </a>
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
                    <!--begin::Container-->
                    <div class="container-fluid p-0 d-flex align-items-center justify-content-between" id="kt_header_container">
                        <!--begin::Page title-->
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            <!--begin::Heading-->
                            <!-- <h1 class="text-dark fw-bolder my-0 fs-2">فرآیند پرمیت جدید</h1> -->
                            <!--end::Heading-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                ...
                                <li class="breadcrumb-item p-5 btn btn-white rounded bg-black text-white" style="border: 1px solid white">پرمیت</li>
                                <!-- Left Side -->
                                <li class="breadcrumb-item p-5 btn btn-outline-white rounded bg-white text-dark text-left" style="position: absolute;left: 0px;" id="backPage"> صفحه قبل</li>
                                <script>
                ...
                <div class="col-md-12 col-sm-12" style="overflow-x: hidden;">
                    <form action="permitDone.php" method="POST" class="form p-15 border border-3 rounded-3" enctype="multipart/form-data">

                        <div class="p-5 border border-3 rounded-3 mb-5">
                            <fieldset>
                                <legend class="mb-10 text-white">اطلاعات پروژه</legend>
                                <div class="container">
                                    <div class="row">
                                        <!--begin::Project dropdown-->
                                        <div class="col-md-4 col-sm-12 fv-row mb-10">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="text-white">نام پروژه</span>
                                            </label>
                                            <input type="hidden" name="project_name" value="<?php echo $_SESSION['project_name']; ?>">
                                            <input type="text" name="project_name" id="project_name" value="<?php echo $_SESSION['project_name']; ?>" class="form-control text-center" readonly>
                                        </div>
                                        <!-- Contractor Name Field (Populated dynamically based on project selection) -->
                                        <div class="col-md-4 col-sm-12 mb-10">
                                            <label for="contractor_name" class="form-label text-white">نام پیمانکار</label>
                                            <?php
                                            // Database connection parameters
                                            $host = "localhost";
                                            $username = "root";
                                            ...
                                            // Prepare and execute SQL query to fetch contractor name
                                            $project_name = $_SESSION['project_id'];
                                            $sql = "SELECT contractor_name FROM project WHERE id = ? ";
                                            $stmt = $conn->prepare($sql);
                                            ...
                                            if ($result->num_rows > 0) {
                                                // Fetch and store contractor name
                                                $row = $result->fetch_assoc();
                                                $contractorName = $row['contractor_name'];

                                                // Display contractor name in readonly input field
                                                echo '<input type="text" name="contractor_name" id="contractor_name" value="' . $contractorName . '" class="form-control text-center" readonly>';
                                            } else {
                                                echo "No contractor found for the specified project.";
                                            }
                                        ...
                                        <div class="col-md-4 col-sm-12 mb-5">
                                            <label for="contract_number" class="form-label text-white">شماره قرارداد</label>
                                            <?php
                                            // Database connection parameters
                                            $host = "localhost";
                                            $username = "root";
                                            ...
                                            // Prepare and execute SQL query to fetch contractor name
                                            $project_name = $_SESSION['project_id'];
                                            $sql = "SELECT contract_number FROM project WHERE id = ?";
                                            $stmt = $conn->prepare($sql);
                                            $stmt->bind_param("i", $project_name);
                                            $stmt->execute();
                                            $result = $stmt->get_result();
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                // Display contractor name in readonly input field
                                                echo '<input type=" text" name="contract_number" id="contract_number" value="' . $contractNumber . '" class="form-control text-center" readonly required>';
                                            } else {
                                                echo "No contractor found for the specified project.";
                                            }
                        ...
                        <div class="p-5 border border-3 rounded-3 mb-5">
                            <fieldset>
                                <legend class="mb-10 text-white">دیسیپلین / ها</legend>
                                <div class="container">
                                    <div class="row">
                                        <!-- Discipline Group dropdown -->
                                        <div class="col-md-4 col-sm-12 fv-row mb-10">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="required text-white">گروه دیسیپلین</span>
                                            </label>
                                            <select required class="form-select form-select-lg form-select-solid form-control text-center" name="discipline_group" id="discipline_group" onchange="populateDisciplineItems()">
                                                <option value="">انتخاب گروه دیسیپلین</option>
                                                ...
                                                // Prepare and execute SQL query to fetch discipline group names
                                                $project_name = $_SESSION['project_id'];
                                                $sql = "SELECT `disciplineGroupName`, `contractor_name`, `project_name` FROM `project` WHERE `id` = ?";
                                                $stmt = $conn->prepare($sql);
                                                $stmt->bind_param("i", $project_name);
                                                $stmt->execute();
                                                $result = $stmt->get_result();
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = $result->fetch_assoc()) {
                                                        // Decode JSON data
                                                        $disciplineGroups = json_decode($row['disciplineGroupName']);

                                                        // Iterate over each discipline group
                                                        foreach ($disciplineGroups as $group) {
                                                            // Convert group name to desired format
                                                            switch ($group) {
                                                                case "elevator":
                                                                    $disciplineGroupName = "آسانسور و پله برقی و رمپ برقی";
                                                                    break;
                                                                case "climer":
                                                                    $disciplineGroupName = "نما و کلایمر";
                                                                    break;
                                                                case "electrical":
                                                                    $disciplineGroupName = "تاسیسات الکتریکال";
                                                                    break;
                                                                case "mechanical":
                                                                    $disciplineGroupName = "تاسیسات مکانیکال";
                                                                    break;
                                                                case "softhard":
                                                                    $disciplineGroupName = "سفت کاری و نازک کاری";
                                                                    break;
                                                                case "structure":
                                                                    $disciplineGroupName = "گود و سازه";
                                                                    break;
                                                                default:
                                                                    // Handle any other discipline group names here
                                                                    break;
                                                            }
                                                            // Display discipline group name in option tag
                                                            echo '<option value="' . $disciplineGroupName . '">' . $disciplineGroupName . "(" . $row['project_name'] . " _ " . $row['contractor_name'] . ")" . '</option>';
                                                        }
                                                    }
                                                } else {
                                                    echo "No discipline group names found for the specified project.";
                                                }
                                                // $_SESSION['discipline'] = $disciplineGroups;
                                                // Close prepared statement and database connection
                                                $stmt->close();
                                                $conn->close();
                                                ?>
                                                <script>
                                                    ...
                                                    setInterval(() => {
                                                        setCookie('disciplineGroupName', document.getElementById('discipline_group').value);
                                                        console.log(getCookie('disciplineGroupName'));
                                                    }, 1000);
                                                </script>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12 fv-row mb-10">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="required text-white">آیتم های دیسیپلین</span>
                                            </label>
                                            <select required class="form-select form-select-lg form-select-solid form-control text-center" name="discipline" id="discipline" onchange="generatePermitID()">
                                                <option value="">انتخاب آیتم دیسیپلین</option>
                                            </select>
                                            <script>
                                                // تعریف آیتم‌های دیسیپلین برای هر گروه
                                                const disciplineItems = {
                                                    "سفت کاری و نازک کاری": [
                                                        "انتخاب کنید",
                                                        "کرسی چینی",
                                                        "عملیات اجرای وال پست",
                                                        "عملیات ساختمان ( اجرای رنگ نما روی سیمانی )",
                                                        "عملیات ساختمانی ( پوشش محافظ در برابر حریق (پایه سیمانی) )",
                                                        "آهنکشی نما",
                                                        "کارهای فلزی سبک"
                                                    ],
                                                    "تاسیسات مکانیکال": [
                                                        "تجهیزات داخلی ( شیرآلات و لوام بهداشتی )"
                                                    ],
                                                    "گود و سازه": [
                                                        "انتخاب کنید",
                                                        ...
                                                        "عملیات قالب بندی",
                                                        "عملیات بتن ریزی",
                                                        "آرماتوربندی ستون و دیوار",
                                                        "قالب بندی ستون و دیوار",
                                                        "همبندی ستون و دیوار",
                                                        "بتن ریزی ستون و دیوار",
                                                        "قالب برداری ستون و دیوار",
                                                        "قالب بندی کف تیر",
                                                        "آرماتوربندی تیر",
                                                        "قالب بندی سقف دال و بغل تیر",
                                                        "آرماتوربندی سقف دال",
                                                        "همبندی رینگ سقف",
                                                        "بتن ریزی تیر و سقف",
                                                        "قالب برداری تیر و سقف",
                                                        "حفر چاه جذبی",
                                                        "مقاوم سازی با FRP",
                                                        "مقاوم سازی با ژاکت فلزی",
                                                        "نصب اسکلت فلزی",
                                                        "اجرای سقف مرکب عرشه فولادی",
                                                        "اجرای پوشش ضد حریق با مواد پایه سیمانی",
                                                        "کانال زهکشی کف گود",
                                                        "عملیات بتن ریزی سقف عرشه",
                                                        "ترمیم بتن سازه ای",
                                                        "خاکبرداری و پایدار سازی گود",
                                                        " عایق گود با دیمپل شیت",
                                                        "بتن نظافتی ( مگر )",
                                                        "عملیات قالب برداری فونداسیون"
                                                    ]
                                                    // دیگر گروه‌ها و آیتم‌ها را می‌توانید اضافه کنید
                                                };

                                                // تابع برای پر کردن آیتم‌های دیسیپلین بر اساس گروه انتخاب شده
                                                function populateDisciplineItems() {
                                                    const selectedGroup = document.getElementById("discipline_group").value;
                                                    const disciplineItemsDropdown = document.getElementById("discipline");
                                                    disciplineItemsDropdown.innerHTML = ""; // پاک کردن گزینه‌های قبلی
                                                    const items = disciplineItems[selectedGroup] || [];
                                                    items.forEach(item => {
                                                        const option = document.createElement("option");
                                                        option.value = item;
                                                        option.text = item;
                                                        disciplineItemsDropdown.appendChild(option);
                                                    });

                                                    document.getElementById('discipline').addEventListener('change', myOnChange);

                                                    function myOnChange() {
                                                        sessionStorage.setItem('discipline', document.getElementById("discipline").value);
                                                    }
                                                }
                                            </script>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <label for="permit_id" class="form-label text-white">شماره پرمیت</label>
                                            <input type="text" name="permit_id" id="permit_id" class="form-control text-center" readonly>
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                        <div class="p-5 border border-3 rounded-3">
                            <fieldset>
                                <legend class="mb-10 text-white">سایر اطلاعات پرمیت</legend>
                                <div class="container">
                                    <div class="row">
                                        <!-- Crew Input -->
                                        <div class="col-md-4 col-sm-12">
                                            <label for="crew" class="form-label required text-white">پیمانکار</label>
                                            <input type="text" name="crew" id="crew" class="form-control text-center" required>
                                        </div>
                                        <!-- Axis Input -->
                                        <div class="col-md-4 col-sm-12">
                                            <label for="axis" class="form-label required text-white">محور</label>
                                            <?php
                                            // // Database connection parameters
                                            // $host = "localhost";
                                            // $username = "root";
                                            ...
                                            // $sql = "SELECT axis FROM project WHERE project_name = ?";
                                            // $stmt = $conn->prepare($sql);
                                            ...
                                            //     // Display contractor name in readonly input field
                                            //     echo '<input type="text" name="axis" id="axis" class="form-control" value="' . $axis . '" required readonly>';
                                            // } else {
                                            //     echo "No contractor found for the specified project.";
                                            // }
                                            ...
                                            // $conn->close();
                                            ?>
                                            <input type="text" name="axis" id="axis" class="form-control text-center" value="" required>
                                        </div>
                                        <!-- Floor Input -->
                                        <div class="col-md-4 col-sm-12">
                                            <label for="floor" class="form-label required text-white">طبقه</label>
                                            <?php
                                            // // Database connection parameters
                                            // $host = "localhost";
                                            // $username = "root";
                                            ...
                                            // // Prepare and execute SQL query to fetch contractor name
                                            // $project_name = $_SESSION['project_name'];
                                            // $sql = "SELECT floor FROM project WHERE project_name = ?";
                                            // $stmt = $conn->prepare($sql);
                                            // $stmt->bind_param("s", $project_name);
                                            // $stmt->execute();
                                            // $result = $stmt->get_result();
                                            ...
                                            //     // Display contractor name in readonly input field
                                            //     echo '<input type="text" name="floor" id="floor" class="form-control" required value="' . $floor . '" readonly>';
                                            // } else {
                                            //     echo "No contractor found for the specified project.";
                                            // }
                                            ...
                                            // $conn->close();
                                            ?>
                                            <input type="text" name="floor" id="floor" class="form-control text-center" value="" required>
                                        </div>
                                        <!-- Block Input -->
                                        <div class="col-md-4 col-sm-12 mt-5">
                                            <label for="block" class="form-label required text-white">بلوک</label>
                                            <?php
                                            // // Database connection parameters
                                            // $host = "localhost";
                                            // $username = "root";
                                            ...
                                            // // Prepare and execute SQL query to fetch contractor name
                                            // $project_name = $_SESSION['project_name'];
                                            // $sql = "SELECT block FROM project WHERE project_name = ?";
                                            // $stmt = $conn->prepare($sql);
                                            // $stmt->bind_param("s", $project_name);
                                            // $stmt->execute();
                                            // $result = $stmt->get_result();
                                            ...
                                            //     // Display contractor name in readonly input field
                                            //     echo '<input type="text" name="block" id="block" class="form-control" required value="' . $block . '" readonly>';
                                            // } else {
                                            //     echo "No contractor found for the specified project.";
                                            // }
                                            ...
                                            // $conn->close();
                                            ?>
                                            <input type="text" name="block" id="block" class="form-control text-center" value="" required>
                                        </div>
                                        <!-- Zone Input -->
                                        <div class="col-md-4 col-sm-12 mt-5">
                                            <label for="zone" class="form-label text-white">زون</label>
                                            <input type="text" name="zone" id="zone" class="form-control text-center">
                                        </div>
                                        <!-- File Upload Input -->

                                        <!-- Time to Action Input -->
                                        <div class="col-md-4 col-sm-12 mt-5">
                                            <label for="time_to_action" class="form-label required text-white">پیش بینی مدت زمان اجرا</label>
                                            <select name="time_to_action_unit" id="time_to_action_unit" class="form-control text-center" onchange="toggleTimeInput()" required>
                                                <option value="days">تعداد روز</option>
                                                <option value="hours">ساعت</option>
                                            </select>
                                            <input type="number" name="time_to_action_value" id="time_to_action_value" class="form-control text-center" min="0">
                                        </div>
                                        <!-- Operation Description Input -->
                                        <div class="col-12 mb-5 mt-5">
                                            <label class="form-label required text-white" for="operation_description">توضیحات عملیات</label>
                                            <textarea name="operation_description" class="form-control" id="operation_description" rows="3"></textarea>
                                        </div>
                                        <!-- <div class="col-6 mt-5">
                                        <label for="file_upload" class="form-label required text-white">آپلود فایل</label><br />
                                        <span class="font-weight-light fs-9 text-warning">پیش نمایش فایل بعد از آپلود در کنار آن قابل مشاهده می باشد.</span>
                                        <input required type="file" name="file_upload" id="file_upload" class="form-control" accept="*" onchange="previewImage(event)">
                                        <iframe id="preview" alt="Preview Image"></iframe>
                                    </div> -->
                                        <div class="container mt-5">
                                            <div class="col-md-6 col-sm-12 mt-5">
                                                <label for="file_upload" class="form-label required text-white">آپلود فایل</label><br />
                                                <span class="font-weight-light fs-9 text-warning">پیش نمایش فایل بعد از آپلود در کنار آن قابل مشاهده می باشد.</span>
                                                <input required type="file" name="file_upload[]" id="file_upload" class="form-control" accept="*" multiple onchange="previewImages(event)">
                                                <div id="previews"></div>
                                            </div>
                                        </div>
                                            ...
                                            function previewImages(event) {
                                                ...
                                                Array.from(files).forEach((file, index) => {
                                                    ...
                                                    reader.onload = function(e) {
                                                        ...
                                                        button.type = 'button'; // Ensure button does not trigger form submission
                                                        button.className = 'btn btn-white mt-3';
                                                        button.setAttribute('data-bs-toggle', 'modal');
                                                        button.setAttribute('data-bs-target', `#modal${index}`);
                                                        button.textContent = `پیش نمایش فایل ${index + 1}`;
                                                        previewsContainer.appendChild(button);
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="modalLabel${index}">پیش نمایش فایل ${index + 1}</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <iframe src="${e.target.result}" alt="پیش نمایش تصاویر آپلود شده" style="width: 100%; height: 400px;"></iframe>
        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">بستن</button>
                                            ...
                                            // Prevent form submission when clicking preview buttons
                                            document.querySelectorAll('#previews button').forEach(button => {
                                                button.addEventListener('click', function(event) {
                                                    event.preventDefault(); // Just in case, prevents any form submission
                                                });
                                            });
                                        </script>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12 mb-10 mt-10">
                                    <!-- on this case have inline css becuse in rtl.css we have important css form control and this change switch btn background color -->
                                    <button type="submit" class="col-md-4 col-sm-12 btn btn-white text-black form-control">مشاهده آیتم های پرمیت</button>
                                </div>
                            </div>
                        </div>
                    </form>
                    <script>
                        // Function to populate Contractor Name and Contract Number based on selected Project
                        function getProjectDetails(projectId) {
                            // Make an AJAX request to fetch details from the server/database
                            var xhr = new XMLHttpRequest();
                            xhr.onreadystatechange = function() {
                                if (this.readyState === 4 && this.status === 200) {
                                    var response = JSON.parse(this.responseText);
                                    if (response.success) {
                                        document.getElementById("contractor_name").value = response.contractorName;
                                        document.getElementById("contract_number").value = response.contractNumber;
                                    } else {
                                        console.error("Failed to fetch project details.");
                                    }
                                }
                            };
                            xhr.open("GET", "./fetch_project_details.php?projectId=" + projectId, true);
                            xhr.send();
                        }
                        // Function to generate permit ID
                        // function generatePermitID() {
                        //     // generate random number :
                        //     function random6Number() {
                        //         return Math.floor(Math.random() * 999999);
                        //     }
                        //     // Get the discipline from the form
                        //     var discipline = document.getElementById("discipline").value;

                        //     // Get the contract number from the form
                        //     var contractNumber = document.getElementById("contract_number").value;

                        //     // Extract project name from contract number
                        //     var projectName = contractNumber.split("-")[0];

                        //     // Extract date from contract number
                        //     var dateIndex = contractNumber.lastIndexOf("-");
                        //     var datePart = contractNumber.substring(dateIndex + 1);
                        //     var persianDate = datePart.replace(/(\d{4})-(\d{2})-(\d{2})/, function(match, year, month, day) {
                        //         return parseInt(year) + 621 + "-" + month + "-" + day; // Convert Gregorian to Persian year
                        //     });

                        //     // generate permit id from Contract Number
                        //     var staticPartOfContractNumber = contractNumber.substring(8, 14);

                        //     // Construct the permit ID
                        //     var permitID = projectName + ("-") + ("P") + ("-") + staticPartOfContractNumber + ("-") + random6Number();
                        //     if (!projectName && !projectId) {
                        //         // dont do anything...
                        //     } else {
                        //         document.getElementById("permit_id").value = permitID;
                        //     }
                        //     // Set the permit ID value to the input field
                        // }

                        // Function to generate permit ID
                        function generatePermitID() {
                            var disciplineGroupName = getCookie('disciplineGroupName');

                            if (!disciplineGroupName) {
                                console.error("نام گروه دیسیپلین یافت نشد.");
                                return;
                            }

                            // ایجاد درخواست AJAX برای دریافت آخرین شماره مجوز
                            var xhr = new XMLHttpRequest();
                            xhr.open("GET", "./fetch_last_permit.php?discipline_group_name=" + encodeURIComponent(disciplineGroupName), true); // تنظیم مسیر به فایل PHP شما
                            xhr.onreadystatechange = function() {
                                if (xhr.readyState == 4 && xhr.status == 200) {
                                    var response = xhr.responseText ? JSON.parse(xhr.responseText) : null;
                                    var lastPermitID = response && response.lastPermitID ? response.lastPermitID : null;

                                    // استخراج بخش شماره از آخرین شماره مجوز (اگر وجود دارد)
                                    var lastNumberPart = lastPermitID ? parseInt(lastPermitID.split("-")[3]) : null;

                                    // مقداردهی اولیه متغیر برای شماره جدید
                                    var newNumberPart;

                                    if (disciplineGroupName === "گود و سازه") {
                                        if (lastNumberPart !== null && lastNumberPart >= 0 && lastNumberPart < 1000) {
                                            newNumberPart = (lastNumberPart + 1).toString().padStart(6, '0');
                                        } else if (lastNumberPart === null) {
                                            newNumberPart = '000000';
                                        } else {
                                            console.error("آخرین شماره برای 'گود و سازه' معتبر نیست. باید بین 000000 تا 000999 باشد.");
                                            return;
                                        }
                                    } else if (disciplineGroupName === "سفت کاری و نازک کاری") {
                                        if (lastNumberPart !== null && lastNumberPart >= 1000 && lastNumberPart < 4000) {
                                            newNumberPart = (lastNumberPart + 1).toString().padStart(6, '0');
                                        } else if (lastNumberPart === null) {
                                            newNumberPart = '001000';
                                        } else {
                                            console.error("آخرین شماره برای 'سفت کاری و نازک کاری' معتبر نیست. باید بین 001000 تا 003999 باشد.");
                                            return;
                                        }
                                    } else if (disciplineGroupName === "تاسیسات الکتریکال") {
                                        if (lastNumberPart !== null && lastNumberPart >= 4000 && lastNumberPart < 5000) {
                                            newNumberPart = (lastNumberPart + 1).toString().padStart(6, '0');
                                        } else if (lastNumberPart === null) {
                                            newNumberPart = '004000';
                                        } else {
                                            console.error("آخرین شماره برای 'تاسیسات الکتریکال' معتبر نیست. باید بین 004000 تا 004999 باشد.");
                                            return;
                                        }
                                    } else if (disciplineGroupName === "تاسیسات مکانیکال") {
                                        if (lastNumberPart !== null && lastNumberPart >= 5000 && lastNumberPart < 6000) {
                                            newNumberPart = (lastNumberPart + 1).toString().padStart(6, '0');
                                        } else if (lastNumberPart === null) {
                                            newNumberPart = '005000';
                                        } else {
                                            console.error("آخرین شماره برای 'تاسیسات مکانیکال' معتبر نیست. باید بین 005000 تا 005999 باشد.");
                                            return;
                                        }
                                    } else if (disciplineGroupName === "نما و کلایمر") {
                                        if (lastNumberPart !== null && lastNumberPart >= 6000 && lastNumberPart < 7000) {
                                            newNumberPart = (lastNumberPart + 1).toString().padStart(6, '0');
                                        } else if (lastNumberPart === null) {
                                            newNumberPart = '006000';
                                        } else {
                                            console.error("آخرین شماره برای 'نما و کلایمر' معتبر نیست. باید بین 006000 تا 006999 باشد.");
                                            return;
                                        }
                                    } else if (disciplineGroupName === "آسانسور و پله برقی و رمپ برقی") {
                                        if (lastNumberPart !== null && lastNumberPart >= 7000 && lastNumberPart < 8000) {
                                            newNumberPart = (lastNumberPart + 1).toString().padStart(6, '0');
                                        } else if (lastNumberPart === null) {
                                            newNumberPart = '007000';
                                        } else {
                                            console.error("آخرین شماره برای 'آسانسور و پله برقی و رمپ برقی' معتبر نیست. باید بین 007000 تا 007999 باشد.");
                                            return;
                                        }
                                    } else {
                                        console.error("نام گروه دیسیپلین نامعتبر است.");
                                        return;
                                    }

                                    // دریافت شماره قرارداد از فرم
                                    var contractNumber = document.getElementById("contract_number").value;

                                    // دریافت ۳ حرف اول شماره قرارداد
                                    var threeCharsOfContractNumber = contractNumber.substring(0, 3);

                                    // استخراج بخش ثابت شماره قرارداد
                                    var staticPartOfContractNumber = contractNumber.substring(8, 14);

                                    // ساخت شماره مجوز جدید
                                    var newPermitID = threeCharsOfContractNumber + "-P-" + staticPartOfContractNumber + "-" + newNumberPart;

                                    // تنظیم شماره مجوز جدید به فیلد ورودی
                                    document.getElementById("permit_id").value = newPermitID;
                                }
                            };
                            xhr.send();
                        }

                        // Example usage: Call generatePermitID() when the form is submitted or when needed

                        // Call the generatePermitID function initially (optional)
                        // generatePermitID();
                    </script>
                </div>
                <!--end::Content-->
    ...
    <script src="../../assets/js/custom/input-prew.js"></script>
