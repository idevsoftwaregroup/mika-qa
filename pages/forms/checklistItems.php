...
// Title of Page:
$title = "Quality Assurance | آیتم های چک لیست";
...
-->
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                <li class="breadcrumb-item text-muted">
                                    <a href="/contractor.php" class="p-5 btn btn-outline-white rounded bg-white text-black">صفحه نخست</a>
                                </li>
                                <li class="breadcrumb-item p-5 btn btn-outline-white rounded bg-white text-white bg-black" style="border: 1px solid white">فرآیند چک لیست</li>
                                <!-- Left Side -->
                ...
                $conn->close();
                ?>
                <div class="container-fluid mt-5" style="overflow-x: scroll;">
                    <h2 style="direction:rtl;" class="text-white p-5">آیتم های چک لیست</h2>
                    <form method="post" action="checklistItemsDone.php"> <!-- Adjust action attribute as needed -->
                            ...
                            <div class="row">
                                <div class="accordion-item mb-5 col-12 rounded-2">
                                    <h2 class="accordion-header" id="tabmain-heading">
                                        <button class="accordion-button text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#tab1-collapse" aria-expanded="true" aria-controls="tab1-collapse">
                                            اطلاعات پروژه
                                        </button>
                                    </h2>
                                                ...
                                                <div class="container-fluid" style="overflow-x: scroll;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 col-sm-12 fv-row mb-10">
                                                            ...
                                                            $sql = "SELECT project_name FROM project WHERE project.contract_number = (SELECT checklist.contract_number FROM checklist WHERE checklist.checklistID = ?)";
                                                            $stmt = $conn->prepare($sql);
                                                        ...
                                                        <div class="col-md-4 col-sm-12">
                                                            ...
                                                            // Prepare and execute SQL query to fetch project name
                                                            $sql = "SELECT contractor_name FROM project WHERE project.contract_number = (SELECT checklist.contract_number FROM checklist WHERE checklist.checklistID = ?)";
                                                            $stmt = $conn->prepare($sql);
                                                            // Check if GET parameter 'prmQWERTY' is set, otherwise provide a default value
                                                            $permitId = isset($_GET['prmQWERTY']) ? $_GET['prmQWERTY'] : 'default_permit_id';
                                                            $stmt->bind_param("s", $permitId);
                                                        ...
                                                        <div class="col-md-4 col-sm-12">
                                                            ...
                                                            // Prepare and execute SQL query to fetch project name
                                                            $sql = "SELECT contract_number FROM project WHERE project.contract_number = (SELECT checklist.contract_number FROM checklist WHERE checklist.checklistID = ?)";
                                                            $stmt = $conn->prepare($sql);
                                                            // Check if GET parameter 'prmQWERTY' is set, otherwise provide a default value
                                                            $permitId = isset($_GET['prmQWERTY']) ? $_GET['prmQWERTY'] : 'default_permit_id';
                                                            $stmt->bind_param("s", $permitId);
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 col-sm-12 fv-row mb-10">
                                                            ...
                                                            // Prepare and execute SQL query to fetch project name
                                                            $sql = "SELECT discipline_group FROM checklist WHERE checklist.checklistId = ? ";
                                                            $stmt = $conn->prepare($sql);
                                                            // Check if GET parameter 'prmQWERTY' is set, otherwise provide a default value
                                                            $permitId = isset($_GET['prmQWERTY']) ? $_GET['prmQWERTY'] : 'default_permit_id';
                                                            $stmt->bind_param("s", $permitId);
                                                        ...
                                                        <div class="col-md-4 col-sm-12 fv-row mb-10">
                                                            ...
                                                            // Prepare and execute SQL query to fetch project name
                                                            $sql = "SELECT discipline FROM checklist WHERE checklist.checklistID = ? ";
                                                            $stmt = $conn->prepare($sql);
                                                            // Check if GET parameter 'prmQWERTY' is set, otherwise provide a default value
                                                            $permitId = isset($_GET['prmQWERTY']) ? $_GET['prmQWERTY'] : 'default_permit_id';
                                                            $stmt->bind_param("s", $permitId);
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                ...
                                                                $_SESSION['discipline_item'] = $discipline;
                                                                // Display project name in readonly input field
                                                        ...
                                                        <div class="col-md-4 col-sm-12">
                                                            <label for="permit_id" class="form-label">شماره چک لیست</label>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 col-sm-12">
                                                            ...
                                                            // Prepare and execute SQL query to fetch project name
                                                            $sql = "SELECT crew FROM checklist WHERE checklist.checklistID = ? ";
                                                            $stmt = $conn->prepare($sql);
                                                            // Check if GET parameter 'prmQWERTY' is set, otherwise provide a default value
                                                            $permitId = isset($_GET['prmQWERTY']) ? $_GET['prmQWERTY'] : 'default_permit_id';
                                                            $stmt->bind_param("s", $permitId);
                                                        ...
                                                        <div class="col-md-4 col-sm-12">
                                                            ...
                                                            // Prepare and execute SQL query to fetch project name
                                                            $sql = "SELECT axis FROM checklist WHERE checklist.checklistID = ? ";
                                                            $stmt = $conn->prepare($sql);
                                                            // Check if GET parameter 'prmQWERTY' is set, otherwise provide a default value
                                                            $permitId = isset($_GET['prmQWERTY']) ? $_GET['prmQWERTY'] : 'default_permit_id';
                                                            $stmt->bind_param("s", $permitId);
                                                        ...
                                                        <div class="col-md-4 col-sm-12">
                                                            ...
                                                            // Prepare and execute SQL query to fetch project name
                                                            $sql = "SELECT floor FROM checklist WHERE checklist.checklistID = ? ";
                                                            $stmt = $conn->prepare($sql);
                                                            // Check if GET parameter 'prmQWERTY' is set, otherwise provide a default value
                                                            $permitId = isset($_GET['prmQWERTY']) ? $_GET['prmQWERTY'] : 'default_permit_id';
                                                            $stmt->bind_param("s", $permitId);
                                                        ...
                                                        <div class="col-md-4 col-sm-12 mt-5">
                                                            ...
                                                            // Prepare and execute SQL query to fetch project name
                                                            $sql = "SELECT `block` FROM checklist WHERE checklist.checklistID = ? ";
                                                            $stmt = $conn->prepare($sql);
                                                            // Check if GET parameter 'prmQWERTY' is set, otherwise provide a default value
                                                            $permitId = isset($_GET['prmQWERTY']) ? $_GET['prmQWERTY'] : 'default_permit_id';
                                                            $stmt->bind_param("s", $permitId);
                                                        ...
                                                        <div class="col-md-4 col-sm-12 mt-5">
                                                            ...
                                                            // Prepare and execute SQL query to fetch project name
                                                            $sql = "SELECT zone FROM checklist WHERE checklist.checklistID = ? ";
                                                            $stmt = $conn->prepare($sql);
                                                            // Check if GET parameter 'prmQWERTY' is set, otherwise provide a default value
                                                            $permitId = isset($_GET['prmQWERTY']) ? $_GET['prmQWERTY'] : 'default_permit_id';
                                                            $stmt->bind_param("s", $permitId);
                                                        ...
                                                        <div class="col-md-4 col-sm-12 mt-5">
                                                            ...
                                                            // Prepare and execute SQL query to fetch project name
                                                            $sql = "SELECT time_to_action FROM checklist WHERE checklist.checklistID = ? ";
                                                            $stmt = $conn->prepare($sql);
                                                            // Check if GET parameter 'prmQWERTY' is set, otherwise provide a default value
                                                            $permitId = isset($_GET['prmQWERTY']) ? $_GET['prmQWERTY'] : 'default_permit_id';
                                                            $stmt->bind_param("s", $permitId);
                                                        ...
                                                        <div class="col-12 mb-5 mt-5">
                                                            ...
                                                            // Prepare and execute SQL query to fetch project name
                                                            $sql = "SELECT operation_description FROM checklist WHERE checklist.checklistID = ? ";
                                                            $stmt = $conn->prepare($sql);
                                                            // Check if GET parameter 'prmQWERTY' is set, otherwise provide a default value
                                                            $permitId = isset($_GET['prmQWERTY']) ? $_GET['prmQWERTY'] : 'default_permit_id';
                                                            $stmt->bind_param("s", $permitId);
                                                        ...
                                                        <div class="col mt-5">
                                                            ...
                                                            // Prepare and execute SQL query to fetch file details
                                                            $sql = "SELECT dir, file_name FROM checklist WHERE checklist.checklistID = ? ";
                                                            $stmt = $conn->prepare($sql);
                                                            if ($stmt === false) {
                                                            ...
                                                            $result = $stmt->get_result();
                                                            if ($result->num_rows > 0) {
                                                                // Fetch the row with directory and file name
                                                                $row = $result->fetch_assoc();
                                                                $dir = rtrim($row['dir'], '/') . '/'; // Ensure the directory has a trailing slash
                                                                $file_name = $row['file_name'];

                                                                // Split the concatenated file names into an array
                                                                $file_names = explode(';', $file_name);

                                                                // Display each file in buttons and download links
                                                                echo '<div class="row">';
                                                                $counter = 1;
                                                                foreach ($file_names as $file) {
                                                                    if (!empty($file)) { // Ensure file name is not empty
                                                                        $full_path = $dir . $file;
                                                                        echo '<div class="col-md-4 col-sm-12 mt-2">';
                                                                        // Show file preview button
                                                                        echo '<button type="button" class="w-100 btn btn-dark btn-lg mb-3" data-bs-toggle="modal" data-bs-target="#fileModal" data-file="' . htmlspecialchars($full_path) . '">نمایش فایل شماره ' . $counter . '</button>';
                                                                        // Add download link
                                                                        echo '<a href="' . htmlspecialchars($full_path) . '" class="w-100 btn btn-success btn-lg mb-5" download>دانلود فایل شماره ' . $counter . '</a>';
                                                                        echo '</div>';
                                                                        $counter++;
                                                                    }
                                                                }
                        ...
                        <div class="container-fluid" style="overflow-x: scroll;" dir="rtl">
                            <div class="row">
                                <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        // انتخاب همه رادیو باتن های مربوط به "تایید"
                                        document.getElementById("acceptRadioAll").addEventListener("change", function() {
                                            if (this.checked) {
                                                document.querySelectorAll('input[type="radio"][value^="Accept-"]').forEach(function(radio) {
                                                    radio.checked = true;
                                                });
                                            }
                                        });

                                        // انتخاب همه رادیو باتن های مربوط به "عدم تایید"
                                        document.getElementById("rejectRadioAll").addEventListener("change", function() {
                                            if (this.checked) {
                                        ...
                                        // انتخاب همه رادیو باتن های مربوط به "در دسترس نمی باشد"
                                        document.getElementById("naRadioAll").addEventListener("change", function() {
                                            if (this.checked) {
                                                document.querySelectorAll('input[type="radio"][value^="N/A-"]').forEach(function(radio) {
                                                    radio.checked = true;
                                                });
                                            }
                                        });
                                ...
                                <div class="container p-5 bg-warning opacity-80 border border-3 border-warning rounded-lg">
                                    <div class="row mb-0">
                                        <span class="text-lg h3">تایید، عدم تایید و یا عدم دسترسی کلی را از اینجا انتخاب نمایید ...</span>
                                        <div class="d-flex mt-5">
                                            <div class="col">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="actionRadioAll" id="acceptRadioAll" value="Accept-All">
                                                    <label class="form-check-label" for="acceptRadioAll">تایید کلی</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="actionRadioAll" id="rejectRadioAll" value="Reject-All">
                                                    <label class="form-check-label" for="rejectRadioAll">عدم تایید کلی</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="actionRadioAll" id="naRadioAll" value="N/A-All">
                                                    <label class="form-check-label" for="naRadioAll">در دسترس نمی‌باشد کلی</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th scope="col fw-bold"><span class="text-white">شرح عملیات</span></th>
                                            ...
                                            <th><span class="text-white">کنترل اولیه</span></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($checklist_items as $index => $item) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="actionRadio<?= $index ?>" id="acceptRadio<?= $index ?>" value="Accept-<?= $item['operation_description'] ?>-<?= $_SESSION['discipline_item'] ?>">
                                                        <label class="form-check-label" for="acceptRadio<?= $index ?>">تایید</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="actionRadio<?= $index ?>" id="rejectRadio<?= $index ?>" value="Reject-<?= $item['operation_description'] ?>-<?= $_SESSION['discipline_item'] ?>">
                                                        <label class="form-check-label" for="rejectRadio<?= $index ?>">عدم تایید</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="actionRadio<?= $index ?>" id="naRadio<?= $index ?>" value="N/A-<?= $item['operation_description'] ?>-<?= $_SESSION['discipline_item'] ?>">
                                                        <label class="form-check-label" for="naRadio<?= $index ?>">در دسترس نمی باشد</label>
                                                    </div>
                                ...
                                <div class="form-group mt-5 text-start mb-5 p-0">
                                    <!-- <label for="description" class="text-white">توضیحات</label> -->
                                    <textarea id="description" name="description" class="form-control text-start" rows="4" cols="100" placeholder="توضیحات"></textarea>
                                </div>
                                <?php
                                // Database connection parameters
                                $host = "localhost";
                                ...
                                // Fetch the user's job position and other information (if needed)
                                $fullNameQuery = "SELECT *
                                                    FROM users 
                                ...
                                if ($rowFullnameResult) {
                                    // Correctly retrieve the job position and other fields from the result
                                    $jobTitle = $rowFullnameResult['job_position'];
                                    if ($jobTitle == 3) {
                                        echo '<div class="container p-5 bg-primary opacity-80 border border-3 border-primary rounded-3">
                                        <h3>آیا چک لیست جاری مورد تایید است ؟</h3>
                                        <div class="row">
                                            <div class="d-inline-block me-3 mb-4 mt-5">
                                                <input class="form-check-input" type="radio" name="statusChecklist" id="acceptChecklist" value="Accept">
                                                <label class="form-check-label" for="acceptChecklist">بله ...</label>
                                            </div>
                                            <div class="d-inline-block">
                                                <input class="form-check-input" type="radio" name="statusChecklist" id="rejectChecklist" value="Reject">
                                                <label class="form-check-label" for="rejectChecklist">خیر، مورد تایید نهایی نمی باشد !</label>
                                            </div>
                                        </div>
                                    </div>';
                                    } else {
                                    ...
                                    echo "User not found for the username: $username";
                                }
                        ...
                        $query3 = "SELECT userID FROM projectPersonnel WHERE role = 'owner' AND projectID = (SELECT projectID FROM permit_status WHERE permit_id = ? LIMIT 1)";
                        ...
                        while ($row3 = $result3->fetch_assoc()) {
                            $query4 = "SELECT distinct user_name FROM `checklistItemsActions` WHERE `permit_id` = ? AND `user_name` != ? ";
        ...
        AND projectPersonnel.userID IN (
            ...
            WHERE job_position = 3
                            ...
                            if ($result4->num_rows == $owner_count) {
                                // echo "Rows:" . $result4->num_rows; Live Debug
                                $all_owners_submitted = true;
                            } else {
                        ...
                        if ($is_manager == "manager" && $is_owner == 1) {
                            ...
                            echo '<button type="submit" class="btn btn-success w-100">ارسال و بستن فرم ( فرآیند ) چک لیست جاری</button>';
                            echo '</div>';
                            echo "<div class='col-3'>&nbsp;</div>";
                            echo "<div class='col-3'>&nbsp;</div>";
                            echo '</div>';
                            echo '</div>';
                        } else if ($is_manager === "not manager") {
                            echo "<div class='container-fluid'>";
                            echo "<div class='row'>";
                            echo "<div class='col-md-6 col-sm-12 p-0 pt-5 pb-5'>";
                            echo '<button type="submit" class="btn btn-success w-100">ارسال فرم چک لیست</button>';
                            echo '</div>';
                            echo "<div class='col-3'>&nbsp;</div>";
                            echo "<div class='col-3'>&nbsp;</div>";
                            echo '</div>';
                            ...
                            echo "<div class='row'>";
                            echo "<div class='col-md-6 col-sm-12 p-0 pt-5 pb-5'>";
                            echo "<p class='btn btn-dark w-100' dir='RTL'>شما مجاز به ارسال این فرم نمی باشید.</p>";
                            echo '</div>';
                            echo "<div class='col-3'>&nbsp;</div>";
                            echo "<div class='col-3'>&nbsp;</div>";
                            echo '</div>';
