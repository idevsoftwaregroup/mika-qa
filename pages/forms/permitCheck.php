...
// set discipline id of the permit :
$getDiscipline = "SELECT `id` FROM `permitDisciplines` WHERE `name` = ? ";
$stmt = $conn->prepare($getDiscipline);
$stmt->bind_param("s", $_SESSION['discipline']);
$stmt->execute();
$result = $stmt->get_result();
if ($result->num_rows > 0) {
    $row = $result->fetch_assoc();
    $_SESSION['selectedDiscID'] = $row['id'];
}
?>
<!DOCTYPE html>
<!--
...
-->
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                ...
                                <li class="breadcrumb-item p-5 btn btn-outline-white rounded bg-white text-dark">آیتم های فرم ( فرآیند ) پرمیت</li>
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                        <!--end::Page title=-->
                ...
                <!--end::Header-->
                <!--begin::Content-->
                <form method="post" class="form px-15" action="permitItemsSelectionDone.php">
                    <div class="container">
                        <div class="row">
                            <!-- Tab #1: Complete Latest Activity -->
                            <div class="accordion-item mb-5 col-md-4 col-sm-12 rounded-2">
                                <h2 class="accordion-header" id="tab1-heading">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#tab1-collapse" aria-expanded="true" aria-controls="tab1-collapse">
                                        تکمیل فعالیت پیشین
                                    </button>
                                </h2>
                                <div id="tab1-collapse" class="accordion-collapse collapse show" aria-labelledby="tab1-heading" data-bs-parent="#accordion">
                                    <div class="container">
                                        <div class="row">
                                            <div class="accordion-body col-12">
                                                <!-- <label class="form-check-label">
                                            <input type="checkbox" name="items[]" value="Related Latest Checklist" class="form-check-input">
                                            آخرین چک لیست مرتبط
                                        </label> -->
                                                <label for="lastActivity" class="form-label">فعالیت پیشین</label>
                                                <input type="text" name="lastActivity" id="lastActivity" class="form-control">
                                            </div>
                                            <div class="col-12 pb-5">
                                                <a href="lastActivity.php" target="_blank" class="btn btn-md btn-rounded btn-dark btn-block">جستجو</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="accordion-item mb-5 col-md-4 col-sm-12 rounded-2">
                                <h2 class="accordion-header" id="tab2-heading">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#tab2-collapse" aria-expanded="true" aria-controls="tab2-collapse">
                                        مستندات
                                    </button>
                                </h2>
                                <div id="tab2-collapse" class="accordion-collapse collapse show" aria-labelledby="tab2-heading" data-bs-parent="#accordion">
                                    <div class="accordion-body">
                                        ...
                                        $getDiscipline = "SELECT `documentations` FROM `permitItemsSelection` WHERE `discipline_id` = (SELECT `id` FROM `permitDisciplines` WHERE `name` = ?)";
                                        $stmt = $conn->prepare($getDiscipline);
                                        $stmt->bind_param("s", $_SESSION['discipline']);
                                        $stmt->execute();
                                        $result = $stmt->get_result();
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                if (isset($documentations) && $documentations != "") {
                                                    echo '<label class="form-check-label">
                                                                <input disabled type="checkbox" name="items[]" value="' . $documentations . '" class="form-check-input">
                                                                ' . $documentations . '
                                                            </label><br />';
                                                } else {
                                                    // echo "";
                            ...
                            <div class="accordion-item mb-5 col-md-4 col-sm-12 rounded-2">
                                <h2 class="accordion-header" id="tab3-heading">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#tab3-collapse" aria-expanded="false" aria-controls="tab3-collapse">
                                        مصالح مورد نیاز
                                    </button>
                                </h2>
                                <div id="tab3-collapse" class="accordion-collapse collapse show" aria-labelledby="tab3-heading" data-bs-parent="#accordion">
                                    <div class="accordion-body">
                                        <?php
                                        error_reporting(E_ALL);
                                        // session_start();
                                        ...
                                        // Fetch project name from database based on project ID
                                        // echo "اطلاعات اولیه " . $_SESSION['discipline'];

                                        // discipline
                                        $getDiscipline = "SELECT workingMaterials FROM permitItemsSelection WHERE discipline_id = (SELECT id FROM permitDisciplines WHERE name = ?)";
                                        $stmt = $conn->prepare($getDiscipline);
                                        $stmt->bind_param("s", $_SESSION['discipline']);
                                        $stmt->execute();
                                        $result = $stmt->get_result();
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                if ($workingMaterials) {
                                                    echo '<label class="form-check-label">
                      <input disabled type="checkbox" name="items[]" value="' . $workingMaterials . '" class="form-check-input">
                      ' . $workingMaterials . '
                  </label><br />';
                                                }
                                            }
                            ...
                            <div class="accordion-item mb-5 col-md-4 col-sm-12 rounded-2">
                                <h2 class="accordion-header" id="tab4-heading">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#tab4-collapse" aria-expanded="false" aria-controls="tab4-collapse">
                                        ابزارآلات و تجهیزات
                                    </button>
                                </h2>
                                <div id="tab4-collapse" class="accordion-collapse collapse show" aria-labelledby="tab4-heading" data-bs-parent="#accordion">
                                    <div class="accordion-body">
                                        <?php
                                        error_reporting(E_ALL);
                                        // Database connection parameters
                                        ...
                                        // Fetch project name from database based on project ID
                                        $getDiscipline = "SELECT `tools` FROM `permitItemsSelection` WHERE `discipline_id` = (SELECT `id` FROM `permitDisciplines` WHERE `name` = ?)";
                                        $stmt = $conn->prepare($getDiscipline);
                                        $stmt->bind_param("s", $_SESSION['discipline']);
                                        $stmt->execute();
                                        $result = $stmt->get_result();
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                if ($tools) {
                                                    echo '<label class="form-check-label">
                                                                <input disabled type="checkbox" name="items[]" value="' . $tools . '" class="form-check-input">
                                                                ' . $tools . '
                                                            </label><br />';
                                                } else {
                                                    echo "";
                            ...
                            <div class="accordion-item mb-5 col-md-4 col-sm-12 rounded-2">
                                <h2 class="accordion-header" id="tab5-heading">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#tab5-collapse" aria-expanded="false" aria-controls="tab5-collapse">
                                        شرایط محیطی
                                    </button>
                                </h2>
                                <div id="tab5-collapse" class="accordion-collapse collapse show" aria-labelledby="tab5-heading" data-bs-parent="#accordion">
                                    <div class="accordion-body">
                                        <?php
                                        error_reporting(E_ALL);
                                        // Database connection parameters
                                        ...
                                        // Fetch project name from database based on project ID
                                        $getDiscipline = "SELECT `env` FROM `permitItemsSelection` WHERE `discipline_id` = (SELECT `id` FROM `permitDisciplines` WHERE `name` = ?)";
                                        $stmt = $conn->prepare($getDiscipline);
                                        $stmt->bind_param("s", $_SESSION['discipline']);
                                        $stmt->execute();
                                        $result = $stmt->get_result();
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                if ($env) {
                                                    echo '<label class="form-check-label">
                                                                <input disabled type="checkbox" name="items[]" value="' . $env . '" class="form-check-input">
                                                                ' . $env . '
                                                            </label><br />';
                                                } else {
                                                    echo "";
                            ...
                            <div class="accordion-item mb-5 col-md-4 col-sm-12 rounded-2">
                                <h2 class="accordion-header" id="tab6-heading">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#tab6-collapse" aria-expanded="false" aria-controls="tab6-collapse">
                                        HSE
                                    </button>
                                </h2>
                                <div id="tab6-collapse" class="accordion-collapse collapse show" aria-labelledby="tab6-heading" data-bs-parent="#accordion">
                                    <div class="accordion-body">
                                        <?php
                                        error_reporting(E_ALL);
                                        // Database connection parameters
                                        ...
                                        // Fetch project name from database based on project ID
                                        $getDiscipline = "SELECT `hse` FROM `permitItemsSelection` WHERE `discipline_id` = (SELECT `id` FROM `permitDisciplines` WHERE `name` = ?)";
                                        $stmt = $conn->prepare($getDiscipline);
                                        $stmt->bind_param("s", $_SESSION['discipline']);
                                        $stmt->execute();
                                        $result = $stmt->get_result();
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                if ($hse) {
                                                    echo '<label class="form-check-label">
                                                                <input disabled type="checkbox" name="items[]" value="' . $hse . '" class="form-check-input">
                                                                ' . $hse . '
                                                            </label><br />';
                                                } else {
                                                    echo "";
                            ...
                            <div class="form-group mt-3 bg-white p-5">
                                <label class="d-block mb-5 text-black">آیا فرم جاری مورد تایید می باشد ؟</label>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input text-black" type="radio" name="permit_status" id="accept" value="Accept" required>
                                    <label class="form-check-label text-primary" for="accept">مورد تایید می باشد</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input text-black" type="radio" name="permit_status" id="reject" value="Reject" required>
                                    <label class="form-check-label text-danger" for="reject">مورد تایید نمی باشد</label>
                                </div>
                            </div>
                            <!-- Description Input Text Area -->
                            <div class="form-group mt-5 text-white w-100 p-0">
                                <!-- <label for="description">توضیحات</label> -->
                                <textarea id="description" name="description" class="form-control w-100" rows="4" cols="100" placeholder="توضیحات"></textarea>
                            </div>
                            <script>
                    ...
                    <div class="container mt-10">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 mb-10">
                                ...
                                <button type="submit" class="col-6 btn btn-lg btn-white text-black form-control">بررسی نهایی آیتم ها</button>
                            </div>
                        </div>
                    </div>
            </div>
