...
// Title of Page:
$title = "Quality Assurance | تایید نهایی فرآیند پرمیت";
...
-->
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                ...
                                <li class="breadcrumb-item p-5 btn rounded bg-white text-dark">تايید نهایی فرآیند پرمیت</li>
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                        <!--end::Page title=-->
                ...
                <!--end::Header-->
                <!--begin::Content-->
                <form action="permitPreviewDone.php" method="POST" class="form px-15" enctype="multipart/form-data">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12 fv-row mb-10">
                                    ...
                                    // echo $_SESSION['permit_id'];
                                    $sql = "SELECT * FROM permits WHERE `permit_id` = ?";
                                    $stmt = $conn->prepare($sql);
                                    $stmt->bind_param("s", $_SESSION['permit_id']);
                                    $stmt->execute();
                                    $result = $stmt->get_result();
                                    if ($result->num_rows > 0) {
                                        // Fetch and store contractor name
                                        $row = $result->fetch_assoc();
                                        // get the project name from the permits
                                        $projectName = $row['project_name'];
                                        // Display contractor name in readonly input field
                                        echo '<div class="p-5 bg-secondary">' . $projectName . '</div>';
                                        // echo '<input type="text" name="contractor_name" id="project_name" value="' . $contractorName . '" class="form-control text-center" readonly>';
                                    } else {
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        // Display contractor name in readonly input field
                                        echo '<div class="p-5 bg-secondary">' . $contractorName . '</div>';
                                        // echo '<input type="text" name="contractor_name" id="project_name" value="' . $contractorName . '" class="form-control text-center" readonly>';
                                    } else {
                                        echo "No contractor found for the specified project.";
                                    }
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        // Display contractor name in readonly input field
                                        echo '<div class="p-5 bg-secondary">' . $contractNumber . '</div>';
                                        // echo '<input type="text" name="contractor_name" id="project_name" value="' . $contractorName . '" class="form-control text-center" readonly>';
                                    } else {
                                        echo "No contractor found for the specified project.";
                                    }
                    ...
                    <fieldset>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12 fv-row mb-10">
                                    <label class="d-flex align-items-center fs-5 fw-bold mb-2 text-white">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        // Display contractor name in readonly input field
                                        echo '<div class="p-5 bg-secondary">' . $disciplineGroup . '</div>';
                                        // echo '<input type="text" name="contractor_name" id="project_name" value="' . $contractorName . '" class="form-control text-center" readonly>';
                                    } else {
                                        echo "No contractor found for the specified project.";
                                    }
                                ...
                                <div class="col-md-4 col-sm-12 fv-row mb-10">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        $row = $result->fetch_assoc();
                                        // get the project name from the permits
                                        $discipline_item = $row['discipline'];
                                        // Display contractor name in readonly input field
                                        echo '<div class="p-5 bg-secondary">' . $discipline_item . '</div>';
                                        // echo '<input type="text" name="contractor_name" id="project_name" value="' . $contractorName . '" class="form-control text-center" readonly>';
                                    } else {
                                        echo "No contractor found for the specified project.";
                                    }
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        // Display contractor name in readonly input field
                                        echo '<div class="p-5 bg-secondary">' . $permitID . '</div>';
                                        // echo '<input type="text" name="contractor_name" id="project_name" value="' . $contractorName . '" class="form-control text-center" readonly>';
                                    } else {
                                        echo "No contractor found for the specified project.";
                                    }
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        $crew = $row['crew'];
                                        // Display contractor name in readonly input field
                                        echo '<div class="p-5 bg-secondary">' . $crew . '</div>';
                                        // echo '<input type="text" name="contractor_name" id="project_name" value="' . $contractorName . '" class="form-control text-center" readonly>';
                                    } else {
                                        echo "No contractor found for the specified project.";
                                    }
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        $axis = $row['axis'];
                                        // Display contractor name in readonly input field
                                        echo '<div class="p-5 bg-secondary">' . $axis . '</div>';
                                        // echo '<input type="text" name="contractor_name" id="project_name" value="' . $contractorName . '" class="form-control text-center" readonly>';
                                    } else {
                                        echo "No contractor found for the specified project.";
                                    }
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        $floor = $row['floor'];
                                        // Display contractor name in readonly input field
                                        echo '<div class="p-5 bg-secondary">' . $floor . '</div>';
                                        // echo '<input type="text" name="contractor_name" id="project_name" value="' . $contractorName . '" class="form-control text-center" readonly>';
                                    } else {
                                        echo "No contractor found for the specified project.";
                                    }
                                ...
                                <div class="col-md-4 col-sm-12 mt-5">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        $block = $row['block'];
                                        // Display contractor name in readonly input field
                                        echo '<div class="p-5 bg-secondary">' . $block . '</div>';
                                        // echo '<input type="text" name="contractor_name" id="project_name" value="' . $contractorName . '" class="form-control text-center" readonly>';
                                    } else {
                                        echo "No contractor found for the specified project.";
                                    }
                                ...
                                <div class="col-md-4 col-sm-12 mt-5">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        $zone = $row['zone'];
                                        // Display contractor name in readonly input field
                                        echo '<div class="p-5 bg-secondary">' . $zone . '</div>';
                                        // echo '<input type="text" name="contractor_name" id="project_name" value="' . $contractorName . '" class="form-control text-center" readonly>';
                                    } else {
                                        echo "No contractor found for the specified project.";
                                    }
                                ...
                                <div class="col-md-4 col-sm-12 mt-5">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        // echo $time_to_action;
                                        // Use a regular expression to match numbers followed by words
                                        preg_match('/(\d+)\s*(\w+)/', $time_to_action, $matches);

                                        if ($matches) {
                                            $number = $matches[1]; // The numeric part
                                            $unit = $matches[2];   // The string part
                                            // echo "Number: $number\n";
                                            // echo "Unit: $unit\n";
                                        } else {
                                            echo "No match found.";
                                        ...
                                        // Display contractor name in readonly input field
                                        echo '<div class="p-5 bg-secondary">' . $number . ($unit == "days" ? " روز" : " حالت پیش فرض") . '</div>';
                                        // echo '<input type="text" name="contractor_name" id="project_name" value="' . $contractorName . '" class="form-control text-center" readonly>';
                                    } else {
                                        echo "No contractor found for the specified project.";
                                    }
                                ...
                                <div class="col-12 mb-5 mt-5">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        // Display contractor name in readonly input field
                                        echo '<div class="p-5 bg-secondary">' . $operation_description . '</div>';
                                        // echo '<input type="text" name="contractor_name" id="project_name" value="' . $contractorName . '" class="form-control text-center" readonly>';
                                    } else {
                                        echo "No contractor found for the specified project.";
                                    }
                                ...
                                <div class="container mt-5">
                                    ...
                                    <div class="container mt-5 p-0 col-md-4 col-sm-12">
                                        <button type="button" class="w-100 col-md-4 col-sm-12 btn btn-primary text-right btn-block w-50" data-bs-toggle="modal" data-bs-target="#fileModal">
                                            مشاهده فایل ها
                                        </button>
                                    </div>
                                    ...
                                    <div class="modal fade" id="fileModal" tabindex="-1" aria-labelledby="fileModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content w-100 h-100">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="fileModalLabel">فایل ها</h5>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        // Prepare and execute SQL query to fetch file paths
                                                        $sql = "SELECT * FROM permits WHERE `permit_id` = ?";
                                                        $stmt = $conn->prepare($sql);
                                                        $stmt->bind_param("s", $_SESSION['permit_id']);
                                                        $stmt->execute();
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                            // Fetch the row containing the file paths
                                                            $row = $result->fetch_assoc();
                                                            $dir = $row['dir'];
                                                            $file_paths_str = $row['file_name']; // Assuming file_name contains concatenated file paths

                                                            // Split the concatenated file paths into an array
                                                            $file_paths = explode(';', $file_paths_str);

                                                            // Display each file in an iframe
                                                            foreach ($file_paths as $file_path) {
                                                                $full_path = $dir . $file_path;
                                                                echo '<div class="col-6 mt-2"><iframe
                                        src="' . $full_path . '"
                                        frameborder="0"
                                        scrolling="auto"
                                        height="200"
                                      ...
                                      ></iframe></div>';
                                                            ...
                                                            echo "No files found for the specified permit.";
                                                        }
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-3">&nbsp;</div>
                            <div class="col-md-6 col-sm-12 mb-10 mt-15">
                                ...
                                <button type="submit" class="w-100 col-6 btn btn-white text-black form-control">شروع فرآیند پرمیت</button>
                            </div>
                        </div>
                    </div>
                </form>
