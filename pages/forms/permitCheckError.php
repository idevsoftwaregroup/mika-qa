            ...
            <div class="d-flex flex-column flex-lg-row-fluid py-10 col-12 h-100" style="background-color: black;background-image: url(./assets/media/lines.webp);">
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid">
                    ...
                    <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                        ...
                        <p class="h-3 text-white text-center" dir="RTL">آیتمی که به عنوان دیسیپلین انتخاب کرده اید دارای آیتم نمی باشد در نتیجه نمی توانید برای آن پرمیت صادر نمایید. لطفا با ادمین سامانه تماس بگیرید.</p>
                        <hr class="w-100 bg-white">
                        <a href="./permit.php" class="btn btn-lg w-100 bg-white">بازگشت به صفحه صدور پرمیت</a>
                        <!--end::Form-->
                    </div>
                    <!--end::Wrapper-->
                </div>
