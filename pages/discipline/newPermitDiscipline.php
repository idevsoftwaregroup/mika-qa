...
$title = "Quality Assurance | New Discipline";
?>
<!DOCTYPE html>
<!--
Author: Keenthemes
...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/backgrounds.rtl.css">
...
-->
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                            ...
                                                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link" href="/pages/discipline/newPermitDiscipline.php">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">دیسیپلین جدید فرآیند پرمیت</span>
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item">
                            ...
                            <div class="flex-column-auto pt-10 px-5" id="kt_aside_secondary_footer">
                                <a href="/logout.php" class="btn btn-bg-light btn-color-gray-600 btn-flex btn-active-color-primary flex-center w-100" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-trigger="hover" data-bs-offset="0,5" data-bs-dismiss-="click" title="200+ in-house components and 3rd-party plugins">
                                    ...
                                    <span class="svg-icon btn-icon svg-icon-4 ms-2">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen005.svg--> <span class="svg-icon btn-icon svg-icon-4 ms-2"> <img width="25" height="25" src="https://img.icons8.com/windows/25/000000/logout-rounded-left.png" alt="logout-rounded-left" /> </span> <!--end::Svg Icon-->
                                    </span>
                                    <!--end::Svg Icon-->
                                </a>
                            </div>
                ...
                <!--end::Secondary-->
                <!--begin::Aside Toggle-->
                <button class="btn btn-sm btn-icon bg-body btn-color-gray-700 btn-active-primary position-absolute translate-middle start-100 bottom-0 shadow-sm d-none d-lg-flex" data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="body" data-kt-toggle-name="aside-minimize" style="margin-bottom: 1.35rem">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            <!--begin::Heading-->
                            <h1 class="text-dark fw-bolder my-0 fs-2">دیسیپلین جدید فرآیند پرمیت</h1>
                            <!--end::Heading-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                ...
                                <li class="breadcrumb-item text-dark">ایجاد دیسیپلین جدید فرآیند پرمیت</li>
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                        <!--end::Page title=-->
                ...
                <!--end::Header-->
                <!--begin::Content-->
                <form class="form newDiscipline-formBackground" novalidate="novalidate" id="kt_modal_create_app_form" action="createPermitDiscipline.php" method="POST">
                    <!--begin::Step 1-->
                        ...
                        <div class="w-100 row">
                            ...
                            <div class="col-4 fv-row mb-10">
                                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                    <span class="required">نام دیسیپلین</span>
                                </label>
                                <input type="text" class="text-center form-control form-control-lg form-control-solid" name="discipline_name" placeholder="" value="" />
                            </div>
                            <div class="col-4 fv-row mb-10">
                                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                    <span class="required">گروه دیسیپلین</span>
                                </label>
                                <input type="text" class="text-center form-control form-control-lg form-control-solid" name="discipline_group" placeholder="" value="" />
                            </div>
                            <div class="col-4 fv-row mb-10">
                                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                    <span class="required">کد دیسیپلین</span>
                                </label>
                                <input type="text" class="text-center form-control form-control-lg form-control-solid" name="discipline_code" placeholder="" value="" />
                            </div>
                            ...
                            <div class="px-1 col-3">
                                <button type="button" id="add_dynamic_items_btn" class=" mt-10 btn btn-sm btn-primary btn-block">افزودن آیتم دیسیپلین جدید</button>
                            </div>
                            <!--end::Dynamic items section-->
                            <!-- begin::Send Button -->
                            <div class="px-1 col-3">
                                <input type="submit" value="ذخیره فرم جاری" class=" mt-10 btn btn-success btn-sm">
                            </div>
                            <!-- end::Send Button -->
                        </div>
                    </div>
			...
			<div class="container mt-5 addBackgroundToNewDiscipline"> 
                <div class="row dynamic-item">
                    <div class="fv-row mb-10 col-4">
                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                            <span class="required">تکمیل فعالیت پیشین</span>
                        </label>
                        <input type="text" class="text-center form-control form-control-lg form-control-solid" name="lastActivity_${dynamicItemId}" placeholder="" value="" />
                    </div>
                    <div class="fv-row mb-10 col-4">
                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                            <span class="required">مستندات و نیازمندی ها</span>
                        </label>
                        <input type="text" class="text-center form-control form-control-lg form-control-solid" name="documentations_${dynamicItemId}" placeholder="" value="" />
                    </div>
                    <div class="fv-row mb-10 col-4">
                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                            <span class="required">مصالح پای کار</span>
                        </label>
                        <input type="text" class="text-center form-control form-control-lg form-control-solid" name="workingMaterials_${dynamicItemId}" placeholder="" value="" />
                    </div>
                    <div class="fv-row mb-10 col-4">
                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                            <span class="required">ابزار آلات و تجهیزات</span>
                        </label>
                        <input type="text" class="text-center form-control form-control-lg form-control-solid" name="tools_${dynamicItemId}" placeholder="" value="" />
                    </div>
                    <div class="fv-row mb-10 col-4">
                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                            <span class="required">شرایط محیطی</span>
                        </label>
                        <input type="text" class="text-center form-control form-control-lg form-control-solid" name="env_${dynamicItemId}" placeholder="" value="" />
                    </div>
                    <div class="fv-row mb-10 col-4">
                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                            <span class="required">HSE</span>
                        </label>
                        <input type="text" class="text-center form-control form-control-lg form-control-solid" name="hse_${dynamicItemId}" placeholder="" value="" />
                    </div>
                </div>
			</div>
            `;
                        ...
                        setCookie("dynamicItemIdPermitDisciplines", dynamicItemId, 365); // Save for 365 days
