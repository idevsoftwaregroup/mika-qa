...
$title = "Quality Assurance | View Discipline";
?>
<!DOCTYPE html>
<!--
Author: Keenthemes
...
-->
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
				...
				<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
					...
					<div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
							<!--begin::Heading-->
							<h1 class="text-dark fw-bolder my-0 fs-2">لیست دیسیپلین ها</h1>
							<!--end::Heading-->
							<!--begin::Breadcrumb-->
							<ul class="breadcrumb fw-bold fs-base my-1">
								...
								<li class="breadcrumb-item text-dark">لیستی از دیسیپلین های سیستم</li>
							</ul>
							<!--end::Breadcrumb-->
						</div>
						<!--end::Page title=-->
				...
				<!--end::Header-->
				<!--begin::Content-->
				<table class="table table-striped text-center align-middle table-row-dashed fs-6 gy-5 mx-10" id="kt_table_users">
					<!--begin::Table head-->
					<thead>
						<!--begin::Table row-->
						<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
							<th class="min-w-50px">شماره یکتا دیسیپلین</th>
							<th class="min-w-50px">شماره یکتا چک لیست</th>
							<th class="min-w-125px">نام دیسیپلین</th>
							<th class="min-w-125px">گروه دیسیپلین</th>
							<th class="min-w-125px">کد یکتا دیسیپلین</th>
							<th class="min-w-125px">شرح عملیات</th>
							<th class="min-w-125px">معیار بررسی</th>
							<th class="min-w-125px">روش / ابزار کنترل</th>
							<th class="min-w-125px">مقدار حداقل بررسی ( درصد )</th>
							<th class="min-w-125px">ملاحظات</th>
							<th class="min-w-125px">رواداری مجاز</th>
						</tr>
					</thead>
					<!--end::Table head-->
					<!--begin::Table body-->
					<tbody class="text-gray-600 fw-bold">
						...
						// SQL query to retrieve data from disciplines and checklist_items tables
						$sql = "SELECT d.id AS discipline_id, d.name AS discipline_name, d.group AS discipline_group, d.code AS discipline_code,
               c.id AS checklist_id, c.operation_description, c.review_criteria, c.control_method_tool,
               c.minimum_check_value, c.considerations, c.allowable_tolerance
        FROM disciplines d
        JOIN checklist_items c ON d.id = c.discipline_id";

						$result = $conn->query($sql);

						if ($result->num_rows > 0) {
							// echo '<table id="kt_table_users" class="table align-middle table-row-dashed fs-6 gy-5">';
							// echo '<thead>';
							...
							while ($row = $result->fetch_assoc()) {
								...
								echo '<td>' . $row['discipline_group'] . '</td>';
								echo '<td>' . $row['discipline_code'] . '</td>';
								echo '<td>' . $row['operation_description'] . '</td>';
								echo '<td>' . $row['review_criteria'] . '</td>';
								echo '<td>' . $row['control_method_tool'] . '</td>';
								echo '<td>' . $row['minimum_check_value'] . '</td>';
								echo '<td>' . $row['considerations'] . '</td>';
								echo '<td>' . $row['allowable_tolerance'] . '</td>';
								echo '</tr>';
							}
						} else {
