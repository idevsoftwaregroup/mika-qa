...
-->
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
				...
				<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
					...
					<div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
							<!--begin::Heading-->
							<h1 class="text-dark fw-bolder my-0 fs-2">دیسیپلین جدید</h1>
							<!--end::Heading-->
							<!--begin::Breadcrumb-->
							<ul class="breadcrumb fw-bold fs-base my-1">
								...
								<li class="breadcrumb-item text-dark">ایجاد دیسیپلین جدید</li>
							</ul>
							<!--end::Breadcrumb-->
						</div>
						<!--end::Page title=-->
				...
				<!--end::Header-->
				<!--begin::Content-->
				<form class="form newDiscipline-formBackground" novalidate="novalidate" id="kt_modal_create_app_form" action="createDiscipline.php" method="POST">
					<!--begin::Step 1-->
			...
			<div class="container mt-5 addBackgroundToNewDiscipline"> 
                <div class="row dynamic-item">
                    <div class="fv-row mb-10 col-4">
                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                            <span class="required">شرح عملیات</span>
                        </label>
                        <input type="text" class="text-center form-control form-control-lg form-control-solid" name="operation_description_${dynamicItemId}" placeholder="" value="" />
                    </div>
                    <div class="fv-row mb-10 col-4">
                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                            <span class="required">معیار بررسی</span>
                        </label>
                        <input type="text" class="text-center form-control form-control-lg form-control-solid" name="review_criteria_${dynamicItemId}" placeholder="" value="" />
                    </div>
                    <div class="fv-row mb-10 col-4">
                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                            <span class="required">روش / ابزار کنترل</span>
                        </label>
                        <input type="text" class="text-center form-control form-control-lg form-control-solid" name="control_method_${dynamicItemId}" placeholder="" value="" />
                    </div>
                    <div class="fv-row mb-10 col-4">
                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                            <span class="required">مقدار حداقل بررسی ( درصد )</span>
                        </label>
                        <input type="text" class="text-center form-control form-control-lg form-control-solid" name="minimum_check_value_${dynamicItemId}" placeholder="" value="" />
                    </div>
                    <div class="fv-row mb-10 col-4">
                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                            <span class="required">ملاحظات</span>
                        </label>
                        <input type="text" class="text-center form-control form-control-lg form-control-solid" name="considerations_${dynamicItemId}" placeholder="" value="" />
                    </div>
                    <div class="fv-row mb-10 col-4">
                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                            <span class="required">رواداری مجاز</span>
                        </label>
                        <input type="text" class="text-center form-control form-control-lg form-control-solid" name="allowable_tolerance_${dynamicItemId}" placeholder="" value="" />
                    </div>
                </div>
			</div>
            `;
						...
						setCookie("dynamicItemId", dynamicItemId, 365); // Save for 365 days
