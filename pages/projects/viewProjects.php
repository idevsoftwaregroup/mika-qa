<?php
$title = "Quality Assurance | View Projects";
?>
<!DOCTYPE html>
<!--
Author: Keenthemes
  ...
  <path d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0M8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4m.256 7a4.5 4.5 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10q.39 0 .74.025c.226-.341.496-.65.804-.918Q8.844 9.002 8 9c-5 0-6 3-6 4s1 1 1 1zm3.63-4.54c.18-.613 1.048-.613 1.229 0l.043.148a.64.64 0 0 0 .921.382l.136-.074c.561-.306 1.175.308.87.869l-.075.136a.64.64 0 0 0 .382.92l.149.045c.612.18.612 1.048 0 1.229l-.15.043a.64.64 0 0 0-.38.921l.074.136c.305.561-.309 1.175-.87.87l-.136-.075a.64.64 0 0 0-.92.382l-.045.149c-.18.612-1.048.612-1.229 0l-.043-.15a.64.64 0 0 0-.921-.38l-.136.074c-.561.305-1.175-.309-.87-.87l.075-.136a.64.64 0 0 0-.382-.92l-.148-.045c-.613-.18-.613-1.048 0-1.229l.148-.043a.64.64 0 0 0 .382-.921l-.074-.136c-.306-.561.308-1.175.869-.87l.136.075a.64.64 0 0 0 .92-.382zM14 12.5a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0"/>
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
				...
				<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
					...
					<div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
							<!--begin::Heading-->
							<h1 class="text-dark fw-bolder my-0 fs-2">لیست پروژه / ها</h1>
							<!--end::Heading-->
							<!--begin::Breadcrumb-->
							<ul class="breadcrumb fw-bold fs-base my-1">
								...
								<li class="breadcrumb-item text-dark">لیست پروژه ها وپرسنل آن</li>
							</ul>
							<!--end::Breadcrumb-->
						</div>
						<!--end::Page title=-->
				...
				<table class="table table-striped text-center align-middle table-row-dashed fs-6 gy-5 mx-10" id="kt_table_users">
					...
					<thead>
						<!--begin::Table row-->
						<tr class="text-start text-muted text-center fw-bolder fs-7 text-uppercase gs-0">
							<th class="min-w-200px">شماره یکتای پروژه</th>
							<th class="min-w-50px">نام پروژه</th>
							<th class="min-w-125px">شماره قرارداد</th>
							<th class="min-w-125px">نام پیمانکار</th>
							<th class="min-w-125px">نام پرنسل</th>
							<th class="min-w-125px">شیفت کاری</th>
					...
					<tbody class="text-gray-600 fw-bold">
						...
						$sql = "SELECT p.id AS ProjectID, p.project_name AS ProjectName, p.contract_number AS ContractNumber, p.contractor_name AS ContractorName,
            pp.name AS FullName, pp.shift AS Shift, pp.job_title AS JobTitle
        FROM project p
        JOIN projectPersonnel pp ON p.id = pp.projectID";
				...
				<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
					...
					<div class="container-xxl d-flex flex-column  flex-stack">
						...
						<div class="text-dark order-2 order-md-1">
							...
							<a href="https://mikapartners.co" target="_blank" class="text-muted text-hover-primary fw-bold me-2 fs-6">Mikapartners Group.</a>
						</div>
						<!--end::Copyright-->
						<!--begin::Menu-->
						<ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
							<li class="menu-item">
								<a href="https://mikapartners.co/why-mika/" target="_blank" class="menu-link px-2">About</a>
							</li>
							<li class="menu-item">
								<a href="https://mikapartners.co/contact-us/" target="_blank" class="menu-link px-2">Support</a>
							</li>
						</ul>
						<!--end::Menu-->
					</div>
