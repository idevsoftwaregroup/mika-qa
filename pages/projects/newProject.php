					...
					<div class="aside-nav d-flex flex-column align-items-center flex-column-fluid w-100 pt-5 pt-lg-0" id="kt_aside_nav">
						...
						<div class="hover-scroll-y mb-10" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_nav" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-offset="0px">
							...
							<ul class="nav flex-column">
								<!--begin::Nav item-->
								<li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Forms">
									<!--begin::Nav link-->
								...
								<!--end::Nav item-->
								<!--begin::Nav item-->
								<li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Menus">
									<!--begin::Nav link-->
											...
											<div class="d-flex mb-10">
												...
												<div id="kt_header_search" class="d-flex align-items-center w-lg-400px" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-start">
													...
													<form data-kt-search-element="form" class="w-100 position-relative mb-5 mb-lg-0" autocomplete="off">
														...
														<span>
															علیرضا هیبتی (کارشناس برنامه نویسی )
														</span>
														<!--end :: user data -->
														<!--end::Hidden input-->
														<!--begin::Icon-->
...
-->
											...
											<div class="m-0">
												<!--begin::Heading-->
												<h1 class="text-gray-800 fw-bold mb-6 mx-5">فرم ها ( فرآیند ها )</h1>
												<!--end::Heading-->
												<!--begin::Items-->
												<div class="mb-10">
													<!--begin::Item-->
													<a href="/pages/forms/permit.php" class="custom-list d-flex align-items-center px-5 py-4">
														<!--begin::Symbol-->
														<div class="symbol symbol-40px me-5">
															<span class="symbol-label">
																<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="512" height="512" viewBox="0 0 128 128">
																	<path fill="#fff" d="M64 9A55 55 0 1 0 64 119A55 55 0 1 0 64 9Z"></path>
																	<path fill="#444b54" d="M64,122C32,122,6,96,6,64S32,6,64,6s58,26,58,58S96,122,64,122z M64,12c-28.7,0-52,23.3-52,52s23.3,52,52,52 s52-23.3,52-52S92.7,12,64,12z"></path>
																	<path fill="#71c2ff" d="M62,79C62,79,62,79,62,79c-0.8,0-1.6-0.4-2.2-1L46.7,64c-1.1-1.2-1.1-3.1,0.2-4.2c1.2-1.1,3.1-1.1,4.2,0.2 L62,71.6l20.9-21.8c1.1-1.2,3-1.2,4.2-0.1c1.2,1.1,1.2,3,0.1,4.2L64.2,78.1C63.6,78.7,62.8,79,62,79z"></path>
																</svg>
															</span>
														</div>
														<!--end::Symbol-->
														...
														<div class="d-flex flex-column flex-grow-1">
															...
															<!--end::Title-->
															<!--begin::Link-->
															<span class="text-gray-400 fw-bold">فرآیند پرمیت</span>
															<!--end::Link-->
														</div>
														<!--begin::Description-->
													</a>
													<!--end::Item-->
													<!--begin::Item-->
													<a href="/pages/forms/beforeChecklist.php" class="custom-list d-flex align-items-center px-5 py-4">
														<!--begin::Symbol-->
														<div class="symbol symbol-40px me-5">
															<span class="symbol-label">
																<img src="../../assets/media/checklist-logo.png" class="h-100   align-self-center" alt="" />
															</span>
														</div>
														<!--end::Symbol-->
														<!--begin::Description-->
														<div class="d-flex flex-column flex-grow-1">
															<!--begin::Title-->
															<h5 class="custom-list-title fw-bold text-gray-800 mb-1"> چک لیست</h5>
															<!--end::Title-->
															<!--begin::Link-->
															<span class="text-gray-400 fw-bold">فرآیند چک لیست</span>
															<!--end::Link-->
														</div>
														<!--begin::Description-->
													</a>
										...
										<div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 px-6 my-5 my-lg-0" id="kt_aside_menu" data-kt-menu="true">
											<div id="kt_aside_menu_wrapper" class="menu-fit">
												...
												<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
													...
													<span class="menu-title">صفحه ها</span>
													<span class="menu-arrow"></span>
													</span>
													<div class="menu-sub menu-sub-accordion menu-active-bg">
														<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
															<span class="menu-link">
																...
																<span class="menu-title">دیسیپلین ها</span>
																<span class="menu-arrow"></span>
															</span>
															<div class="menu-sub menu-sub-accordion menu-active-bg">
																<div class="menu-item">
																	<a class="menu-link" href="/pages/discipline/newDiscipline.php">
																		...
																		<span class="menu-title">دیسیپلین جدید</span>
																	</a>
																</div>
																<div class="menu-item">
																	<a class="menu-link" href="/pages/discipline/viewDisciplines.php">
																		...
																		<span class="menu-title">لیست دیسیپلین ها</span>
																	</a>
																</div>
															</div>
														</div>
															...
															<div class="menu-sub menu-sub-accordion menu-active-bg">
																<div class="menu-item">
																	<a class="menu-link" href="/pages/projects/newProject.php">
																		...
																		<span class="menu-title">پروژه جدید</span>
																	</a>
																</div>
																<div class="menu-item">
																	<a class="menu-link" href="/pages/projects/viewProjects.php">
																		...
																		<span class="menu-title">لیست پروژه ها</span>
																	</a>
																</div>
																<!-- <div class="menu-item">
												...
												<div class="menu-item">
													<div class="menu-content pt-8 pb-2">
														<span class="menu-section text-muted text-uppercase fs-8 ls-1">کاربران </span>
													</div>
												</div>
												<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
													<span class="menu-link">
														...
														<span class="menu-title">مدیریت کاربران سیستم</span>
														<span class="menu-arrow"></span>
													</span>
												...
												<div class="menu-item">
													<a class="menu-link" href="/documentation/getting-started/changelog.php">
														...
														<span class="menu-title">نسخه اپلیکیشن v8.0.25</span>
													</a>
												</div>
											</div>
										</div>
									...
									<div class="tab-pane fade" id="kt_aside_nav_tab_subscription" role="tabpanel">
										...
										<div class="mx-5">
											...
											<div class="text-center pt-10 mb-20">
												<!--begin::Title-->
												<h2 class="fs-2 fw-bolder mb-7">اپلیکیشن تضمین کیفیت میکا</h2>
												<!--end::Title-->
												<!--begin::Description-->
												<p class="text-gray-400 fs-4 fw-bold mb-10">تضمین کیفیت پروژه ها ساختمانی گروه ساختمانی میکا</p>
												<!--end::Description-->
												<!--begin::Action-->
												<a href="https://mikapartners.co" class="btn btn-primary" data-bs-target="#kt_modal_upgrade_plan" data-bs-toggle="modal">وب سایت رسمی گروه ساختمانی میکا</a>
												<!--end::Action-->
											</div>
											<!--end::Container-->
											<!--begin::Illustration-->
							...
							<div class="flex-column-auto pt-10 px-5" id="kt_aside_secondary_footer">
								<a href="/logout.php" class="btn btn-bg-light btn-color-gray-600 btn-flex btn-active-color-primary flex-center w-100" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-trigger="hover" data-bs-offset="0,5" data-bs-dismiss-="click" title="200+ in-house components and 3rd-party plugins">
									<span class="btn-label">خروج از سامانه</span>
									<!--begin::Svg Icon | path: icons/duotune/general/gen005.svg-->
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
				...
				<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
					...
					<div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
							<!--begin::Heading-->
							<h1 class="text-dark fw-bolder my-0 fs-2">پروژه جدید</h1>
							<!--end::Heading-->
							<!--begin::Breadcrumb-->
							<ul class="breadcrumb fw-bold fs-base my-1">
								...
								<li class="breadcrumb-item text-dark">پروژه ها و پرسنل مربوط به هر پروژه</li>
							</ul>
							<!--end::Breadcrumb-->
						</div>
						<!--end::Page title=-->
				...
				<!--end::Header-->
				<!--begin::Content-->
				<form class="form newDiscipline-formBackground" novalidate="novalidate" id="kt_modal_create_app_form" action="createProject.php" method="POST">
					<!--begin::Step 1-->
					<div class="container current" data-kt-stepper-element="content">
						<div class="w-100 row">
							<!--begin::Input group for static items-->
							<div class="col-4 fv-row mb-10">
								<label class="d-flex align-items-center fs-5 fw-bold mb-2">
									<span class="required">نام پروژه</span>
								</label>
								<input type="text" class="text-center form-control form-control-lg form-control-solid" name="projectname" placeholder="" value="" />
							</div>
							<div class="col-4 fv-row mb-10">
								<label class="d-flex align-items-center fs-5 fw-bold mb-2">
									<span class="required">شماره قرارداد</span>
								</label>
								<input type="text" class="text-center form-control form-control-lg form-control-solid" name="contractnumber" placeholder="" value="" />
							</div>
							<div class="col-4 fv-row mb-10">
								<label class="d-flex align-items-center fs-5 fw-bold mb-2">
									<span class="required">نام پیمانکار</span>
								</label>
								<input type="text" class="text-center form-control form-control-lg form-control-solid" name="contractorname" placeholder="" value="" />
							</div>
							...
							<div class="col-12 fv-row mb-10">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="checkbox" value="elevator" name="discipline_group[]" id="discipline_group_1">
									<label class="form-check-label" for="discipline_group_1">
										آسانسور و پله برقی و رمپ برقی
									</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="checkbox" value="electrical" name="discipline_group[]" id="discipline_group_2">
									<label class="form-check-label" for="discipline_group_2">
										تاسیسات الکتریکال
									</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="checkbox" value="mechanical" name="discipline_group[]" id="discipline_group_3">
									<label class="form-check-label" for="discipline_group_3">
										تاسیسات مکانیکال
									</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="checkbox" value="softhard" name="discipline_group[]" id="discipline_group_4">
									<label class="form-check-label" for="discipline_group_4">
										سفت کاری و نازک کاری
									</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="checkbox" value="structure" name="discipline_group[]" id="discipline_group_5">
									<label class="form-check-label" for="discipline_group_5">
										گود و سازه
									</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="checkbox" value="climer" name="discipline_group[]" id="discipline_group_6">
									<label class="form-check-label" for="discipline_group_6">
										نما و کلایمر
									</label>
								</div>
							</div>

							<!--end::Input group for static items-->

							<!--begin::Dynamic items section-->
							<div id="dynamic_items_container">
								<!-- Dynamic items will be added here -->
							</div>
							<div class="px-1 col-3">
								<button type="button" id="add_dynamic_items_btn" class=" mt-10 btn btn-sm btn-primary btn-block">افزودن آیتم جدید</button>
							</div>
							<!--end::Dynamic items section-->
							<!-- begin::Send Button -->
							<div class="px-1 col-3">
								<input type="submit" value="ذخیره فرم جاری ( تعریف پروژه و پرسنل آن )" class=" mt-10 btn btn-success btn-sm">
							</div>
							<!-- end::Send Button -->
						</div>
					</div>
				...
				<script>
					...
					// Read personnel names from the cookie
					const personnelNamesCookie = getCookie('personnelNames'); // Change 'personnelNames' to your cookie name
					const personnelNames = personnelNamesCookie ? JSON.parse(personnelNamesCookie) : [];

					// Add dynamic items button click event
					document.getElementById('add_dynamic_items_btn').addEventListener('click', function() {
						// Create dynamic items container
						var dynamicItemsContainer = document.getElementById('dynamic_items_container');

						// Create dynamic items group
						var dynamicItemsGroup = document.createElement('div');
						dynamicItemsGroup.classList.add('dynamic-items-group');

						// Add dynamic item elements to the group
						dynamicItemsGroup.innerHTML = `
    <div class="container mt-5 addBackgroundToNewDiscipline"> 
        <div class="row dynamic-item">
            <div class="fv-row mb-10 col-3">
                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                    <span class="required">عنوان شغلی</span>
                </label>
                <input type="text" class="text-center form-control form-control-lg form-control-solid" name="jobtitle_${dynamicItemId}" placeholder="" value="" />
            </div>
            <div class="fv-row mb-10 col-3">
                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                    <span class="required">شیفت کاری</span>
                </label>
                <input type="text" class="text-center form-control form-control-lg form-control-solid" name="shift_${dynamicItemId}" placeholder="" value="" />
            </div>
            <div class="fv-row mb-10 col-3">
                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                    <span class="required">نام / نام خانوادگی پرسنل</span>
                </label>
                <!-- Personnel FullName select dropdown -->
                <div class="input-group">
                    <input type="text" class="form-control" id="personnel_fullname_search_${dynamicItemId}" name="personnel_fullname_list_${dynamicItemId}" list="personnel_fullname_list_${dynamicItemId}" placeholder="جستجوی نام پرسنل">
                    <datalist id="personnel_fullname_list_${dynamicItemId}">
            ...
            <div class="fv-row mb-10 col-3">
                ...
                <select class="form-control form-control-lg form-control-solid" placeholder="... انتخاب کنید" name="role_${dynamicItemId}">
    ...
    `;
						...
						// Append dynamic items group to the container
						dynamicItemsContainer.appendChild(dynamicItemsGroup);

						// Populate personnel name fields in the dynamic item
						const datalist = dynamicItemsGroup.querySelector(`datalist[id="personnel_fullname_list_${dynamicItemId}"]`);
						...
						const textInput = dynamicItemsGroup.querySelector(`#personnel_fullname_search_${dynamicItemId}`);
						...
						// Increment the dynamic item ID for uniqueness
						dynamicItemId++;

						// Save dynamicItemId to a cookie
						setCookie("projectPersonelID", dynamicItemId, 365); // Save for 365 days
					});
				</script>
				...
				<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
					...
					<div class="container-xxl d-flex flex-column  flex-stack">
						...
						<div class="text-dark order-2 order-md-1">
							<span class="text-gray-400 fw-bold me-1">طراحی و توسعه</span>
							<a href="https://mikapartners.co" target="_blank" class="text-muted text-hover-primary fw-bold me-2 fs-6">واحد نرم افزار گروه ساختمانی میکا</a>
						</div>
						<!--end::Copyright-->
						<!--begin::Menu-->
						<ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
							<li class="menu-item">
								<a href="https://mikapartners.co/why-mika/" target="_blank" class="menu-link px-2"> </a>
							</li>
							<li class="menu-item">
								<a href="https://mikapartners.co/why-mika/" target="_blank" class="menu-link px-2">درباره میکا</a>
							</li>
							<li class="menu-item">
								<a href="https://mikapartners.co/contact-us/" target="_blank" class="menu-link px-2">پشتیبانی</a>
							</li>
						</ul>
						<!--end::Menu-->
					</div>
