                ...
                <div class="container-fluid p-10" style="direction: rtl;overflow-x: scroll;">
                    <div class="row">
                        ...
                        <td>" . htmlspecialchars($jalali_date) . "</td>";
                                    ...
                                    function displayChecklists($conn, $username)
                                    {
                                        ...
                                        $query = "SELECT * FROM checklist 
                                                    ...
                                                    AND contractor_name = (SELECT contractor_name FROM project WHERE id = ?) AND checklist.isDeleted = False
                        ...
                        <td>" . htmlspecialchars($jalali_date) . "</td>";
                                            ...
                                            echo "<tr><td colspan='8' class='text-center'>هیچ چک لیستی یافت نشد.</td></tr>";
                                        }
                                    }
