...
<body dir="rtl" class="bg-green-200">
    ...
    <div class="container-fluid pl-5 pr-5 mx-auto p-5">
        <h1 class="text-2xl font-bold mb-4">درج گروه دیسیپلین چک لیست جدید</h1>
        <div class="flex flex-col sm:flex-row gap-3 mb-3">
            <a href="./create_discipline_checklist.php"
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-nowrap">درج آیتم های دیسیپلین چک لیست</span>
                </div>
            </a>
            <a href="./manage_checklistDisciplines.php"
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-nowrap">مدیریت گروه های دیسیپلین چک لیست</span>
                </div>
            </a>
        </div>
        <?php
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['create_discipline'])) {
            $name = $_POST['name'];
            $group_name = $_POST['group_name']; // Corrected field name
            $code = uniqid(); // تولید کد یکتا رندوم

            $sql = "INSERT INTO disciplines (name, `group`, code) VALUES (?, ?, ?)";
