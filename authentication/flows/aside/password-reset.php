			...
			<div class="d-flex flex-column flex-lg-row-fluid py-10">
					...
					<div class="w-lg-500px p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_password_reset_form">
							...
							<div class="d-flex flex-wrap justify-content-center pb-lg-0">
								...
								<a href="../../authentication/flows/aside/sign-up.php" class="btn btn-lg btn-light-primary fw-bolder">Cancel</a>
							</div>
							<!--end::Actions-->
						</form>
						<!--end::Form-->
				...
				<div class="d-flex flex-center flex-wrap fs-6 p-5 pb-0">
					...
					<div class="d-flex flex-center fw-bold fs-6">
						<a href="https://mikapartners.co" class="text-muted text-hover-primary px-2" target="_blank">About</a>
						<a href="https://mikapartners.co/support" class="text-muted text-hover-primary px-2" target="_blank">Support</a>
