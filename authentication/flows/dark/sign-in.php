					...
					<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
						...
						<div class="text-center mb-10">
							...
							<div class="text-gray-400 fw-bold fs-4">New Here?
								<a href="../../authentication/flows/dark/sign-up.php" class="link-primary fw-bolder">Create an Account</a>
							</div>
							<!--end::Link-->
						</div>
						<!--begin::Heading-->
						...
						<div class="fv-row mb-10">
							...
							<div class="d-flex flex-stack mb-2">
								...
								<!--end::Label-->
								<!--begin::Link-->
								<a href="../../authentication/flows/dark/password-reset.php" class="link-primary fs-6 fw-bolder">Forgot Password ?</a>
								<!--end::Link-->
							</div>
							<!--end::Wrapper-->
							<!--begin::Input-->
