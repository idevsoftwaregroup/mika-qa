		...
		<div class="d-flex flex-column flex-column-fluid">
			...
			<div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-15">
				...
				<div class="pt-lg-10 mb-10">
					...
					<div class="fw-bold fs-3 text-muted mb-15">Your password is successfully changed. Please Sign
						<br />in to your account and start a new project.
					</div>
					<!--end::Message-->
					<!--begin::Action-->
					<div class="text-center">
						<a href="../../authentication/flows/basic/sign-in.php" class="btn btn-primary btn-lg fw-bolder">Sign In</a>
					</div>
					<!--end::Action-->
					<!--begin::Action-->
					<div class="text-gray-700 fw-bold fs-4 pt-7">Did’t receive an email?
						<a href="../../authentication/flows/basic/password-reset.php" class="text-primary fw-bolder">Try Again</a>
					</div>
					<!--end::Action-->
				</div>
				<!--end::Wrapper-->
			...
			<div class="d-flex flex-center flex-column-auto p-10">
				...
				<div class="d-flex align-items-center fw-bold fs-6">
					<a href="https://mikapartners.co" class="text-muted text-hover-primary px-2">About</a>
