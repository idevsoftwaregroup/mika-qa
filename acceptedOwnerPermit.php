...
WHERE
    ...
    permits.isDeleted = FALSE OR permits.isDeleted = NULL
) AND permits.status = 'Accept'
ORDER BY
    dateTimeCreated
DESC";
                                        $stmt = $conn->prepare($query);
                        ...
                        <td>" . htmlspecialchars($jalali_date) . "</td>";
                                            ...
                                            echo "<tr><td colspan='8' class='text-center'>هیچ پرمیت <span class='text-primary fs-bold'>تایید شده</span> ای یافت نشد.</td></tr>";
                                        }
                                    }
