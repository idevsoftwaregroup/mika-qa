            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                ...
                                <li class="breadcrumb-item p-5 btn btn-outline-white rounded bg-black text-white" style="border: 1px solid white">کارتابل تیم کارفرما</li>
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                        <!--end::Page title=-->
                ...
                <div class="px-10">
                    <form method="post" action="">
                        <table class="table table-white px-15">
                            <thead>
                                <tr>
                                    <th scope="col" class="text-white bg-black btn-sm text-center border-1 border-radius pr-5">نام پروژه</th>
                                    <th scope="col" class="text-white btn-sm bg-black border-1 text-center">
                                        <input type="text" name="search_term" id="search_term" class="form-control" placeholder="شماره پرمیت">
                                    </th>
                                    <th scope="col" class="text-white btn-sm bg-black border-1 text-center">
                                        <input type="text" name="search_contract_number" id="search_contract_number" class="form-control" placeholder="شماره قرارداد">
                                    </th>
                                    <th scope="col" class="text-white btn-sm bg-black border-1 text-center">
                                        <input type="text" name="search_type" id="search_type" class="form-control" placeholder="نوع فرآیند">
                                    </th>
                                    <th scope="col" class="text-white btn-sm bg-black border-1 text-center">
                                        <input type="text" name="search_status" id="search_status" class="form-control" placeholder="وضعیت فرآیند">
                                    </th>
                                    <th scope="col" class="text-center text-white btn-sm bg-black border-1" style="padding: 19px;">
                                        تاریخ و زمان ایجاد
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td colspan="6" class="text-start">
                                        <a href="/owner.php" class="btn btn-dark btn-sm mb-2 text-white">
                                            <img src="./assets/media/icons/reset_form/icons8-form-50.png" alt="Reset the form" style="width: 20px"> ریست فرم
                                        </a>
                                        <button type="submit" class="btn btn-dark btn-sm mb-2 text-white">
                                ...
                                {
                                    // Fetch permits and exclude those already submitted by the user
                                    $query = "
                        SELECT p.*, 
       (SELECT COUNT(*) 
        FROM permit_status ps 
        WHERE ps.permit_id = p.permit_id COLLATE utf8mb4_unicode_ci 
        AND ps.user_id = ? COLLATE utf8mb4_unicode_ci) as is_submitted
FROM permits p
WHERE (SELECT COUNT(*) 
       FROM permit_status ps 
       WHERE ps.permit_id = p.permit_id COLLATE utf8mb4_unicode_ci 
       AND ps.user_id = ? COLLATE utf8mb4_unicode_ci) = 0;
                    ...
                    ";
                                    ...
                                    <td><a href='../pages/forms/permitItems.php?prmQWERTY=" . htmlspecialchars($row["permit_id"], ENT_QUOTES, 'UTF-8') . "'>" . htmlspecialchars($row["permit_id"], ENT_QUOTES, 'UTF-8') . "</a></td>
                                    <td>" . htmlspecialchars($row["contract_number"], ENT_QUOTES, 'UTF-8') . "</td>
                                    <td>پرمیت</td>
                                    <td>" . htmlspecialchars($row["status"], ENT_QUOTES, 'UTF-8') . "</td>
                                    <td>" . htmlspecialchars($row["date_created"], ENT_QUOTES, 'UTF-8') . "</td>
                                </tr>";
                                        }
                                    } else {
                                        echo "<tr><td colspan='6'>هیچ فرآیند فعال یافت نشد.</td></tr>";
                                    }
                                }
                                ...
                                {
                                    // Fetch checklists and exclude those already submitted by the user
                                    $query = "
                        SELECT c.*, 
       (SELECT COUNT(*) 
        FROM checklistItemsActions cia 
        WHERE cia.permit_id = c.permit_id COLLATE utf8mb4_unicode_ci 
        AND cia.user_name = ? COLLATE utf8mb4_unicode_ci) as is_submitted
FROM checklist c
WHERE (SELECT COUNT(*) 
       FROM checklistItemsActions cia 
       WHERE cia.permit_id = c.permit_id COLLATE utf8mb4_unicode_ci 
       AND cia.user_name = ? COLLATE utf8mb4_unicode_ci) = 0;
                    ...
                    ";
                                    ...
                                    <td><a href='../pages/forms/checklistItems.php?prmQWERTY=" . htmlspecialchars($row["permit_id"], ENT_QUOTES, 'UTF-8') . "'>" . htmlspecialchars($row["permit_id"], ENT_QUOTES, 'UTF-8') . "</a></td>
                                    <td>" . htmlspecialchars($row["contract_number"], ENT_QUOTES, 'UTF-8') . "</td>
                                    <td>چک لیست</td>
                                    <td>" . htmlspecialchars($row["status"], ENT_QUOTES, 'UTF-8') . "</td>
                                    <td>" . htmlspecialchars($row["date_created"], ENT_QUOTES, 'UTF-8') . "</td>
                                        ...
                                        echo "<tr><td colspan='6'>هیچ فرآیند فعال چک لیست یافت نشد.</td></tr>";
                                    }
                                }
