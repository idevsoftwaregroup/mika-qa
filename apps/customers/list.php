											...
											<div id="kt_aside_menu_wrapper" class="menu-fit">
												...
												<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
													...
													<div class="menu-sub menu-sub-accordion">
														...
														<div class="menu-item">
															<a class="menu-link active" href="../../apps/customers/list.php">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
								...
								<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
									...
									<tbody class="fw-bold text-gray-600">
										<tr>
											...
											<!--begin::Name=-->
											<td>
												<a href="../../apps/customers/view.php" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
											</td>
											<!--end::Name=-->
											<!--begin::Email=-->
											<td>
											...
											<td data-filter="mastercard">
												<img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 9163
											</td>
											<!--end::Payment method=-->
											<!--begin::Date=-->
											...
											<td class="text-end">
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
													<!--begin::Menu item-->
													<div class="menu-item px-3">
														<a href="../../apps/customers/view.php" class="menu-link px-3">View</a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
										...
										<tr>
											...
											<!--begin::Name=-->
											<td>
												<a href="../../apps/customers/view.php" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
											</td>
											<!--end::Name=-->
											<!--begin::Email=-->
											<td>
											...
											<!--begin::Payment method=-->
											<td data-filter="visa">
												<img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 7063
											</td>
											<!--end::Payment method=-->
											<!--begin::Date=-->
										...
										<tr>
											...
											<!--begin::Name=-->
											<td>
												<a href="../../apps/customers/view.php" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
											</td>
											<!--end::Name=-->
											<!--begin::Email=-->
											<td>
											...
											<!--begin::Payment method=-->
											<td data-filter="mastercard">
												<img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 8458
											</td>
											<!--end::Payment method=-->
											<!--begin::Date=-->
										...
										<tr>
											...
											<!--begin::Name=-->
											<td>
												<a href="../../apps/customers/view.php" class="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
											</td>
											<!--end::Name=-->
											<!--begin::Email=-->
											<td>
											...
											<td data-filter="american_express">
												<img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 6409
											</td>
											<!--end::Payment method=-->
											<!--begin::Date=-->
										...
										<tr>
											...
											<!--begin::Name=-->
											<td>
												<a href="../../apps/customers/view.php" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
											</td>
											<!--end::Name=-->
											<!--begin::Email=-->
											<td>
											...
											<!--begin::Payment method=-->
											<td data-filter="visa">
												<img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 3153
											</td>
											<!--end::Payment method=-->
											<!--begin::Date=-->
										...
										<tr>
											...
											<!--begin::Name=-->
											<td>
												<a href="../../apps/customers/view.php" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
											</td>
											<!--end::Name=-->
											<!--begin::Email=-->
											<td>
											...
											<!--begin::Payment method=-->
											<td data-filter="american_express">
												<img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 9239
											</td>
											<!--end::Payment method=-->
											<!--begin::Date=-->
										...
										<tr>
											...
											<!--begin::Name=-->
											<td>
												<a href="../../apps/customers/view.php" class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
											</td>
											<!--end::Name=-->
											<!--begin::Email=-->
											<td>
											...
											<!--begin::Payment method=-->
											<td data-filter="mastercard">
												<img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 5344
											</td>
											<!--end::Payment method=-->
											<!--begin::Date=-->
										...
										<tr>
											...
											<!--begin::Name=-->
											<td>
												<a href="../../apps/customers/view.php" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
											</td>
											<!--end::Name=-->
											<!--begin::Email=-->
											<td>
											...
											<!--begin::Payment method=-->
											<td data-filter="american_express">
												<img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 6049
											</td>
											<!--end::Payment method=-->
											<!--begin::Date=-->
										...
										<tr>
											...
											<!--begin::Name=-->
											<td>
												<a href="../../apps/customers/view.php" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
											</td>
											<!--end::Name=-->
											<!--begin::Email=-->
											<td>
											...
											<!--begin::Payment method=-->
											<td data-filter="visa">
												<img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 6123
											</td>
											<!--end::Payment method=-->
											<!--begin::Date=-->
										...
										<tr>
											...
											<!--begin::Name=-->
											<td>
												<a href="../../apps/customers/view.php" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
											</td>
											<!--end::Name=-->
											<!--begin::Email=-->
											<td>
											...
											<!--begin::Payment method=-->
											<td data-filter="visa">
												<img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 5182
											</td>
											<!--end::Payment method=-->
											<!--begin::Date=-->
										...
										<tr>
											...
											<!--begin::Name=-->
											<td>
												<a href="../../apps/customers/view.php" class="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
											</td>
											<!--end::Name=-->
											<!--begin::Email=-->
											<td>
											...
											<!--begin::Payment method=-->
											<td data-filter="mastercard">
												<img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 8096
											</td>
											<!--end::Payment method=-->
											<!--begin::Date=-->
										...
										<tr>
											...
											<!--begin::Name=-->
											<td>
												<a href="../../apps/customers/view.php" class="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
											</td>
											<!--end::Name=-->
											<!--begin::Email=-->
											<td>
											...
											<!--begin::Payment method=-->
											<td data-filter="american_express">
												<img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 9156
											</td>
											<!--end::Payment method=-->
											<!--begin::Date=-->
						...
						<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
							...
							<div class="modal-dialog modal-dialog-centered mw-650px">
								...
								<div class="modal-content">
									<!--begin::Form-->
									<form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="../../apps/customers/list.php">
										<!--begin::Modal header-->
