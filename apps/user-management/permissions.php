...
-->
												...
												<div class="flex-shrink-0 ms-2">
													...
													<!--begin::Menu-->
													<!--begin::Menu 1-->
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_614857c87f980">
														<!--begin::Header-->
														<div class="px-7 py-5">
														...
														<div class="px-7 py-5">
															...
															<div class="mb-10">
																...
																<!--begin::Input-->
																<div>
																	<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_614857c87f980" data-allow-clear="true">
																		<option></option>
											...
											<div id="kt_aside_menu_wrapper" class="menu-fit">
												...
												<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion mb-1">
													...
													<div class="menu-sub menu-sub-accordion">
														...
														<div class="menu-item">
															<a class="menu-link active" href="../../apps/user-management/permissions.php">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
				...
				<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
					...
					<div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
							<!--begin::Heading-->
							<h1 class="text-dark fw-bolder my-0 fs-2">Permissions List</h1>
							<!--end::Heading-->
							<!--begin::Breadcrumb-->
								...
								<table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
									...
									<tbody class="fw-bold text-gray-600">
										<tr>
											...
											<!--begin::Assigned to=-->
											<td>
												<a href="../../apps/user-management/roles/view.php" class="badge badge-light-primary fs-7 m-1">Administrator</a>
											</td>
											<!--end::Assigned to=-->
											<!--begin::Created Date-->
										...
										<tr>
											...
											<td>
												<a href="../../apps/user-management/roles/view.php" class="badge badge-light-primary fs-7 m-1">Administrator</a>
												<a href="../../apps/user-management/roles/view.php" class="badge badge-light-danger fs-7 m-1">Developer</a>
												<a href="../../apps/user-management/roles/view.php" class="badge badge-light-success fs-7 m-1">Analyst</a>
												<a href="../../apps/user-management/roles/view.php" class="badge badge-light-info fs-7 m-1">Support</a>
												<a href="../../apps/user-management/roles/view.php" class="badge badge-light-warning fs-7 m-1">Trial</a>
											</td>
											<!--end::Assigned to=-->
											<!--begin::Created Date-->
