...
-->
												...
												<div class="flex-shrink-0 ms-2">
													...
													<!--begin::Menu-->
													<!--begin::Menu 1-->
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_614857c768756">
														<!--begin::Header-->
														<div class="px-7 py-5">
														...
														<div class="px-7 py-5">
															...
															<div class="mb-10">
																...
																<!--begin::Input-->
																<div>
																	<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_614857c768756" data-allow-clear="true">
																		<option></option>
													...
													<div class="menu-sub menu-sub-accordion">
														...
														<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
															...
															<div class="menu-sub menu-sub-accordion">
																...
																<div class="menu-item">
																	<a class="menu-link active" href="../../apps/user-management/roles/view.php">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot"></span>
																		</span>
				...
				<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
					...
					<div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
							<!--begin::Heading-->
							<h1 class="text-dark fw-bolder my-0 fs-2">View Role Details</h1>
							<!--end::Heading-->
							<!--begin::Breadcrumb-->
											...
											<tbody class="fw-bold text-gray-600">
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
															<a href="../../apps/user-management/users/view.php">
														...
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../apps/user-management/users/view.php" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="../../apps/user-management/users/view.php" class="menu-link px-3">View</a>
															</div>
															<!--end::Menu item-->
															<!--begin::Menu item-->
															<div class="menu-item px-3">
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../apps/user-management/users/view.php" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
															<a href="../../apps/user-management/users/view.php">
																<div class="symbol-label">
																	<img src="assets/media/avatars/blank.png" alt="Max Smith" class="w-100" />
																</div>
															</a>
														</div>
														<!--end::Avatar-->
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../apps/user-management/users/view.php" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../apps/user-management/users/view.php" class="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../apps/user-management/users/view.php" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../apps/user-management/users/view.php" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../apps/user-management/users/view.php" class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../apps/user-management/users/view.php" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../apps/user-management/users/view.php" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../apps/user-management/users/view.php" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../apps/user-management/users/view.php" class="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../apps/user-management/users/view.php" class="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../apps/user-management/users/view.php" class="text-gray-800 text-hover-primary mb-1">Robert Doe</a>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../apps/user-management/users/view.php" class="text-gray-800 text-hover-primary mb-1">John Miller</a>
