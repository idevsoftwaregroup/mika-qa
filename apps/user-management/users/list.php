...
$title = "Quality Assurance | User List";
...
-->
											...
											<div class="m-0">
												<!--begin::Heading-->
												<h1 class="text-gray-800 fw-bold mb-6 mx-5">فرم ها</h1>
												<!--end::Heading-->
												<div class="mb-10">
													<!--begin::Item-->
													<a href="/index.php" class="custom-list d-flex align-items-center px-5 py-4">
														<!--begin::Symbol-->
														<div class="symbol symbol-40px me-5">
                                                            <span class="symbol-label">
                                                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="500" height="500" viewBox="0,0,256,256"
style="fill:#000000;">
<g fill="#1662c2" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><g transform="scale(5.12,5.12)"><path d="M5,4c-1.64557,0 -3,1.35554 -3,3v9v10v17c0,1.64446 1.35443,3 3,3h40c1.64506,0 3,-1.35494 3,-3v-17v-10v-5c0,-1.64506 -1.35494,-3 -3,-3h-27c0.08657,0 -0.03101,0.00036 -0.27539,-0.28125c-0.24438,-0.28161 -0.54519,-0.74881 -0.85937,-1.25c-0.31418,-0.50119 -0.64346,-1.03596 -1.05859,-1.50586c-0.41514,-0.4699 -0.98789,-0.96289 -1.80664,-0.96289zM5,6h9c-0.06075,0 0.06114,0.00701 0.30859,0.28711c0.24746,0.2801 0.54864,0.74533 0.86133,1.24414c0.31269,0.49881 0.63651,1.03161 1.04297,1.5c0.40646,0.46839 0.96604,0.96875 1.78711,0.96875h27c0.56294,0 1,0.43706 1,1v2.1875c-0.31489,-0.11356 -0.64816,-0.1875 -1,-0.1875h-40c-0.35184,0 -0.68511,0.07394 -1,0.1875v-6.1875c0,-0.56354 0.43557,-1 1,-1zM5,15h40c0.56503,0 1,0.43497 1,1v10v17c0,0.56294 -0.43706,1 -1,1h-40c-0.56443,0 -1,-0.43646 -1,-1v-17v-10c0,-0.56503 0.43497,-1 1,-1z"></path></g></g>
</svg>
                                                            </span>
                                                        </div>
														<!--end::Symbol-->
														...
														<div class="d-flex flex-column flex-grow-1">
															<!--begin::Title-->
															<h5 class="custom-list-title fw-bold text-gray-800 mb-1">کارتابل</h5>
															<!--end::Title-->
															<!--begin::Link-->
															<span class="text-gray-400 fw-bold">همه فرآیند ها</span>
															<!--end::Link-->
														</div>
														<!--begin::Description-->
													</a>
												...
												<div class="mb-10">
													...
													<a href="/pages/forms/permit.php" class="custom-list d-flex align-items-center px-5 py-4">
														<!--begin::Symbol-->
														<div class="symbol symbol-40px me-5">
															<span class="symbol-label"> <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="512" height="512" viewBox="0 0 128 128"> <path fill="#fff" d="M64 9A55 55 0 1 0 64 119A55 55 0 1 0 64 9Z"></path><path fill="#444b54" d="M64,122C32,122,6,96,6,64S32,6,64,6s58,26,58,58S96,122,64,122z M64,12c-28.7,0-52,23.3-52,52s23.3,52,52,52 s52-23.3,52-52S92.7,12,64,12z"></path><path fill="#71c2ff" d="M62,79C62,79,62,79,62,79c-0.8,0-1.6-0.4-2.2-1L46.7,64c-1.1-1.2-1.1-3.1,0.2-4.2c1.2-1.1,3.1-1.1,4.2,0.2 L62,71.6l20.9-21.8c1.1-1.2,3-1.2,4.2-0.1c1.2,1.1,1.2,3,0.1,4.2L64.2,78.1C63.6,78.7,62.8,79,62,79z"></path> </svg> </span>
														</div>
														<!--end::Symbol-->
														<!--begin::Description-->
														<div class="d-flex flex-column flex-grow-1">
															<!--begin::Title-->
															<h5 class="custom-list-title fw-bold text-gray-800 mb-1">فرآیند پرمیت</h5>
															<!--end::Title-->
															<!--begin::Link-->
															<span class="text-gray-400 fw-bold">ایجاد فرآیند پرمیت جدید</span>
															<!--end::Link-->
														</div>
														<!--begin::Description-->
													</a>
													...
													<a href="/pages/forms/beforeChecklist.php" class="custom-list d-flex align-items-center px-5 py-4">
														...
														<div class="symbol symbol-40px me-5">
															<span class="symbol-label">
                                                                <img src="assets/media/checklist-logo.png"
														...
														<div class="d-flex flex-column flex-grow-1">
															<!--begin::Title-->
															<h5 class="custom-list-title fw-bold text-gray-800 mb-1">فرآیند چک لیست</h5>
															<!--end::Title-->
															<!--begin::Link-->
															<span class="text-gray-400 fw-bold">ایجاد فرآیند چک لیست جدید</span>
															<!--end::Link-->
														</div>
														<!--begin::Description-->
													</a>
															...
															<div class="menu-sub menu-sub-accordion menu-active-bg">
																...
																<div class="menu-item">
																	<a class="menu-link" href="../../pages/discipline/viewDisciplines.php">
																		...
																		<span class="menu-title">لیسن دیسیپلین ها</span>
																	</a>
																</div>
															</div>
														</div>
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
				...
				<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
					...
					<div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
							<!--begin::Heading-->
							<h1 class="text-dark fw-bolder my-0 fs-2">لیست کاربران</h1>
							<!--end::Heading-->
							<!--begin::Breadcrumb-->
							<ul class="breadcrumb fw-bold fs-base my-1">
								...
								<li class="breadcrumb-item text-dark">لیست کاربران تعریف شده در سیستم</li>
							</ul>
							<!--end::Breadcrumb-->
						</div>
						<!--end::Page title=-->
					...
					<div class="container-xxl" id="kt_content_container">
						...
						<div class="card">
							...
							<div class="card-header border-0 pt-6">
								...
								<div class="card-title">
									...
									<div class="d-flex align-items-center position-relative my-1">
										...
										<!--end::Svg Icon-->
										<input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="جسنجوی کاربر جدید" />
									</div>
									<!--end::Search-->
								</div>
								<!--begin::Card title-->
								...
								<div class="card-toolbar">
									...
									<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
										...
										<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">
											...
											<!--end::Svg Icon-->کاربر جدید</button>
										<!--end::Add user-->
									</div>
									<!--end::Toolbar-->
									<!--begin::Group actions-->
									...
									<div class="modal fade" id="kt_modal_add_user" tabindex="-1" aria-hidden="true">
										...
										<div class="modal-dialog modal-dialog-centered mw-650px">
											...
											<div class="modal-content">
												...
												<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
													<!--begin::Form-->
													<form id="kt_modal_add_user_form" class="form" action="/apps/user-management/users/adduser.php" method="post">
														<!--begin::Scroll-->
														<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
															...
															<div class="fv-row mb-7">
																<!--begin::Label-->
																<label class="required fw-bold fs-6 mb-2">FullName</label>
																<!--end::Label-->
																<!-- begin::username -->
																<input type="text" name="fullname" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="FullName" value="" />
																<!-- end::username -->
															</div>
															<!--end::Input group-->
															<!--begin::Input group-->
															...
															<div class="fv-row mb-7">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input type="phone" name="phone" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="09029983102" value="" />
																<!--end::Input-->
															</div>
															<!--end::Input group-->
															<!--begin::Input group-->
															<div class="fv-row mb-7">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" name="jobtitle" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Job Title" value="" />
																<!--end::Input-->
															</div>
															<!--end::Input group-->
															<!--begin::Input group-->
															<div class="fv-row mb-7">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" name="company" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Company Name" value="" />
																<!--end::Input-->
															</div>
															<!--end::Input group-->
															<!--begin::Input group-->
															<div class="fv-row mb-7">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" name="desc" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Description" value="" />
																<!--end::Input-->
															</div>
															<!--end::Input group-->
															<!--begin::Input group-->
															<div class="fv-row mb-7">
																...
																<!--end::Label-->
																<!--begin::Select-->
																<select name="position" class="form-select form-select-solid mb-3 mb-lg-0">
							...
							<div class="card-body pt-0">
								<!--begin::Table-->
								<table id="kt_table_users" class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
									<!--begin::Table head-->
									<thead>
										<!--begin::Table row-->
                ...
                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                    <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_table_users .form-check-input" value="1" />
											...
											<th class="min-w-50px">شماره یکتای کاربر</th>
											<th class="text-start min-w-100px">عملیات</th>
											<th class="min-w-125px">نام کاربری</th>
											<th class="min-w-125px">نام / نام خانوادگی</th>
											<th class="min-w-125px">رمز ورود</th>
											<th class="min-w-125px">شماره تماس</th>
											<th class="min-w-125px">عنوان شغلی</th>
											<th class="min-w-125px">موقعیت شغلی</th>
											<th class="text-end min-w-100px">شرکت</th>
											<th class="text-end min-w-100px">توضیحات</th>
										</tr>
										<!--end::Table row-->
									</thead>
									<!--end::Table head-->
									...
									<tbody class="text-gray-600 fw-bold">
										...
										// Read records from the users table
										$users = readRecords($conn, "users");
										// Display the fetched data
										if ($users !== false) {
											foreach ($users as $user) {
												// Display each user's information within a table row
												echo '<tr>';
												// echo '<td class="d-flex align-items-center"><input class="form-check-input" type="checkbox"></td>';
												echo '<td>' . $user['id'] . '</td>';
												echo '<td><a href="/apps/user-management/users/deluser.php?id=' . $user['id'] . '">حذف</a> &nbsp;&nbsp; <a href="/apps/user-management/users/edituser.php?id=' . $user['id'] . '">ویرایش</a></td>';
												echo '<td>' . $user['username'] . '</td>';
												echo '<td>' . $user['fullname'] . '</td>';
												echo '<td>' . $user['password'] . '</td>';
												echo '<td>' . $user['phone_number'] . '</td>';
												echo '<td>' . $user['job_title'] . '</td>';
												echo '<td>' . $user['job_position'] . '</td>';
												echo '<td>' . $user['company'] . '</td>';
												echo '<td>' . $user['description'] . '</td>';
												echo '</tr>';
											}
										} else {
											// Display an empty row with a message indicating no users were found
											echo '<tr>';
											echo '<td colspan="10" class="text-center">هیچ کاربری یافت نشد</td>';
											echo '</tr>';
										}
