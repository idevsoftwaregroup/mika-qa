...
-->
												...
												<div class="flex-shrink-0 ms-2">
													...
													<!--begin::Menu-->
													<!--begin::Menu 1-->
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_614857c3ebc9a">
														<!--begin::Header-->
														<div class="px-7 py-5">
														...
														<div class="px-7 py-5">
															...
															<div class="mb-10">
																...
																<!--begin::Input-->
																<div>
																	<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_614857c3ebc9a" data-allow-clear="true">
																		<option></option>
											...
											<!--end::Toolbar-->
											<!--begin::Projects-->
											<?php require('../../../layouts/infrastructure/menu.php'); ?>
											<!--end::Projects-->
										</div>
										<!--end::Wrapper-->
									</div>
						...
						<div class="card">
													...
													<form id="kt_modal_add_user_form" class="form" action="/apps/user-management/users/adduser.php" method="post">
														...
														<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
															...
															<div class="fv-row mb-7">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" name="position" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Job Position" value="" />
																<!--end::Input-->
															</div>
															<!--end::Input group-->
														</div>
							...
							<div class="card-body pt-0">
								...
								if ($_SERVER["REQUEST_METHOD"] == "POST") {
									...
									$sql = "UPDATE users SET username='$username', password='$password', phone_number='$phone', job_title='$job_title', job_position='$job_position', company='$company', description='$description' WHERE id=$user_id";
								...
								$conn->close();
								?>
								<form method="POST" class="form mt-15" action="/apps/user-management/users/updateDone.php">
									<label for="id" class="required fw-bold fs-6 mb-2">User ID:</label><br>
									<input type="text" id="id" class="form-control form-control-solid mb-3 mb-lg-0" name="id" value="<?php echo $user['id']; ?>"><br>


									<label for="username" class="required fw-bold fs-6 mb-2">Username:</label><br>
									<input type="text" id="username" class="form-control form-control-solid mb-3 mb-lg-0" name="username" value="<?php echo $user['username']; ?>"><br>

									<label for="fullname" class="required fw-bold fs-6 mb-2">FullName:</label><br>
									<input type="text" id="fullname" class="form-control form-control-solid mb-3 mb-lg-0" name="fullname" value="<?php echo $user['fullname']; ?>"><br>

									<label for="password" class="required fw-bold fs-6 mb-2">Password:</label><br>
									<input type="password" id="password" name="password" class="form-control form-control-solid mb-3 mb-lg-0" value="<?php echo $user['password']; ?>"><br>

									<label for="phone" class="required fw-bold fs-6 mb-2">Phone:</label><br>
									<input type="text" id="phone" name="phone" class="form-control form-control-solid mb-3 mb-lg-0" value="<?php echo $user['phone_number']; ?>"><br>

									<label for="job_title" class="required fw-bold fs-6 mb-2">Job Title:</label><br>
									<input type="text" id="job_title" name="job_title" class="form-control form-control-solid mb-3 mb-lg-0" value="<?php echo $user['job_title']; ?>"><br>

									<label for="job_position" class="required fw-bold fs-6 mb-2">Job Position:</label><br>
									<input type="text" id="job_position" name="job_position" class="form-control form-control-solid mb-3 mb-lg-0" value="<?php echo $user['job_position']; ?>"><br>

									<label for="company" class="required fw-bold fs-6 mb-2">Company:</label><br>
									<input type="text" id="company" name="company" class="form-control form-control-solid mb-3 mb-lg-0" value="<?php echo $user['company']; ?>"><br>

									<label for="description" class="required fw-bold fs-6 mb-2">Description:</label><br>
									<textarea class="form-control form-control-solid mb-3 mb-lg-0" id="description" name="description"><?php echo $user['description']; ?></textarea><br><br>

									<input type="submit" class="btn btn-block btn-primary" value="Submit an Edit">
								</form>
