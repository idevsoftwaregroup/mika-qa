<!DOCTYPE html>
<?php
$title = "Quality Assurance | View User";
?>
<html lang="en">
<!--begin::Head-->
...
-->
												...
												<div class="flex-shrink-0 ms-2">
													...
													<!--begin::Menu-->
													<!--begin::Menu 1-->
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_614857c51e98e">
														<!--begin::Header-->
														<div class="px-7 py-5">
														...
														<div class="px-7 py-5">
															...
															<div class="mb-10">
																...
																<!--begin::Input-->
																<div>
																	<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_614857c51e98e" data-allow-clear="true">
																		<option></option>
									...
									<div class="card-body">
										...
										<div id="kt_user_view_details" class="collapse show">
											<div class="pb-5 fs-6">
												...
												<div class="text-gray-600">20 Dec 2021, 11:30 am</div>
												<!--begin::Details item-->
											</div>
										</div>
										<!--end::Details content-->
