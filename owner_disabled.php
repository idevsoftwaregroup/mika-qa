...
-->
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                ...
                                <li class="breadcrumb-item p-5 btn btn-outline-white rounded bg-white text-dark">کارتابل تیم کارفرما</li>
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                        <!--end::Page title=-->
                ...
                <!--end::Header-->
                <!--begin::Content-->
                <form action="" method="post" name="searchTerms">
                    <div class="container-fluid">
                        <div clas="row">
                            <div class="p-1 border border-white rounded-3">
                                <!-- <table class="table table-hover mb-10">
                                <thead>
                                    <tr>
                                        <th scope="col fw-bold text-white border border-1 border-white">
                                            <input type='text' name='form_permit' id='form_permit' class='form-control' placeholder="شماره پرمیت">
                                        </th>
                                        <th scope="col text-white">
                                            <input type='text' name='form_type' id='form_type' class='form-control' placeholder="نوع فرم">
                                        </th>
                                        <th scope="col text-white">
                                            <input type='text' name='project_name' id='project_name' class='form-control' placeholder="نام پروژه">
                                        </th>
                                        <th scope="col text-white">
                                            <span class="text-white">نام پیمانکار</span>
                                        </th>
                                        <th scope="col text-white">
                                            <input type='text' name='contract_number_form' id='project_name' class='form-control' placeholder="شماره قرارداد">
                                        </th>
                                        <th scope="col text-white">
                                            <input type='text' name='form_status' id='form_status' class='form-control' placeholder="وضعیت فرم">
                                        </th>
                                        <th scope="col text-white">
                                            <span class="text-white">تاریخ و زمان ایجاد</span>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody> -->
                                ...
                                <div class="row mb-3 p-3">
                                    <div class="col">
                                        <input type="text" id="search_permit_id" class="form-control" placeholder="شماره پرمیت">
                                    </div>
                                    <div class="col">
                                        <input type="text" id="search_form_type" class="form-control" placeholder="نوع فرم">
                                    </div>
                                    <div class="col">
                                        <input type="text" id="search_project_name" class="form-control" placeholder="نام پروژه">
                                    </div>
                                    <div class="col">
                                        <input type="text" id="search_contractor_name" class="form-control" placeholder="نام پیمانکار">
                                    </div>
                                    <div class="col">
                                        <input type="text" id="search_contract_number" class="form-control" placeholder="شماره قرارداد">
                                    </div>
                                    <div class="col">
                                        <input type="text" id="search_status" class="form-control" placeholder="وضعیت فرم">
                                    </div>
                                    <div class="col">
                                        <input type="text" id="search_date_created" class="form-control" placeholder="تاریخ و زمان ایجاد">
                                    </div>
                                </div>
                                <?php
                                // Database connection parameters
                                ...
                                {
                                    $query = "SELECT COUNT(*) as count FROM `permit_status` WHERE `permit_id` = '$permit_id' AND `user_id` = '" . $username . "' ";
                                ...
                                {
                                    $query = "SELECT * FROM permits order by dateTimeCreated DESC";
                                    $result = $conn->query($query);
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            // echo $row['permit_id'];
                                            // Check if the permit has not been submitted by the current user
                                            // var_dump(permitSubmittedByUser($conn, $row['permit_id'], $username));
                                            if (permitSubmittedByUser($conn, $row['permit_id'], $username) === 0) {
                                                // Output permit information
                                                ...
                                                // echo "<tr class='border border-0 border-dark rounded-2'>
                                                //         <td class='col-3'><a class='btn btn-sm btn-dark text-white' href='../pages/forms/permitItems.php?prmQWERTY=" . $row["permit_id"] . "'>" . $row["permit_id"] . "</a></td>

                                                //         <td class='fw-bolder'><span class='text-info'>پرمیت</span></td>
                                                //         <td>" . $row["project_name"] . "</td>
                                                //         <td>" . $row["contractor_name"] . "</td>
                                                //         <td>" . $row["contract_number"] . "</td>
                                                //         <td><strong class='" . ($row["status"] == "issued" ? "text-warning bg-white rounded p-2" : ($row["status"] == "Accept" ? "text-success bg-white rounded p-2" : ($row["status"] == "Reject" ? "text-danger bg-white rounded p-2" : ($row['status'] == "in progress" ? "bg-dark text-white p-2 rounded" : "")))) . "'>" . $row["status"] . "</strong></td>
                                                //         <td>" . $jalali_date . "</dt>
                                                //     </tr>";
                                                ...
                                                echo '<div class="row border border-1 border-white rounded-2 text-white pt-6 pb-3 m-3">
                                                            <div class="col p-1 text-center">
                                                                ' . $jalali_date . '
                                                            </div>
                                                            <div class="col fw-bolder p-1 text-center">
                                                            <span class="text-white">پرمیت</span>
                                                            </div>
                                                            <div class="col p-1 text-center">
                                                            ' . $row["project_name"] . '
                                                            </div>
                                                            ...
                                                            <div class="col p-1 text-center">
                                                                <strong class="statusSize ' . ($row["status"] == "issued" ? "text-white bg-warning rounded p-2" : ($row["status"] == "Accept" ? "text-white bg-129045 rounded p-2" : ($row["status"] == "Reject" ? "text-danger bg-c70707 rounded p-2" : ($row['status'] == "in progress" ? "bg-267fe7 text-white p-2 rounded" : "")))) . '">' . $searchStatus . '</strong>
                                                            </div>
                                                            <div class="col p-1 text-center">
                                                                <a class="btn btn-sm btn-white text-dark fs-bold" href="../pages/forms/permitItems.php?prmQWERTY=' . $row["permit_id"] . '">' . $row["permit_id"] . '</a>
                                                            </div>
                                                            </div>';
                                            }
                                        }
                                    } else {
                                        echo "هیچ فرآیند فعال یافت نشد.";
                                    }
                                }
                                ...
                                {
                                    $query = "SELECT * FROM checklist order by date_created desc";
                                    $result = $conn->query($query);
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            if (!checklistSubmittedByUser($conn, $row['permit_id'], $username)) {
                                                ...
                                                $jalali_date = jdate("Y/m/d H:i:s", $timestamp);
                                                // echo "<tr>
                                                //         <td class='col-md-3'><a class='btn btn-sm btn-dark text-white rounded' href='../pages/forms/checklistItems.php?prmQWERTY=" . $row["permit_id"] . "'>" . $row["permit_id"] . "</a></td>
                                                ...
                                                if ($row["status"] == "issued") {
                                                    $mainStatus = "ایجاد شده";
                                                } else if ($row["status"] == "in progress") {
                                                    $mainStatus = "در حال بررسی";
                                                } else if ($row["status"] == "Accept") {
                                                    $mainStatus = "تایید شده";
                                                } else if ($row["status"] == "Reject") {
                                                    $mainStatus = "تایید نشده";
                                                }
                                                ...
                                                echo '<div class="row border border-1 border-white rounded-2 text-white pt-6 pb-3 m-3">
                                                            ...
                                                            <div class="col fw-bolder p-1 text-center">
                                                                <span class="text-white">چک لیست</span>
                                                                </div>
                                                            <div class="col p-1 text-center">
                                                            ' . $row["projectname"] . '
                                                            </div>
                                                            ...
                                                            <div class="col p-1 text-center">
                                                            <strong class="statusSize ' . ($row["status"] == "issued" ? "text-white bg-warning rounded p-2" : ($row["status"] == "Accept" ? "text-success bg-white rounded p-2" : ($row["status"] == "Reject" ? "text-danger bg-white rounded p-2" : ($row["status"] == "in progress" ? "bg-dark text-white p-2 rounded" : "")))) . '">' . $mainStatus . '</strong>
                                                            </div>
                                                            <div class="col p-1 text-center">
                                                            <a class="btn btn-sm btn-white text-dark fs-bold rounded" href="../pages/forms/checklistItems.php?prmQWERTY=' . $row["permit_id"] . '">' . $row["permit_id"] . '</a>
                                                            </div>
                                                        </div>';
                                            }
                                        }
                                    } else {
                                        // echo "هیچ فرآیند فعال چک لیست یافت نشد.";
                                    }
                                }
                                ...
                                <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        ...
                                        function filterRows() {
                                            var permit_id = document.getElementById("search_permit_id").value.toLowerCase();
                                            var form_type = document.getElementById("search_form_type").value.toLowerCase();
                                            var project_name = document.getElementById("search_project_name").value.toLowerCase();
                                            var contractor_name = document.getElementById("search_contractor_name").value.toLowerCase();
                                            var contract_number = document.getElementById("search_contract_number").value.toLowerCase();
                                            var status = document.getElementById("search_status").value.toLowerCase();
                                            var date_created = document.getElementById("search_date_created").value.toLowerCase();

                                            var rows = document.querySelectorAll(".permit-row, .checklist-row");

                                            rows.forEach(function(row) {
                                                var permitIDText = row.querySelector(".col-3 a").textContent.toLowerCase();
                                                var formTypeText = row.querySelector(".fw-bolder span").textContent.toLowerCase();
                                                var projectNameText = row.children[2].textContent.toLowerCase();
                                                var contractorNameText = row.children[3].textContent.toLowerCase();
                                                var contractNumberText = row.children[4].textContent.toLowerCase();
                                                var statusText = row.children[5].textContent.toLowerCase();
                                                var dateCreatedText = row.children[0].textContent.toLowerCase();

                                                row.style.display =
                                                    (permitIDText.includes(permit_id) &&
                                                        formTypeText.includes(form_type) &&
                                                        projectNameText.includes(project_name) &&
                                                        contractorNameText.includes(contractor_name) &&
                                                        contractNumberText.includes(contract_number) &&
                                                        statusText.includes(status) &&
                                                        dateCreatedText.includes(date_created)) ? "" : "none";
                                            });
                                        }

                                        // Attach event listeners to search inputs
                                        var searchInputs = document.querySelectorAll(".row.mb-3 input");
