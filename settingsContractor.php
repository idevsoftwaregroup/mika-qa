            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper" style="background-color: black;">
                    ...
                    <div class="container-fluid d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                ...
                                <li class="breadcrumb-item p-5 btn btn-outline-white rounded bg-black text-white" style="border: 1px solid white">تنظیمات</li>
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                        <!--end::Page title=-->
                ...
                <div class="container-fluid mt-5" dir="rtl">
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header p-6 h2">
                                    تغییر رمز
                                </div>
                                <div class="card-body">
                                    <form action="contractor_process_password_change.php" method="POST">
                                        <div class="mb-3">
                                            <label for="currentPassword" class="form-label">رمز فعلی</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="confirmPassword" class="form-label">تایید رمز جدید</label>
                                            <input type="password" class="form-control" id="confirmPassword" name="confirmPassword" required>
                                        </div>
                                        <button type="submit" class="btn btn-dark w-100 mb-0">تغییر رمز ورود</button>
                                    </form>
                                </div>
                            </div>
                        </div>
