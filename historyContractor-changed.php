                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <ul class="breadcrumb fw-bold fs-base my-1">
                                ...
                                <li class="breadcrumb-item p-5 btn btn-outline-white rounded bg-white text-dark">هیستوری فرآیند ها</li>
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                        <!--end::Page title=-->
            ...
            dateTimeCreated DESC";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        cs.permit_id = ?";
                            ...
                            if ($_SESSION['permitID'] == $permitID_row) {
                                // echo "1";
                            } else {
        ...
        <div class="accordion-item mb-5 col-12 rounded-2">
                ...
                <div class="card bg-black text-white">
                    ...
                    ';
                                ...
                                try {
                                    ...
                                    $sql_get_fullname = "SELECT fullname FROM users WHERE username = :contractor_name";
                                    ...
                                    $sql_project = "SELECT * FROM project WHERE contractor_name = :contractor_fullname";
                                    ...
                                    foreach ($projects as $project) {
                                        ...
                                        echo '<div class="col-12 border border-1 border-white rounded" style="padding: 10px 0px 20px;width: 98%;"><ul id="progressbar" class="text-center">';

                                        // Output each user's status
                                        foreach ($result1 as $row1) {
                                            if ($row1['status_in_permit_status'] == 'itis') {
                                                echo '<li class="active step0 text-white" style="padding: 5px 0px 5px 15px; background-color: white; color: black !important; border-radius: 10px; margin: 7px 30px 0px 0px;">
                                                            <div class="mx-3">' . htmlspecialchars($row1['fullname']) . '</div>
                                                            <div class="text-white mark bg-dark textwhite rounded rounded-3 p-3 fs-8">&nbsp;' . htmlspecialchars($row1['job_title']) . '</div> <br />
                                                        </li>';
                                            } else {
                                                echo '<li class="step0 text-white" style="padding: 5px 0px 5px 15px; background-color: white; color: black !important; border-radius: 10px; margin: 7px 30px 0px 0px;">
                                                            <div class="mx-3">' . htmlspecialchars($row1['fullname']) . '</div>
                                                            <div class="text-white mark bg-dark textwhite rounded rounded-3 p-3 fs-8">&nbsp;' . htmlspecialchars($row1['job_title']) . '</div> <br />
                                                        </li>';
                                            }
                                        ...
                                        // Output each user's status from checklistitemsactions
                                        foreach ($result1 as $row1) {
                                            if ($row1['action_status'] == 'noaction') {
                                                ...
                                                echo '<li class="active step0 text-white fs-3" style="padding: 5px 0px 5px 15px; background-color: white; color: black !important; border-radius: 10px; margin: 7px 30px 0px 0px;">
                                                            <div class="mx-3">' . htmlspecialchars($row1['fullname']) . '</div>
                                                            <div class="text-white mark bg-dark textwhite rounded rounded-3 p-3 fs-8">&nbsp;' . htmlspecialchars($row1['job_title']) . '</div> <br />
                                                        </li>';
                                            }
            ...
            <div class="container text-white">
                <div class="row pb-3">
                    ...
                    <div class="col-6 pt-3">تاریخ امضا قرارداد: ' . $row['date'] . '</div>
                </div>
            </div>
        </div>
    </div>
