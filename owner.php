                    ...
                    <div class="row">
                        <div class="px-3">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="card p-0">
                                        <div class="card-body bg-black border border-2 border-white rounded-3 text-white">
    ...
    WHERE
        project.id = $projectID
) AND permits.status = 'issued' AND permits.isDeleted = False
                                            ";
                                                ...
                                                if ($result->num_rows > 0) {
                                                    ...
                                                    $newPermits = $row['newPermits'];
                                                    echo "<span style='font-size: 16px' class='text-success'>&nbsp;(&nbsp;" . $newPermits . "&nbsp;)&nbsp;</span>";
                                                } else {
                                                    echo "<span class='text-warning' style='font-size: 14px;'>&nbsp;(&nbsp;ندارد.&nbsp;)&nbsp;</span>";
                                                }
                                            ...
                                            <div class="position-relative">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <a href="./permitOwner.php" style="font-size: 10px" class="button-dark w-100 btn btn-outline-white btn-sm rounded-3 border border-2 border-white mt-5 mb-0 position-relative p-1 w-full">
                                                            همه پرمیت ها
                                                            <?php
                                                            // Using Session
                                                            session_start();
        ...
        project.id = $projectID
                                            ...
                                            ";
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                $row = $result->fetch_assoc();
                                                                $all = $row['allPermits'];
                                                                echo "<span style='font-size: 13px' class='button-dark'>&nbsp;(&nbsp;" . $all . "&nbsp;)&nbsp;</span>";
                                                            } else {
                                                                echo "<span class='button-dark' style='font-size: 14px;'>&nbsp;(&nbsp;ندارد.&nbsp;)&nbsp;</span>";
                                                            }
                                                    ...
                                                    <div class="col-6">
                                                        <a href="./issuedOwnerPermit.php" style="font-size: 10px" class="w-100 btn btn-outline-success btn-sm rounded-3 border border-2 border-success mt-5 mb-0 position-relative p-1 w-full">
                                                            پرمیت جدید
                                                            <?php
                                                            // Using Session
                                                            session_start();
...
WHERE
 ...
 AND permits.isDeleted = False
                                            ";
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                $row = $result->fetch_assoc();
                                                                $newPermits = $row['issued'];
                                                                echo "<span class='button' style='font-size: 14px;'>&nbsp;(&nbsp;" . $newPermits . "&nbsp;)&nbsp;</span>";
                                                            } else {
                                                                echo "<span class='button' style='font-size: 14px;'>&nbsp;(&nbsp;ندارد.&nbsp;)&nbsp;</span>";
                                                            }
                                                    ...
                                                    <div class="col-6">
                                                        <a href="./acceptedOwnerPermit.php" style="font-size: 10px" class="w-100 btn btn-outline-primary btn-sm rounded-3 border border-2 border-primary mt-5 mb-0 position-relative p-1 w-full">
                                                            پرمیت انجام شده
                                                            <?php
                                                            // Using Session
                                                            session_start();
 ...
 AND permits.isDeleted = False
                                            ";
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                $row = $result->fetch_assoc();
                                                                $done = $row['done'];
                                                                echo "<span class='button' style='font-size: 14px;'>&nbsp;(&nbsp;" . $done . "&nbsp;)&nbsp;</span>";
                                                            } else {
                                                                echo "<span class='button' style='font-size: 14px;'>&nbsp;(&nbsp;ندارد.&nbsp;)&nbsp;</span>";
                                                            }
                                                    ...
                                                    <div class="col-6">
                                                        <a href="./rejectedOwnerPermit.php" style="font-size: 10px" class="w-100 btn btn-outline-danger btn-sm rounded-3 border border-2 border-danger mt-5 mb-0 position-relative p-1 w-full">
                                                            پرمیت ریجکت شده
                                                            <?php
                                                            // Using Session
                                                            session_start();
...
WHERE
 ...
 AND permits.isDeleted = False
                                            ";
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                $row = $result->fetch_assoc();
                                                                $reject = $row['done'] == '' || $row['done'] == NULL ? "0" : "ندارد";
                                                                echo "<span class='button' style='font-size: 14px;'>&nbsp;(&nbsp;" . $reject . "&nbsp;)&nbsp;</span>";
                                                            } else {
                                                                echo "<span class='button' style='font-size: 14px;'>&nbsp;(&nbsp;ندارد.&nbsp;)&nbsp;</span>";
                                                            }
                                ...
                                <div class="col-sm-12">
                                    <div class="card p-0">
                                        <div class="card-body">
                                            <h3 class="card-title">چک لیست ها
                                                <?php
                                                // Using Session
                                                session_start();
                                                ...
                                                $dbname = "qualityassurance";
                                                // Database connection
                                                $conn = new mysqli("localhost", "root", "0010", "qualityassurance");
                                                ...
                                                // Query for unseen checklists
                                                $query = "
SELECT
    COUNT(*) as newChecklists
FROM
    checklist
WHERE
    checklist.contractor_name =(
    SELECT
        project.contractor_name
    FROM
        project
    WHERE
        project.id = $projectID
) AND checklist.status = 'issued' AND checklist.isDeleted = False
                                    ...
                                    ";
                                                ...
                                                if ($result->num_rows > 0) {
                                                    $row = $result->fetch_assoc();
                                                    $newChecklists = $row['newChecklists'];
                                                    echo "<span style='font-size: 13px;'>&nbsp;(&nbsp;" . $newChecklists . "&nbsp;)&nbsp;</span>";
                                                } else {
                                                    echo "<span style='font-size: 13px;'>&nbsp;(&nbsp;ندارد.&nbsp;)&nbsp;</span>";
                                                }
                                            ...
                                            <div class="position-relative">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <a href="./checklistOwner.php" style="font-size: 10px;" class=" btn btn-dark btn-sm rounded-3 mt-5 mb-0 position-relative w-100">
                                                            همه چک لیست ها
                                                            <?php
                                                            // Using Session
                                                            session_start();
    ...
    WHERE
        project.id = $projectID
                                    ...
                                    ";
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                $row = $result->fetch_assoc();
                                                                $issued = $row['allChecks'];
                                                                echo "<span style='font-size: 13px' >&nbsp;(&nbsp;" . $issued . "&nbsp;)&nbsp;</span>";
                                                            } else {
                                                                echo "<span style='font-size: 13px'>&nbsp;(&nbsp;ندارد.&nbsp;)&nbsp;</span>";
                                                            }
                                                    ...
                                                    <div class="col-6">
                                                        <a href="./issuedOwnerChecklist.php" style="font-size: 10px;" class=" btn btn-success btn-sm rounded-3 mt-5 mb-0 position-relative w-100">
                                                            چک لیست جدید
                                                            <?php
                                                            // Using Session
                                                            session_start();
...
WHERE
    ...
    WHERE
        project.id = $projectID
) AND checklist.status = 'issued' AND checklist.isDeleted = 0
                                    ...
                                    ";
                                                    ...
                                                    <div class="col-6">
                                                        <a href="./acceptedOwnerChecklist.php" style="font-size: 10px;" class=" btn btn-primary btn-sm rounded-3 mt-5 mb-0 position-relative w-100">
                                                            چک لیست انجام شده
                                                            <?php
                                                            // Using Session
                                                            session_start();
...
WHERE
    ...
    WHERE
        project.id = $projectID
) AND checklist.isDeleted = False AND checklist.status = 'Accept'
                                    ...
                                    ";
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                $row = $result->fetch_assoc();
                                                                $done = $row['done'];
                                                                echo "<span style='font-size: 13px' >&nbsp;(&nbsp;" . $done . "&nbsp;)&nbsp;</span>";
                                                            } else {
                                                                echo "<span style='font-size: 13px'>&nbsp;(&nbsp;ندارد.&nbsp;)&nbsp;</span>";
                                                            }
                                                    ...
                                                    <div class="col-6">
                                                        <a href="./rejectedOwnerChecklist.php" style="font-size: 10px;" class=" btn btn-danger btn-sm rounded-3 mt-5 mb-0 position-relative w-100">
                                                            چک لیست ریجکت شده
                                                            <?php
                                                            // Using Session
                                                            session_start();
...
WHERE
    ...
    WHERE
        project.id = $projectID
) AND checklist.isDeleted = FALSE AND checklist.status = 'Reject'
                                    ...
                                    ";
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                $row = $result->fetch_assoc();
                                                                $rejectedChecklists = $row['reject'];
                                                                echo "<span style='font-size: 13px' >&nbsp;(&nbsp;" . $rejectedChecklists . "&nbsp;)&nbsp;</span>";
                                                            } else {
                                                                echo "<span style='font-size: 13px' >&nbsp;(&nbsp;ندارد.&nbsp;)&nbsp;</span>";
                                                            }
